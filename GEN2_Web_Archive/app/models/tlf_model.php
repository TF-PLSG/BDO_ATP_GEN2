...
class Tlf_Model extends MVC_Model
{
    ...
    function getAllTransactionLookUp($page, $data) {
		...
		if($data['SYSTEM_DATE_START'] == $data['SYSTEM_DATE_END']) {
			$where = " WHERE SYSTEM_DATE = :SYSTEM_DATE_START";
			$param['SYSTEM_DATE_START'] = $data['SYSTEM_DATE_START'];
		} else {
			$where = " WHERE SYSTEM_DATE >= :SYSTEM_DATE_START AND SYSTEM_DATE <= :SYSTEM_DATE_END ";
			$param['SYSTEM_DATE_START'] = $data['SYSTEM_DATE_START'];
			$param['SYSTEM_DATE_END'] = $data['SYSTEM_DATE_END'];
		}
		unset($data['SYSTEM_DATE_START']);
		unset($data['SYSTEM_DATE_END']);
		foreach($data as $key => $value) {
    ...
    public function getTransactionInfo($TRANSACTION_ID, $SYSTEM_DATE) {
        ...
        $param['SYSTEM_DATE'] = $SYSTEM_DATE;
		  ...
		  $where = ' WHERE TRANSACTION_ID = :TRANSACTION_ID AND SYSTEM_DATE = :SYSTEM_DATE';
