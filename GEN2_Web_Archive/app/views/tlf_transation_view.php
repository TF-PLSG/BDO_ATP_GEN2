	...
	<div class="container page-body">
		...
		<div class="row">
			<div class="col-lg-12 resultset">
				...
				<form id="submitSearch" name="signinform" action="<?php echo PATHURL; ?>tlf/transaction/" method="POST" class="form-signin" role="form" onsubmit="return encrypt_card()">
				<?php
					...
					<input type="hidden" name="data[UNMASK]" value="<?php echo isset($data['UNMASK'])? $data['UNMASK']:0;?>" id="MASKUNMASK">
						...
						<div class="col-sm-12 col-md-3 mb-3">
								<div class="form-group">
									...
									<input type="text" maxlength="50" class="form-control input-blue-border" placeholder="Transaction ID" id="TRANSACTION_ID" name="data[TRANSACTION_ID]" value="<?php echo isset($data['TRANSACTION_ID'])? htmlentities($data['TRANSACTION_ID']):'';?>">
								</div>
							</div>
							<div class="col-sm-12 col-md-3 mb-3">
								<div class="form-group">
							...
							<div class="col-sm-12 col-md-3 mb-3">
								<div class="form-group">
									...
									<input type="text" maxlength="15" class="form-control input-blue-border" placeholder="Merchant Id" id="MERCHANT_ID" name="data[MERCHANT_ID]" value="<?php echo isset($data['MERCHANT_ID'])? htmlentities($data['MERCHANT_ID']):'';?>">
								</div>
							</div>
							...
							<div class="col-sm-12 col-md-3 mb-3">
								<div class="form-group">
									...
									<input type="text" maxlength="21" class="form-control input-blue-border" placeholder="Card Number" id="CARD_NUM" name="data[CARD_NUM]" value="<?php echo isset($data['CARD_NUM'])? htmlentities($data['CARD_NUM']):'';?>">									
								</div>
							</div>
							<div class="col-sm-12 col-md-3 mb-3">
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div>
										<div class="input-group date form_date" id="form_date1" data-date="" data-date-format="yyyy-mm-dd" data-link-field="dtp_input1" data-link-format="yyyy-mm-dd">
											<input id="dtp_input_1" class="form-control input-blue-border" size="16" type="text" name="data[SYSTEM_DATE_START]" value="<?php echo isset($data['SYSTEM_DATE_START'])? htmlentities($data['SYSTEM_DATE_START']):'';?>" readonly>
							...
							<div class="col-sm-12 col-md-3 mb-3">
								<div class="form-group">
									...
									<div class="input-group date form_date" id="form_date2" data-date="" data-date-format="yyyy-mm-dd" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd">
											<input id="dtp_input_2" class="form-control input-blue-border" size="16" type="text" readonly name="data[SYSTEM_DATE_END]" value="<?php echo isset($data['SYSTEM_DATE_END'])? htmlentities($data['SYSTEM_DATE_END']):'';?>">
											<span class="input-group-addon"><span class="glyphicon glyphicon-remove"></span></span>
											<span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
										</div>
							...
							<div class="col-sm-12 col-md-3 mb-3">
								<div class="row">
									...
									<div class="form-group" style="display: flex;">
										...
										<input type="text" maxlength="4" class="form-control input-blue-border mr-2" placeholder="Start Time 🕚" id="TRANSACTION_START_TIME" name="data[TRANSACTION_START_TIME]" value="<?php echo isset($data['TRANSACTION_START_TIME'])? htmlentities($data['TRANSACTION_START_TIME']):'';?>">
										<input type="text" maxlength="4" class="form-control input-blue-border" placeholder="End Time 🕚" id="TRANSACTION_END_TIME" name="data[TRANSACTION_END_TIME]" value="<?php echo isset($data['TRANSACTION_END_TIME'])? htmlentities($data['TRANSACTION_END_TIME']):'';?>">
									</div>
									</div>
									<?php /*
									<!-- <div class="col-sm-6">
							...
							<div class="col-sm-12 col-md-3 mb-3">
								<div class="form-group">
									...
									<input type="text" maxlength="10" class="form-control input-blue-border" placeholder="Host Name" id="HOST_NAME" name="data[REDEMPTION_AMOUNT]" value="<?php echo isset($data['REDEMPTION_AMOUNT'])? htmlentities($data['REDEMPTION_AMOUNT']):'';?>">
								</div>
							</div>
							<div class="col-sm-12 col-md-3 mb-3">
								<div class="form-group">
  ...
  return base64_encode($encoded);
				...
				<div class="overflow-visible">
						...
						<?php foreach($resultset['data'] as $val): ?>
							<tr>
							<td><?php echo $val['MESSAGE_TYPE']; ?></td>
								<td>
								...
								<?php if(!empty($val['CARD_NUM']) && strlen($val['CARD_NUM']) > 10) {
   $maskCardNo = substr($val['CARD_NUM'], 0, 6) . str_repeat("X", strlen($val['CARD_NUM']) - 10) . substr($val['CARD_NUM'], -4);
}  ?>
								<span class="cardNumber" data-mask="<?php echo encrypt($maskCardNo); ?>" data-unmask="<?php echo encrypt($val['CARD_NUM']); ?>">
								...
								<td align="right"><?php 
									if(!empty($val["TOTAL_AMOUNT"])) { 
									    if($val["TOTAL_AMOUNT"]!="000000000000"){ 
