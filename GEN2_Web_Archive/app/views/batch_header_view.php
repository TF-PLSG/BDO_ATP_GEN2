      ...
      <div class="container">
        ...
        <div class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            ...
            <li><a href="<?php echo PATHURL; ?>batch/header/" class="nav-items-link-active"><i class="fa fa-fw fa-table"></i> BCH01</a></li>
		...
		<div class="row">
			<div class="col-lg-12">
				<h3 class="page-header">
					<span class="page-header-text">BCH01 Batch Header Lookup</span>
					<div class="filter-div-settings text-right">
						...
						<a href="<?php echo PATHURL; ?>batch/header/" class="btn btn-transparent-outlined"><i class="fa fa-fw fa-undo"></i> Reset Filter</a>
				...
				<div class="well filter-div">
					<form name="signinform" action="<?php echo PATHURL; ?>batch/header/" method="POST" class="form-signin" role="form" onsubmit="">
						<div class="row">
								<div class="col-sm-12 col-md-3 mb-3">
									<div class="form-group">
										<label>Device Id</label>
										<input type="text" id="DEVICE_ID" maxlength="10" class="form-control input-blue-border" placeholder="Device Id" name="data[DEVICE_ID]" value="<?php echo isset($data['DEVICE_ID'])? htmlentities($data['DEVICE_ID']):'';?>" >
									</div>
								</div>
								<div class="col-sm-12 col-md-3 mb-3">
									<div class="form-group">
										<label>Batch Number</label>
										<input type="text" id="BATCH_NBR" maxlength="10" class="form-control input-blue-border" placeholder="Batch Number" name="data[BATCH_NBR]" value="<?php echo isset($data['BATCH_NBR'])? htmlentities($data['BATCH_NBR']):'';?>">
									</div>
								</div>
