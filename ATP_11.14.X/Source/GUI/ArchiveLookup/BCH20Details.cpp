// BCH20Details.cpp : implementation file
//
...
CBCH20Details::CBCH20Details(CWnd* pParent /*=NULL*/)
	: CDialog(CBCH20Details::IDD, pParent)
{
	//{{AFX_DATA_INIT(CBCH20Details)
	m_sz_auth_number = _T("");
	m_sz_batch_nbr = _T("");
	m_sz_card_nbr = _T("");
	m_sz_device_id = _T("");
...
void CBCH20Details::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CBCH20Details)
	...
	DDX_Text(pDX, IDC_PROCESSED, m_sz_processed);
	DDX_Text(pDX, IDC_PURGE_DATE2, m_sz_purge_date);
	//}}AFX_DATA_MAP
}


BEGIN_MESSAGE_MAP(CBCH20Details, CDialog)
	//{{AFX_MSG_MAP(CBCH20Details)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()

/////////////////////////////////////////////////////////////////////////////
// CBCH20Details message handlers

BOOL CBCH20Details::OnInitDialog() 
{
	...
	m_sz_processed			 = sBatchRecord.processed;
