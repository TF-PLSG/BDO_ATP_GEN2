...
#define LVS_EX_RED   0x0600

#define	GETFIRSTSELECTEDITEM	WM_USER + 100
#define	GETITEMTEXT				WM_USER + 101
#define	UPDATEITEMTEXT			WM_USER + 102
#define	SETRED					WM_USER + 103
#define	SORT					WM_USER + 104
#define	INSERTITEM				WM_USER + 105
#define	GETITEMCOUNT			WM_USER + 106
#define	SETITEMTEXT				WM_USER + 107
#define GETSELECTEDITEMTEXT		WM_USER + 108
#define LIST_LOCK				WM_USER + 109
#define LIST_UNLOCK				WM_USER + 110
#define GETSELECTEDROW			WM_USER + 111

#define WM_LIST_RESIZE			WM_USER + 200
...
///////////////////////////////////////////////////////////////////////////
// The CListViewCtrlEx class definition
///////////////////////////////////////////////////////////////////////////
...
protected:
	...
	CVector<ColumnState>	m_ColumnStates;
	...
	class CListViewHeaderCtrl : public CHeaderCtrl			
	{
	public:		
		CListViewHeaderCtrl();
		virtual ~CListViewHeaderCtrl() {};	
...
public:
	...
	int InsertColumn(CVector <CString> vColumnNames, int nFormat = LVCFMT_LEFT, int nWidth = -1, int nSubItem = -1);
	...
	BOOL UpdateItemText(const CString& row_name, int iSubItem, LPTSTR lpszText);
	BOOL UpdateItemText(const CString& row_name, int iSubItem, double val, int nPrecision = -1); // Double.    
	BOOL UpdateItemText(const CString& row_name, int iSubItem, float val, int nPrecision = -1); // Float.      
	BOOL UpdateItemText(const CString& row_name, int iSubItem, ULONG val); // Unsigned long.                   
	BOOL UpdateItemText(const CString& row_name, int iSubItem, LONG val); // Long.                             
	BOOL UpdateItemText(const CString& row_name, int iSubItem, UINT val); // Unsigned int.                     
	BOOL UpdateItemText(const CString& row_name, int iSubItem, INT val); // Int.                               
	BOOL UpdateItemText(const CString& row_name, int iSubItem, USHORT val); // Unsigned short.                 
	BOOL UpdateItemText(const CString& row_name, int iSubItem, SHORT val); // Short.                           
	BOOL UpdateItemText(const CString& row_name, int iSubItem, BYTE val); // Byte.                             
	BOOL UpdateItemText(const CString& row_name, int iSubItem, TCHAR val); // TCHAR.              
	void GetSelectedItemText(CString &szSelectedStr, int nSubItem = 0);
	void GetSelectedRow(CVector <CString> &row);
	// Sorting
	...
	void SetRed(int nItem, BOOL bRed);
	void SetRed(const CString &row_name, BOOL bRed);
	int GetRowNumber(int nColumn, const CString &szCell);
// Overrides
	// ClassWizard generated virtual function overrides
	//{{AFX_VIRTUAL(CListViewCtrlEx)
	protected:
...
protected:
	...
	////////////////////////////////////////////////////////////////////////////////
	// The header control only used by CListViewCtrlEx
	////////////////////////////////////////////////////////////////////////////////

	// Member data
	CListViewHeaderCtrl m_wndHeader;

protected:
	// Wizzard generated stuff

	//{{AFX_MSG(CListViewCtrlEx)
