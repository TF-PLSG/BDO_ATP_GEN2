...
* Revision History:
*  
* $Log:   N:\PVCS\PTE\Equitable\ATP_gui\DialogRouter.h  $
   ...
   PVCS was locked.
      ...
      Rev 1.1   Sep 22 1999 15:49:24   iarustam
...
*
************************************************************************************/
// DialogRouter.h : header file
//

/////////////////////////////////////////////////////////////////////////////
// CDialogRouter dialog

class CDialogRouter : public CDialog
{
// Construction
public:
	CDialogRouter(CWnd* pParent = NULL);   // standard constructor
	CTime c_time;
// Dialog Data
	//{{AFX_DATA(CDialogRouter)
