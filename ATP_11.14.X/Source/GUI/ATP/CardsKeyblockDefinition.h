...
*
************************************************************************************/
// CardsKeyblockDefinition.h : header file
//

/////////////////////////////////////////////////////////////////////////////
// CCardsKeyblockDefinition dialog
#ifndef CCARDSKEYBLOCKDEFINITION
#define CCARDSKEYBLOCKDEFINITION
...
class CCardsKeyblockDefinition : public CPropertyPage
{
	DECLARE_DYNCREATE(CCardsKeyblockDefinition)

// Construction
public:
	CCardsKeyblockDefinition();
	~CCardsKeyblockDefinition();
    ...
    BOOL PopulateProfileIdDialogFromDatabase ( CAF01_KEYBLOCK);    
    BOOL PopulateProfileIdDatabaseStructureFromDialog ( pCAF01_KEYBLOCK ); 
    BOOL CheckDialogForCompleteness();
    BOOL CheckTime();

    //CCardsMerchantLimit *pMerchantLimitPage;
    CCardsKeyblockProcessing *pProcessingPage;
