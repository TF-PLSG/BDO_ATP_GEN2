...
#ifndef CNETWORKDEFINITION
#define CNETWORKDEFINITION
...
class CNetworkDefinition : public CPropertyPage
{
	DECLARE_DYNCREATE(CNetworkDefinition)
...
public:
	...
	BOOL PopulateDatabaseFromNetworkDialog( pNCF01, pNCF02  );
	BOOL PopulateNetworkDialogFromDatabase( NCF01, NCF02  );
	BOOL CheckDialogForCompleteness();
	void PopulateHistoryTable();


	CNetworkGeneral *pGeneralPage;
	CNetworkGeneral1 *pGeneral1Page;
	CNetworkTotals *pTotalsPage;
	CNetworkProcessing *pProcessingPage;
	CNetworkLogon *pLogonPage;
    CChangeHistory *pChangeHistoryPage;
	CTime c_time;
// Dialog Data
	//{{AFX_DATA(CNetworkDefinition)
	enum { IDD = IDD_NETWORK_DEFINITION };
