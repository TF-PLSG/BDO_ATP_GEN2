...
* Revision History:
*  
* $Log:   N:\PVCS\PTE\Equitable\ATP_gui\DialogConfig.cpp  $
   ...
   PVCS was locked.
      ...
      Rev 1.1   Sep 22 1999 15:48:50   iarustam
...
/////////////////////////////////////////////////////////////////////////////
// CDialogConfig property page

IMPLEMENT_DYNCREATE(CDialogConfig, CPropertyPage)

CDialogConfig::CDialogConfig() : CPropertyPage(CDialogConfig::IDD)
{
...
BEGIN_MESSAGE_MAP(CDialogConfig, CPropertyPage)
...
BOOL CDialogConfig::OnCommand(WPARAM wParam, LPARAM lParam) 
{
