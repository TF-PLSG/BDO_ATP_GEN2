...
*
************************************************************************************/
// NetworkAcquirerPropertySheet.cpp : implementation file
//
...
IMPLEMENT_DYNAMIC(CNetworkAcquirerPropertySheet, CPropertySheet)

CNetworkAcquirerPropertySheet::CNetworkAcquirerPropertySheet(UINT nIDCaption, CWnd* pParentWnd, UINT iSelectPage)
	:CPropertySheet(nIDCaption, pParentWnd, iSelectPage)
{
}

CNetworkAcquirerPropertySheet::CNetworkAcquirerPropertySheet(LPCTSTR pszCaption, CWnd* pParentWnd, UINT iSelectPage)
...
CNetworkAcquirerPropertySheet::~CNetworkAcquirerPropertySheet()
{
}


BEGIN_MESSAGE_MAP(CNetworkAcquirerPropertySheet, CPropertySheet)
	//{{AFX_MSG_MAP(CNetworkAcquirerPropertySheet)
		// NOTE - the ClassWizard will add and remove mapping macros here.
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()

/////////////////////////////////////////////////////////////////////////////
// CNetworkAcquirerPropertySheet message handlers

void CNetworkAcquirerPropertySheet::SetData()
{
