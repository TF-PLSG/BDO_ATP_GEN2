...
*   
************************************************************************************/
// RelatedPropertySheet.cpp : implementation file
//
...
IMPLEMENT_DYNAMIC(CRelatedPropertySheet, CPropertySheet)

CRelatedPropertySheet::CRelatedPropertySheet(UINT nIDCaption, CWnd* pParentWnd, UINT iSelectPage)
	:CPropertySheet(nIDCaption, pParentWnd, iSelectPage)
{
}

CRelatedPropertySheet::CRelatedPropertySheet(LPCTSTR pszCaption, CWnd* pParentWnd, UINT iSelectPage)
...
CRelatedPropertySheet::~CRelatedPropertySheet()
{
}


BEGIN_MESSAGE_MAP(CRelatedPropertySheet, CPropertySheet)
...
void CRelatedPropertySheet::SetData()
{
