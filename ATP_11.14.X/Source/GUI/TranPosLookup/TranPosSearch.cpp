...
* Revision History:
*  
* $Log:   N:\PVCS\PTE\Equitable\tran_lookup\TranPosSearch.cpp  $
   
      Rev 1.0   Jan 25 2011  16:55:18   TF-Sriaknth
   Added Idle Time of Tranlookup module
   
     
*
************************************************************************************/
// TranPosSearch.cpp : Defines the class behaviors for the application.
//
...
BEGIN_MESSAGE_MAP(CTranPosSearchApp, CWinApp)
	//{{AFX_MSG_MAP(CTranPosSearchApp)
...
/////////////////////////////////////////////////////////////////////////////
// CTranPosSearchApp construction

CTranPosSearchApp::CTranPosSearchApp()
{
...
/////////////////////////////////////////////////////////////////////////////
// The one and only CTranPosSearchApp object

CTranPosSearchApp theApp;

/////////////////////////////////////////////////////////////////////////////
// CTranPosSearchApp initialization

BOOL CTranPosSearchApp::InitInstance()
{
	char error_msg[300];
...
CAboutDlg::CAboutDlg() : CDialog(CAboutDlg::IDD)
{
	...
	//}}AFX_DATA_INIT
	char temp_buff[50];
	sprintf(temp_buff, "ATP - TranPosSearch. Version : %s", appProductVersion);
...
void CTranPosSearchApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}
