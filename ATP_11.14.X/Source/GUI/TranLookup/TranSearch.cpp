...
* Revision History:
*  
* $Log:   N:\PVCS\PTE\Equitable\tran_lookup\TranSearch.cpp  $
...
*
************************************************************************************/
// TranSearch.cpp : Defines the class behaviors for the application.
//
...
BEGIN_MESSAGE_MAP(CTranSearchApp, CWinApp)
	//{{AFX_MSG_MAP(CTranSearchApp)
...
/////////////////////////////////////////////////////////////////////////////
// CTranSearchApp construction

CTranSearchApp::CTranSearchApp()
{
...
/////////////////////////////////////////////////////////////////////////////
// The one and only CTranSearchApp object

CTranSearchApp theApp;

/////////////////////////////////////////////////////////////////////////////
// CTranSearchApp initialization

BOOL CTranSearchApp::InitInstance()
{
	char error_msg[300];
...
void CTranSearchApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}
