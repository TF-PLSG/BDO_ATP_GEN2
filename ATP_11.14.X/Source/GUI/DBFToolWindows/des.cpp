/******************************************************************************
   ...
   $Log:   N:\PVCS\PTE\CORE\PTE_LIB\DES.C  $
   
      Rev 1.1   Aug 23 1999 17:01:38   MSALEH
   add brackets to be clearer
...
unsigned short  in[],unsigned short   out[],unsigned short   base_rule)
...
unsigned short  x,unsigned short p1,unsigned short p2)
{
...
unsigned short  key[],unsigned short 
						 subkeys[])
{
		unsigned short  i,
								 y,
...
/**/
void K_DES( //text, key, encrypt, work )
unsigned short  text[4],
			unsigned short   key[4],
			unsigned short  encrypt,
			unsigned short   work[52])  /* four words of key, and 48 words of subkeys */
{
