...
void K_DES  ( unsigned short *, unsigned short *, unsigned short , unsigned short * );
...
INT encrypt_key ( pBYTE key_in, pBYTE key_out )
{
  ...
  K_DES ((unsigned short*)ukey, (unsigned short*)hard_key, (unsigned short)1, (unsigned short*)work);
...
INT decrypt_key ( pBYTE key_in, pWORD key_out )
{
  ...
  K_DES ((unsigned short*)key_out, (unsigned short*)hard_key, (unsigned short)0, (unsigned short*)work);
...
INT des_encryption ( pBYTE buffer, INT buffer_len, pWORD des_key, INT mode )
{
  ...
  for (offset=0; offset < buffer_len; offset=offset+8)
    ...
    K_DES ((unsigned short*)temp1, (unsigned short*)des_key, (unsigned short)1, (unsigned short*)work);
...
INT des_decryption ( pBYTE buffer, INT buffer_len, pWORD des_key, INT mode )
{
  ...
  for (offset=0; offset < buffer_len; offset=offset+8)
    ...
    K_DES ((unsigned short*)temp2, (unsigned short*)des_key, (unsigned short)0, (unsigned short*)work);
...
INT password_cryption ( pBYTE data, INT encrypt )
{
  ...
  K_DES((unsigned short*)buffer, (unsigned short*)hard_key1, (unsigned short)encrypt, (unsigned short*)work);
