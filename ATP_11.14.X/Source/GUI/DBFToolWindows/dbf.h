...
*  
* TITLE:            DBF file decryptor . 
*  
* DESCRIPTION:        
*
* APPLICATION:      dbf_tool.exe
*
* AUTHOR:           Karthick Anna
*
* REVISION HISTORY:
*
* 
...
#define VERSION_INCOMPATIBLE -11
#define FILE_INCOMPATIBLE -12
#define ALEADY_DECRYPTED -13


/*** Common structure for current terminal batch ***/

// DBF TLF01
typedef struct _DBF_TLF01
{
