...
struct iso_msg_rec
   {
        BYTE msgtype_bcd   [2];			//farad 8/9/1998	BYTE msgtype   [4];
        BYTE bitmap1_bin   [8];
        BYTE bitmap2_bin   [8];
		...
		BYTE pan_ctry_cd   [2];
        BYTE posentry      [2];			//farad 8/9/98  BYTE posentry      [3]; 
        BYTE cardseqnum    [2];
        BYTE nii           [2];			  
        BYTE pos_condcd    [1];			   
        BYTE pin_captcd    [1];
        ...
        BYTE tran_curr_cd  [2];			//farad 8/10/98  BYTE tran_curr_cd  [3];
        							  	         //farad 8/10/98  BYTE settle_cur_cd [3];
        BYTE card_curr_cd  [2];			//farad 8/10/98	 BYTE card_curr_cd  [3];
        ...
        BYTE addlamts      [120];		//farad 8/10/98	 BYTE addlamts      [120];
     	BYTE ICCdata_len   [1];								//farad 8/10/98  BYTE advice_cd_len [3];
