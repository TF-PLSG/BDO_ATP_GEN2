 ...
 * All Rights Reserved.
 *
 * MODULE:      NCEQ_CURRENCY.C
 *  
 * TITLE:       Equitable Network Controller Currency Conversion Processor
 *  
 ...
 * $Log:   N:\PVCS\PTE\Equitable\nceqit_ncmlnk_iso_format\nceq_currency.c  $
      ...
      Rev 1.3   Sep 02 2004 17:10:42   dirby
   Modified to support extremely large amounts.
   SCR 1471
   
      Rev 1.2   Sep 27 2001 09:49:32   dirby
   Straightened out some indentation and changed a comment.  SCR 447
   
      Rev 1.1   Aug 27 2001 14:02:20   SYARLAGA
   Modified  perform_currency_conversion function.
   
      Rev 1.0   Aug 06 2001 09:48:08   dirby
   Initial revision.
 *
 ****************************************************************************/
#include <stdio.h>
