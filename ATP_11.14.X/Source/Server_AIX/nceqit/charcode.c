/******************************************************************************
    ...
    $Log:   N:\PVCS\PTE\Equitable\nceqit_ncmlnk_iso_format\charcode.c  $
   
      Rev 1.2   Aug 20 2001 17:05:56   dirby
   Modified 'hex_to_ebcdic' and 'ebcdic_to_hex' conversion
   functions to use upper case characters.  Reference SCR 441.
   
      Rev 1.1   Aug 13 2001 17:14:48   SYARLAGA
   Added conversion functions   HEX_TO_EBCDIC and           EBCDIC_TO_HEX.
   
      Rev 1.0   Aug 06 2001 09:47:44   dirby
   Initial revision.
   
      Rev 1.1   01 Apr 1999 11:24:34   rmalathk
   ...
   2. minor changes for sending the network
      ...
      Rev 1.0   17 Mar 1999 11:10:06   rmalathk
   Initial Release
