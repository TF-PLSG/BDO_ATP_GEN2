...
#include "dcpos_iso_utilities.h"  // Includes all function prototypes for ISO standard utilities
...
#define N_BFData ( sizeof(BFData) / sizeof (struct bitfield_data) )
	...
	********************************************/
	...
	{
	/********************************************
		P R E A U T H C A N C L E   R E S P O N S E
		********************************************/
    ...
    ********************************************/
	...
	{
	      /********************************************
	         R E L O A D  R E P E A T R E S P O N S E
	      ********************************************/
...
extern void isoutil_build_terminal_response ( INT trantype)
{
   ...
   {
      dcpos_log_message( 1, 1, "Response transaction message type is not found",
...
{
   CHAR temp[70]         = {0};
   CHAR templen_bcd[4]   = {0};
   CHAR templen_ascii[8] = {0};
   INT  cvc2_len = 0;
   INT  num_spaces = 0;
   INT  i = 0;
   INT  f48_len = 0;
...
extern BOOLEAN isoutil_RspMovevBCD (enum bitfields fieldid)
{
   ...
   if (isoutil_verify_fieldlen(fieldid, movelen) == false)
   {
      ...
      dcpos_log_message( 1, 2, Buff, "isoutil_RspMovevBCD",0 );
	  return false;
   }
