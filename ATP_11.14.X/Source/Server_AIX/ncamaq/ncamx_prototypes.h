...
* All Rights Reserved.
*
* MODULE:      NCAMX_PROTOTYPES.H
*  
* TITLE:       Amex Network Control Function Prototypes
*  
...
void 	ncamaq_log_message( INT dest, INT severity, pCHAR mesg, pCHAR func_name,int details );
...
void  vEmvDataMove(enum bitfields fieldid);
...
void 	issue_1804( INT request_type );
INT  	issue_1814( INT request_type );
void 	process_1804_request(  void );
void 	process_1814_request( void );
...
INT  	end_18nn_to_host( pCHAR err_buf );

/*-------*/
/* TIMER */
/*-------*/
void 	process_timeout_msg( pPTE_MSG p_msg_in );
INT  	end_timeout_response( pCHAR err_buf );
...
void 	decrypt_pin();
void 	process_decrypt_pin_response( pPTE_MSG p_msg_in );
