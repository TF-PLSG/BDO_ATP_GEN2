...
static  struct trandef TRANTABLE[] = {
	  ...
	  /* 0100 MESSAGES */
	{
	  ...
	  *******************************************************/
	  ...
	  0x30,0x31,0x30,0x30,                  /* message id, 0100 */
	  0x33,0x33,0x30,0x30,0x30,0x30,        /* processing code */
	  /**** OPTIONS ****/
	  topt1_postadv,
	  topt2_referral+topt2_reversal+topt2_floor,
	  /**** BIT FIELDS ****/
	...
	{ 
		/*************************************************************
		  ...
		  Currently BDO HOST is not supporting 0120 and 0121 message type.
		*************************************************************/
		AUTH_ADVICE,
		0x30,0x31,0x32,0x30, 				 /* message id, 0220 */
		0x30,0x30,0x30,0x30,0x30,0x30,		 /* processing code */
		/**** OPTIONS ****/
		topt1_postadv,
		topt2_referral+topt2_reversal+topt2_floor,
		...
		bf_55IccData,	/* COND */
		bf_60selfdeffeild,   /* MAND */
		bf_61cardholderauthinfo,
		bf_104tranindappinfo,
		bf_117PaymtFacilitator,	/* COND */
		bf_125dstransactionid,
		//bf_62SwitchingData,		/* COND */
		bf_done		/* end of fields to move */
	},
	...
	{ 
		...
		*************************************************************/
		...
		0x30,0x31,0x33,0x30, 				 /* message id, 0130 */
		0x30,0x30,0x30,0x30,0x30,0x30,		 /* processing code */
		/**** OPTIONS ****/
		topt1_postadv,
		topt2_referral+topt2_reversal+topt2_floor,
	...
	{ 
		...
		*************************************************************/
		AUTH_ADVICE_REPEAT,
		0x30,0x31,0x32,0x31, 				 /* message id, 0121*/
		0x30,0x30,0x30,0x30,0x30,0x30,		 /* processing code */
		/**** OPTIONS ****/
		topt1_postadv,
		topt2_referral+topt2_reversal+topt2_floor,
	...
	{ 
		...
		**********************************************************************/
		...
		0x30,0x31,0x33,0x31, 				 /* message id,0131 */
		0x30,0x30,0x30,0x30,0x30,0x30,		 /* processing code */
		/**** OPTIONS ****/
		topt1_postadv,
		topt2_referral+topt2_reversal+topt2_floor,
			...
			Abhishek
			 AUTH_VOID_SALE
				...
				Note:Only the value of field 25 is used to distinguish from
					traditional pre-authorization transaction and 
					MO/TO Pre-authorization request
				We are sending 100 for cadence only
		  *******************************************************/
		  AUTH_VOID_SALE,
		  0x30,0x31,0x30,0x30,					/* message id, 0100 */
			...
			Abhishek
			 AUTH_VOID_SALE RESPONSE
				...
				Note:Only the value of field 25 is used to distinguish from
					traditional pre-authorization transaction and 
					MO/TO Pre-authorization request
				We are sending 110 for cadence only
		  ***********************************************/
