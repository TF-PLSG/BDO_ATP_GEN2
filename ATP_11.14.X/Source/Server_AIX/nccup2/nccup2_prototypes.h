...
void 	perform_host_key_send(void);
...
void 	nccup2_log_message( INT dest, INT severity, pCHAR mesg, pCHAR func_name, int details );
...
INT  	nccup2_Log_error_warning_to_File(pCHAR Error_Buf,int sev,pCHAR func,int details);
...
INT 	move_field_14( pINT result_flag, pCHAR err_buf );  /* Girija Y - ThoughtFocus */
...
INT 	move_field_44( pINT result_flag, pCHAR err_buf ); /* Girija Y - ThoughtFocus */
