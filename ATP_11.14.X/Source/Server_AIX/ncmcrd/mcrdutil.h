...
enum bitfields {
   ...
   bf_106fleetservicedata =106, /*Fleet Service data*/
   bf_108moneySend    = 108,    /* Money send data             */
   bf_112addldata    = 112,    /* Additinal data			*/
...
static  struct trandef TRANTABLE[] = {
	...
	/* BDO wants to send Void and Reversal Txn to MC host  (09-76)  29 Oct,2009TF-Ajay  */
	   { 
      /********************************************
         R E V E R S A L
      ********************************************/
	  ...
	  /* BDO wants to send Void and Reversal Txn to MC host  TF-Ajay 06 Nov,2009 */
	  { 
      /********************************************
...
struct iso_msg_rec
{
		...
		BYTE de108_len		[3];
		BYTE de108			[999];
		BYTE fleetservicedata[1000];
		BYTE fleetservicedata_len[3];
        BYTE filename_len  [2];
        BYTE filename      [17];
...
/******************************************************************************/
   ...
   {  /* TF-Ajay (09-76) to support Void & Reversal txn 30 Oct,2009*/
   ...
   {
	bf_106fleetservicedata,                 /* field */
	HOST_MESSAGE.fleetservicedata_len,     /* data to move */
	3,                            /* # of bytes in addl len field */
	Move_IfThere,                  /* mandatory */
	vEBCDICMove,                  /* move routine */
	RspEBCDICvMove
