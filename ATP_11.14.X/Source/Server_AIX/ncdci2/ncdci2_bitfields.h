 ...
 * All Rights Reserved.
 *
 * MODULE:      ncdci2_bitfields.h
 *  
 * TITLE:       ncdci2 Network Control Bit Field Definitions
 *  
...
static  struct trandef TRANTABLE[] = {
		...
		***********************************************/
		{
			...
			0x31,0x31,0x31,0x30,                  /* message id, 1210 */
		...
		********************************/
		{
			 AUTH_CARD_UPDATE,
			 0x31,0x33,0x30,0x34,                  /* message id, 1304 */
			 0x30,0x30,0x30,0x30,0x30,0x30,        /* processing code */
			 /**** OPTIONS ****/
			 topt1_postadv,
			 topt2_referral+topt2_reversal+topt2_floor,
		  ...
		  ********************************/
		  {
			 ...
			 0x31,0x33,0x31,0x34,                  /* message id, 1314 */
			 0x30,0x30,0x30,0x30,0x30,0x30,        /* processing code */
			 /**** OPTIONS ****/
			 topt1_postadv,
			 topt2_referral+topt2_reversal+topt2_floor,
...
struct bitfield_data *ncdci2_Find_Bitfield_Table (enum bitfields);
...
struct iso_msg_rec  ncdci2_HOST_MESSAGE;
...
static  struct bitfield_data BFData[] = {
	{
		...
		ncdci2_HOST_MESSAGE.pan_len,         	/* data to move */
		2,                           		/* # of bytes in pan len field */
		ncdci2_Move_IfThere,                  /* mandatory */
		ncdci2_vDataMove,                     /* move routine */
		ncdci2_RspMovevData                   /* response routine */
	},
	{
		bf_3proc,                     		/* field */
		ncdci2_HOST_MESSAGE.proccode,        	/* data to move */
		6,                            		/* # of bytes in  iso field */
		ncdci2_Move_Always,                 	 /* mandatory */
		ncdci2_GenericMove,                   /* move routine */
		ncdci2_RspMoveGeneric                 /* response routine */
	},
	{
		bf_4amount,                   		/* field */
		ncdci2_HOST_MESSAGE.amount,           /* data to move */
	...
	},
	{
		...
		ncdci2_HOST_MESSAGE.ch_bill_amt,      /* data to move */
		12,                           		/* # of bytes in  iso field */
		ncdci2_Move_IfThere,                  /* mandatory */
		ncdci2_GenericMove,                   /* move routine */
		ncdci2_RspMoveGeneric                 /* response routine */
	...
	{
		bf_7trntime,                  /* field */
		ncdci2_HOST_MESSAGE.gmt_time,        /* data to move : MMDDhhmmss*/
		10,                           /* # of bytes in  iso field */
		ncdci2_Move_IfThere,                  /* conditional */
		ncdci2_GenericMove,                   /* move routine */
		ncdci2_RspMoveGeneric                 /* response routine */
	},
	{
		bf_11stan,                    /* field */
		ncdci2_HOST_MESSAGE.stan,            /* data to move */
		6,                            /* # of bytes in  iso field */
		ncdci2_Move_Always,                  /* conditional */
		ncdci2_GenericMove,                   /* move routine */
		ncdci2_RspMoveGeneric                 /* response routine */
	},
	{
		bf_12time,                    /* field */
		ncdci2_HOST_MESSAGE.time,            /* data to move */
		12,                            /* # of bytes in  iso field */
		ncdci2_Move_IfThere,                  /* conditional */
		ncdci2_GenericMove,                   /* move routine */
		ncdci2_RspMoveGeneric                 /* response routine */
	...
	{
		bf_13date,                    /* field */
		ncdci2_HOST_MESSAGE.date,            /* effective data to move */
	...
	{
		bf_14expiry,                  /* field */
		ncdci2_HOST_MESSAGE.date_expd,       /* data to move */
		4,                            /* # of bytes in field */
		ncdci2_Move_IfThere,                     /* conditional */
		ncdci2_GenericMove,                   /* move routine */
		ncdci2_RspMoveGeneric                 /* response routine */
	...
	{
		bf_22posentry,                /* field */
		ncdci2_HOST_MESSAGE.posentry,        /* data to move */
		12,                            /* # of bytes in  iso field */
		ncdci2_Move_IfThere,                  /* conditional */
		ncdci2_GenericMove,                   /* move routine */
		ncdci2_RspMoveGeneric                 /* response routine */
	...
	{
		bf_23csn,                  /* field */
		ncdci2_HOST_MESSAGE.card_seq_num,         /* data to move */
		3,                            /* # of bytes in field */
		ncdci2_Move_IfThere,                 /* conditional */
		ncdci2_GenericMove,                   /* move routine */
		ncdci2_RspMoveGeneric                 /* response routine */
	},
	{
		...
		ncdci2_HOST_MESSAGE.net_manag_info_code,         /* data to move */
		3,                            /* # of bytes in field */
		ncdci2_Move_IfThere,                 /* conditional */
		ncdci2_GenericMove,                   /* move routine */
		ncdci2_RspMoveGeneric                 /* response routine */
	...
	{
		bf_25poscc,                   /* field */
		ncdci2_HOST_MESSAGE.pos_condcd,      /* data to move */
		4,                            /* # of bytes in  iso field */
		ncdci2_Move_IfThere,                  /* conditional */
		ncdci2_GenericMove,                   /* move routine */
		ncdci2_RspMoveGeneric                 /* response routine */
	...
	{
		bf_26pincode,                 /* field */
		ncdci2_HOST_MESSAGE.accpt_bus_cd,    /* data to move */
		4,                            /* # of bytes in field */
		ncdci2_Move_IfThere,                  /* conditional */
		ncdci2_GenericMove,                   /* move routine */
		ncdci2_RspMoveGeneric                 /* response routine */
	},
	{
		...
		ncdci2_HOST_MESSAGE.Original_amount,    /* data to move */
	...
	{
		bf_32idcode,                  /* field */
		ncdci2_HOST_MESSAGE.acq_inst_len,    /* data to move */
	...
	},
	{
		...
		ncdci2_HOST_MESSAGE.fwd_inst_len,    /* data to move */
		2,                            /* # of bytes in  iso field */
		ncdci2_Move_IfThere,                  /* conditional */
		ncdci2_vDataMove,                  /* move routine */
		ncdci2_RspMovevData                /* response routine */
	...
	{
		bf_35track2,                  /* field */
		ncdci2_HOST_MESSAGE.track2_len,      /* data to move */
	...
	{
		bf_37rrn,                  /* field */
		ncdci2_HOST_MESSAGE.rrn,      /* data to move */
	...
	{
		bf_38authcode,                /* field */
		ncdci2_HOST_MESSAGE.authcode,        /* data to move */
		6,                            /* # of bytes in  iso field */
		ncdci2_Move_IfThere,                 /* conditional */
		ncdci2_GenericMove,                   /* move routine */
		ncdci2_RspMoveGeneric                 /* response routine */
	...
	{
		bf_39respcode,                /* field */
		ncdci2_HOST_MESSAGE.responsecd,      /* data to move */
	...
	},
	{
		...
		ncdci2_HOST_MESSAGE.service_code,      /* data to move */
		3,                            /* # of bytes in  iso field */
		ncdci2_Move_IfThere,                 /* conditional */
		ncdci2_GenericMove,                   /* move routine */
		ncdci2_RspMoveGeneric                 /* response routine */
	...
	{
		bf_41termid,                  /* field */
		ncdci2_HOST_MESSAGE.termid,          /* data to move */
	...
	{
		bf_42cardacc,                 /* field */
		ncdci2_HOST_MESSAGE.cardaccid,       /* data to move */
		15,                           /* # of bytes in  iso field */
		ncdci2_Move_IfThereWithSpaces,                  /* conditional */
		ncdci2_GenericMove,                   /* move routine */
		ncdci2_RspMoveGeneric                 /* response routine */
	},
	{
		bf_43cardacceptloc,                 /* field */
		ncdci2_HOST_MESSAGE.cardaccname_len,       /* data to move */
		2,                           /* # of bytes in  iso field */
		ncdci2_Move_IfThere,                  /* conditional */
		ncdci2_vDataMove,                   /* move routine */
		ncdci2_RspMovevData					/* response routine */
	...
	{
		bf_44respdata,                 /* field */
		ncdci2_HOST_MESSAGE.addl_rsp_len,       /* data to move */
		2,                           /* # of bytes in  iso field */
		ncdci2_Move_IfThere,                  /* conditional */
		ncdci2_vDataMove,                   /* move routine */
		ncdci2_RspMovevData					/* response routine */
	...
	{
		bf_45track1,                  /* field */
		ncdci2_HOST_MESSAGE.track1_len,      /* data to move */
	...
	},
	{
		...
		ncdci2_HOST_MESSAGE.surcharge_fee_len,      /* data to move */
	...
	{
		bf_48addldata,                /* field */
		ncdci2_HOST_MESSAGE.addl_data_len,   /* data to move */
	...
	{
		bf_49trncurcd,               /* field */
		ncdci2_HOST_MESSAGE.tran_curr_cd,   /* data to move */
		3,                           /* # of bytes in  iso field */
		ncdci2_Move_IfThere,                /* mandatory    */
		ncdci2_GenericMove,                 /* move routine */
		ncdci2_RspMoveGeneric				/* response routine */
	...
	{
		bf_51crdcurcd,               /* field */
		ncdci2_HOST_MESSAGE.card_curr_cd,    /* data to move */
		3,                            /* # of bytes in field */
		ncdci2_Move_IfThere,                 /* mandatory    */
		ncdci2_GenericMove,                   /* move routine */
		ncdci2_RspMoveGeneric                 /* response routine */
	...
	{
		bf_52pinblock,                /* field */
		ncdci2_HOST_MESSAGE.pinblock,        /* data to move */
		8,                            /* # of bytes in  iso field */
		ncdci2_Move_IfThere,                  /* mandatory */
		ncdci2_GenericMove,                  /* move routine */
		ncdci2_RspMoveGeneric                /* response routine */
	},
	{
		...
		ncdci2_HOST_MESSAGE.AddlAmts_len,   /* data to move */
		3,                            /* # of bytes in field */
		ncdci2_Move_IfThere,                  /* mandatory    */
		ncdci2_vDataMove,                  /* move routine */
		ncdci2_RspMovevData                /* response routine */
	...
	{
		bf_55IccData,                 /* field */
		ncdci2_HOST_MESSAGE.IccData_len,   /* data to move */
		3,                            /* # of bytes in field */
		ncdci2_Move_IfThere,                  /* mandatory    */
		ncdci2_vDataMove,                  /* move routine */
		ncdci2_RspMovevData                /* response routine */
	},
	{
		...
		ncdci2_HOST_MESSAGE.orig_data_len,   /* data to move */
		2,                            /* # of bytes in field */
		ncdci2_Move_IfThere,                  /* mandatory    */
		ncdci2_vDataMove,                  /* move routine */
		ncdci2_RspMovevData                /* response routine */
	},
	{
		...
		ncdci2_HOST_MESSAGE.Auth_agent_IIC_len,   /* data to move */
		2,                            /* # of bytes in field */
		ncdci2_Move_IfThere,                 		/* mandatory    */
		ncdci2_vDataMove,               		/* move routine */
		ncdci2_RspMovevData                /* response routine */
	},
	{
		...
		ncdci2_HOST_MESSAGE.NetworkID_Transport_data_len,   /* data to move */
		3,                            /* # of bytes in field */
		ncdci2_Move_IfThere,                  /* mandatory    */
		ncdci2_vDataMove,                  /* move routine */
		ncdci2_RspMovevData                /* response routine */
	},
	{
		...
		ncdci2_HOST_MESSAGE.addition_auth_data_len,   /* data to move */
		3,                            /* # of bytes in field */
		ncdci2_Move_IfThere,                  /* mandatory    */
		ncdci2_vDataMove,                  /* move routine */
		ncdci2_RspMovevData                /* response routine */
	...
	{
		bf_64mac,                 /* field */
		ncdci2_HOST_MESSAGE.mess_auth_code,   /* data to move */
		8,                            /* # of bytes in field */
		ncdci2_Move_IfThere,                  /* mandatory    */
		ncdci2_GenericMove,                   /* move routine */
		ncdci2_RspMovevData                 /* response routine */
	},
	{
		...
		ncdci2_HOST_MESSAGE.data_record_len,   /* data to move */
		3,                            /* # of bytes in field */
		ncdci2_Move_IfThere,                  /* mandatory    */
		ncdci2_vDataMove,                  /* move routine */
		ncdci2_RspMovevData                /* response routine */
	},
	{
		...
		ncdci2_HOST_MESSAGE.ctry_code,    /* data to move */
		3,                            /* # of bytes in field */
		ncdci2_Move_IfThere,                  /* mandatory    */
		ncdci2_GenericMove,                   /* move routine */
		ncdci2_RspMoveGeneric                 /* response routine */              		/* response routine */
	},
	{
		bf_93txdestIIC,                /* field */
		ncdci2_HOST_MESSAGE.TranDestination_ICC_len,    /* data to move */
		2,                            		/* # of bytes in  iso field */
		ncdci2_Move_IfThere,                 		/* mandatory    */
		ncdci2_vDataMove,               		/* move routine */
		ncdci2_RspMovevData                /* response routine */
	},
	{
		...
		ncdci2_HOST_MESSAGE.TranOriginator_ICC_len,    /* data to move */
		2,                            		/* # of bytes in  iso field */
		ncdci2_Move_IfThere,                 		/* mandatory    */
		ncdci2_vDataMove,               		/* move routine */
		ncdci2_RspMovevData                /* response routine */
	},
	{
		...
		ncdci2_HOST_MESSAGE.Key_Managment_data_len,    /* data to move */
		3,                            		/* # of bytes in  iso field */
		ncdci2_Move_IfThere,                 		/* mandatory    */
		ncdci2_vDataMove,               		/* move routine */
		ncdci2_RspMovevData                /* response routine */
	},
	{
		...
		ncdci2_HOST_MESSAGE.recv_ins_id_code_len,    /* data to move */
		2,                            		/* # of bytes in  iso field */
		ncdci2_Move_IfThere,                 		/* mandatory    */
		ncdci2_vDataMove,               		/* move routine */
		ncdci2_RspMovevData                /* response routine */
	},
	{
		...
		ncdci2_HOST_MESSAGE.file_name_len,    /* data to move */
		2,                            		/* # of bytes in  iso field */
		ncdci2_Move_IfThere,                 		/* mandatory    */
		ncdci2_vDataMove,               		/* move routine */
		ncdci2_RspMovevData                /* response routine */
	},
	{
		...
		ncdci2_HOST_MESSAGE.tran_specf_data_len,   /* data to move */
		3,                            /* # of bytes in field */
		ncdci2_Move_IfThere,                  /* mandatory    */
		ncdci2_vDataMove,                  /* move routine */
		ncdci2_RspMovevData                /* response routine */
	},
	{
		...
		ncdci2_HOST_MESSAGE.tran_data_len,   /* data to move */
		3,                            /* # of bytes in field */
		ncdci2_Move_IfThere,                  /* mandatory    */
		ncdci2_vDataMove,                  /* move routine */
		ncdci2_RspMovevData                /* response routine */
	},
	{
		...
		ncdci2_HOST_MESSAGE.Add_authentication_data_len,    /* data to move */
		3,                            		/* # of bytes in  iso field */
		ncdci2_Move_IfThere,                 		/* mandatory    */
		ncdci2_vDataMove,               		/* move routine */
		ncdci2_RspMovevData                /* response routine */
	},
	{
		...
		ncdci2_HOST_MESSAGE.networ_ref_id_len,    /* data to move */
		3,                            		/* # of bytes in  iso field */
		ncdci2_Move_IfThere,                 		/* mandatory    */
		ncdci2_vDataMove,               		/* move routine */
		ncdci2_RspMovevData                /* response routine */
	},
	{
		...
		ncdci2_HOST_MESSAGE.transaction_qualifer_len,    /* data to move */
		3,                            		/* # of bytes in  iso field */
		ncdci2_Move_IfThere,                 		/* mandatory    */
		ncdci2_vDataMove,               		/* move routine */
		ncdci2_RspMovevData                /* response routine */
	},
	{
		...
		ncdci2_HOST_MESSAGE.replacement_pin_len,    /* data to move */
		3,                            		/* # of bytes in  iso field */
		ncdci2_Move_IfThere,                 		/* mandatory    */
		ncdci2_vDataMove,               		/* move routine */
		ncdci2_RspMovevData                /* response routine */
