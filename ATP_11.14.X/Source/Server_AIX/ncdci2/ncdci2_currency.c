 ...
 * All Rights Reserved.
 *
 * MODULE:      ncdci2_currency.C
 *  
 * TITLE:       Diners Network Controller Currency Conversion Processor
 *  
...
/******************************************************************************
 *
 *  NAME:         ncdci2_perform_currency_conversion
 *
   ...
   else
   {
      ...
      else
      {
         ...
         else
         {
             ...
             */
            else if ( 0 == strcmp(cc_in, DINERS_USA_CURRENCY_CODE) )
            {
               rate_in = 1.0;
            }
            ...
            if ( true == ret_val )
            {
               ...
               if ( 0 == strcmp(cc_out, DINERS_USA_CURRENCY_CODE) )
               {
                  rate_out = 1.0;
               }
