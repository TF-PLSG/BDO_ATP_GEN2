 ...
 * All Rights Reserved.
 *
 * MODULE:      ncdci2_stats.c
 *  
 * TITLE:       Diners Network Controller Statistics Processor
 *  
...
/******************************************************************************
 *
 *  NAME:         ncdci2_send_transaction_statistics
 *
 ...
 *  MODIFICATIONS:
 ******************************************************************************/
INT ncdci2_send_transaction_statistics( pPTE_MSG p_msg )
{
   ...
   ret_code = ncdci2_build_and_send_request_message( MT_GET_STATS_RESPONSE, 
                                              ST1_NONE,
                                              ST2_NONE,
                                              originator_queue, 
                                              (pBYTE)&Monitor_Stats,
   ...
   if ( false == ret_code  )
   {
      ncdci2_log_message( 2, 2, err_msg, "ncdci2_send_transaction_statistics",0 );
   }
   return( ret_code );
}
...
/******************************************************************************
 *
 *  NAME:         ncdci2_reset_transaction_statistics
 *
 ...
 *  MODIFICATIONS:
 ******************************************************************************/
INT ncdci2_reset_transaction_statistics( pPTE_MSG p_msg )
{
	   BYTE  originator_queue[17] = {0};
	   BYTE  originator_info[33] = {0};
	   CHAR  err_msg[100] = {0};
   ...
   if ( false == ret_code  )
   {
      ncdci2_log_message( 2, 2, err_msg, "ncdci2_reset_transaction_statistics",0 );
   }
   return( ret_code );
}
