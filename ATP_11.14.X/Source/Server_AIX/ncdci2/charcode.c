...
Function:      ncdci2_init_character_code_maps
...
Return values:
               None
******************************************************************************/
void ncdci2_init_character_code_maps()
{
   // ascii to ebcdic map
...
/*************************************************************************************
       NAME:               ncdci2_convert_int_to_ascii
...
*************************************************************************************/
void ncdci2_convert_int_to_ascii( pBYTE source, pBYTE dest, INT len )
{
   INT  temp = 0;
   BYTE temp_byte = 0;
...
void ncdci2_convert_to_ascii( pBYTE source, pBYTE dest, INT len )
{
   ...
   return;
} /* ncdci2_convert_to_ascii */



/*************************************************************************************
       NAME:               ncdci2_convert_to_ebcdic
       ...
       AUTHOR:             Abhishek Verma
*************************************************************************************/
void ncdci2_convert_to_ebcdic( pBYTE source, pBYTE dest, INT len )
{
   INT temp = 0;
   BYTE temp_byte = 0;
   ...
   return;
} /* ncdci2_convert_to_ebcdic */

/*****************************************************************************/
/******************************************************************************
 *
 *  NAME:         ncdci2_hex_to_ebcdic
 *
 ...
 *
 ******************************************************************************/
void ncdci2_hex_to_ebcdic( pBYTE instr, pBYTE outstr, INT len )
{
   INT   i = 0 ;
   INT   j = 0 ;
   INT   outstr_idx = 0;
    ...
    */
   ncdci2_convert_to_ebcdic( outstr, outstr, len*2 );
 ...
 *
 ******************************************************************************/
void ncdci2_ebcdic_to_hex( pBYTE instr, pBYTE outstr, INT len )
{
   #define  MAX_LEN 100
   ...
   ncdci2_convert_to_ascii( instr, temp_str, len );
...
/*****************************************************************************
  ...
  Modified by:
      FArad      8/14/98
******************************************************************************/
 void ncdci2_asc_to_bcd (afield, how_many, bstring)
...
/*****************************************************************************
  ...
  Modified by:
******************************************************************************/
void ncdci2_bcd_to_asc (bstring, blen, astr, astr_len)
   BYTE bstring[];
   INT          blen;
   pCHAR        astr;
   INT          astr_len;
