...
public class FalconArchive {

	/**
	 * @param args
	 */
	private final static Logger logger = LogManager.getLogger(FalconArchive.class);
	...
	public static void main(String[] args) {
		...
		try{
			...
			if(propFilePath !=null){
			   //Stirng 
			   /*String loggerPath = propFilePath+"/trace/falconArchive"+getCurrentTimeStamp()+".log";
			...
			messageSender.setup();
			String msgTextFile = propFilePath+"/log/Falcon_Archive.txt";
