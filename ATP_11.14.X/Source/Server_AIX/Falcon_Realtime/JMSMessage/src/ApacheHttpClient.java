...
public class ApacheHttpClient {
	...
	public void writeData(String data) throws Exception {
		System.out.println("Data comming to ApacheHttpClient writeData()---------"+data);
		writeToService(data);
		System.out.println("Transaction is logging into archive file...!!!");		
	}
...
/*	public static void enableApacheHttpClientLogger() {
		String propFilePath = System.getenv("ASCENDENTROOT");
		try {
...
*/
	 ...
	 * startOfTransaction(); for (int i = 0; i < 10; i++) writeData();
	 * endOfTransaction(); }
	 */
	}
