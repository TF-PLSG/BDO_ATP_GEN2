...
void CheckNULLTerminatedinMCF03P(pMCF03P mcf03p,pCHAR mode );
...
void CheckNULLTerminatedinMCF03P(pMCF03P mcf03p,pCHAR mode )
{
	checknull(mcf03p->merch_id ,sizeof(mcf03p->merch_id),"MCF01","merch_id","CheckNULLTerminatedinMCF03P",mode);
	checknull(mcf03p->system_date ,sizeof(mcf03p->system_date),"MCF01","system_date","CheckNULLTerminatedinMCF03P",mode);
	checknull(mcf03p->total_amount ,sizeof(mcf03p->total_amount),"MCF01","total_amount","CheckNULLTerminatedinMCF03P",mode);
	checknull(mcf03p->total_transcn_cnt ,sizeof(mcf03p->total_transcn_cnt),"MCF01","total_transcn_cnt","CheckNULLTerminatedinMCF03P",mode);
	checknull(mcf03p->total_aprvd_amount ,sizeof(mcf03p->total_aprvd_amount),"MCF01","total_aprvd_amount","CheckNULLTerminatedinMCF03P",mode);
	checknull(mcf03p->total_reversed_amount ,sizeof(mcf03p->total_reversed_amount),"MCF01","total_reversed_amount","CheckNULLTerminatedinMCF03P",mode);
	checknull(mcf03p->total_aprvd_transcn_count ,sizeof(mcf03p->total_aprvd_transcn_count),"MCF01","total_aprvd_transcn_count","CheckNULLTerminatedinMCF03P",mode);
	checknull(mcf03p->total_reversed_transcn_count ,sizeof(mcf03p->total_reversed_transcn_count),"MCF01","total_reversed_transcn_count","CheckNULLTerminatedinMCF03P",mode);
	checknull(mcf03p->field_1 ,sizeof(mcf03p->field_1),"MCF01","field_1","CheckNULLTerminatedinMCF03P",mode);
	checknull(mcf03p->field_2 ,sizeof(mcf03p->field_2),"MCF01","field_2","CheckNULLTerminatedinMCF03P",mode);
	checknull(mcf03p->field_3 ,sizeof(mcf03p->field_3),"MCF01","field_3","CheckNULLTerminatedinMCF03P",mode);
	checknull(mcf03p->field_4 ,sizeof(mcf03p->field_4),"MCF01","field_4","CheckNULLTerminatedinMCF03P",mode);
	checknull(mcf03p->field_5 ,sizeof(mcf03p->field_5),"MCF01","field_5","CheckNULLTerminatedinMCF03P",mode);
	checknull(mcf03p->field_6 ,sizeof(mcf03p->field_6),"MCF01","field_6","CheckNULLTerminatedinMCF03P",mode);
	checknull(mcf03p->field_7 ,sizeof(mcf03p->field_7),"MCF01","field_7","CheckNULLTerminatedinMCF03P",mode);
	checknull(mcf03p->field_8 ,sizeof(mcf03p->field_8),"MCF01","field_8","CheckNULLTerminatedinMCF03P",mode);
	checknull(mcf03p->field_9 ,sizeof(mcf03p->field_9),"MCF01","field_9","CheckNULLTerminatedinMCF03P",mode);
	checknull(mcf03p->field_10 ,sizeof(mcf03p->field_10),"MCF01","field_10","CheckNULLTerminatedinMCF03P",mode);
