 ...
 * All Rights Reserved.
 *
 * MODULE:      ncpul_currency.C
 *  
 * TITLE:       ncpul Network Controller Currency Conversion Processor
 *  
   ...
   else
   {
      ...
      else
      {
         ...
         else
         {
             ...
             */
            else if ( 0 == strcmp(cc_in, PULSE_USA_CURRENCY_CODE) )
            {
               rate_in = 1.0;
            }
            ...
            if ( true == ret_val )
            {
               ...
               if ( 0 == strcmp(cc_out, PULSE_USA_CURRENCY_CODE) )
               {
                  rate_out = 1.0;
               }
