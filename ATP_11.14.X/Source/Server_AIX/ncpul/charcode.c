/******************************************************************************
    ...
    TITLE:  PULSE Host Handler Driver
...
Function:      ncpul_init_character_code_maps
...
Return values:
               None
******************************************************************************/
void ncpul_init_character_code_maps()
{
   // ascii to ebcdic map
...
/*************************************************************************************
       NAME:               ncpul_convert_int_to_ascii
...
*************************************************************************************/
void ncpul_convert_int_to_ascii( pBYTE source, pBYTE dest, INT len )
{
   INT  temp = 0;
   BYTE temp_byte = 0;
...
void ncpul_convert_to_ascii( pBYTE source, pBYTE dest, INT len )
{
   ...
   return;
} /* ncpul_convert_to_ascii */



/*************************************************************************************
       NAME:               ncpul_convert_to_ebcdic
...
void ncpul_convert_to_ebcdic( pBYTE source, pBYTE dest, INT len )
{
   ...
   return;
} /* ncpul_convert_to_ebcdic */

/*****************************************************************************/
/******************************************************************************
 *
 *  NAME:         ncpul_hex_to_ebcdic
 *
 ...
 *
 ******************************************************************************/
void ncpul_hex_to_ebcdic( pBYTE instr, pBYTE outstr, INT len )
{
   INT   i = 0;
   INT   j = 0;
   INT   outstr_idx = 0;
    ...
    */
   ncpul_convert_to_ebcdic( outstr, outstr, len*2 );
 ...
 *
 ******************************************************************************/
void ncpul_ebcdic_to_hex( pBYTE instr, pBYTE outstr, INT len )
{
   #define  MAX_LEN 100
   ...
   ncpul_convert_to_ascii( instr, temp_str, len );
...
******************************************************************************/
 void ncpul_asc_to_bcd (afield, how_many, bstring)
   pCHAR         afield;
   INT           how_many;
   BYTE          bstring[];
{  
...
/*****************************************************************************
  ...
  Modified by:
******************************************************************************/
void ncpul_bcd_to_asc (bstring, blen, astr, astr_len)
