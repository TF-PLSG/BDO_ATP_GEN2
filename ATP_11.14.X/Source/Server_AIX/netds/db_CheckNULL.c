...
void CheckNULLTerminatedinOBS01(pOBS01 obs01,pCHAR mode);
void CheckNULLTerminatedinVISA3DS2(pVISA3DS2 visa3ds2,pCHAR mode);
...
void CheckNULLTerminatedinOBS01(pOBS01   obs01, pCHAR mode)
{
	checknull(obs01->on_behalf_service,sizeof(obs01->on_behalf_service),"OBS01","on_behalf_service","CheckNULLTerminatedinOBS01",mode);
	checknull(obs01->on_behalf_result,sizeof(obs01->on_behalf_result),"OBS01","on_behalf_result","CheckNULLTerminatedinOBS01",mode);
	checknull(obs01->description,sizeof(obs01->description),"OBS01","description","CheckNULLTerminatedinOBS01",mode);
	checknull(obs01->response_code,sizeof(obs01->response_code),"OBS01","response_code","CheckNULLTerminatedinOBS01",mode);

}

void CheckNULLTerminatedinVISA3DS2(pVISA3DS2   visa3ds2, pCHAR mode)
{
	checknull(visa3ds2->cavv,sizeof(visa3ds2->cavv),"VISA3DS2","on_behalf_service","CheckNULLTerminatedinVISA3DS2",mode);
	checknull(visa3ds2->description,sizeof(visa3ds2->description),"VISA3DS2","description","CheckNULLTerminatedinVISA3DS2",mode);
	checknull(visa3ds2->response_code,sizeof(visa3ds2->response_code),"VISA3DS2","response_code","CheckNULLTerminatedinVISA3DS2",mode);
...
void CheckNULLTerminatedinNCF01_Keyblock(pNCF01_KEYBLOCK   ncf01_keyblock,pCHAR mode)
{
	checknull(ncf01_keyblock->network_id,sizeof(ncf01_keyblock->network_id),"NCF01_KEYBLOCK","NETWORK_ID","CheckNULLTerminatedinNCF01_Keyblock",mode);
	/*checknull(ncf01_keyblock->NETWORK_TYPE,sizeof(ncf01_keyblock->NETWORK_TYPE),"NCF01_KEYBLOCK","NETWORK_TYPE","CheckNULLTerminatedinNCF01_Keyblock",mode);*/

	checknull(ncf01_keyblock->iss_cwk_keyblock,sizeof(ncf01_keyblock->iss_cwk_keyblock),"NCF01_KEYBLOCK","ISS_CWK_Keyblock","CheckNULLTerminatedinNCF01_Keyblock",mode);
	checknull(ncf01_keyblock->iss_zmk_keyblock,sizeof(ncf01_keyblock->iss_zmk_keyblock),"NCF01_KEYBLOCK","ISS_ZMK_Keyblock","CheckNULLTerminatedinNCF01_Keyblock",mode);
	checknull(ncf01_keyblock->iss_rtdcwk_keyblock,sizeof(ncf01_keyblock->iss_rtdcwk_keyblock),"NCF01_KEYBLOCK","ISS_RTDCWK_Keyblock","CheckNULLTerminatedinNCF01_Keyblock",mode);
	checknull(ncf01_keyblock->iss_kek_keyblock,sizeof(ncf01_keyblock->iss_kek_keyblock),"NCF01_KEYBLOCK","ISS_KEK_Keyblock","CheckNULLTerminatedinNCF01_Keyblock",mode);
	checknull(ncf01_keyblock->acq_cwk_keyblock,sizeof(ncf01_keyblock->acq_cwk_keyblock),"NCF01_KEYBLOCK","ACQ_CWK_Keyblock","CheckNULLTerminatedinNCF01_Keyblock",mode);
	checknull(ncf01_keyblock->acq_zmk_keyblock,sizeof(ncf01_keyblock->acq_zmk_keyblock),"NCF01_KEYBLOCK","ACQ_ZMK_Keyblock","CheckNULLTerminatedinNCF01_Keyblock",mode);
	checknull(ncf01_keyblock->acq_kek_keyblock,sizeof(ncf01_keyblock->acq_kek_keyblock),"NCF01_KEYBLOCK","ACQ_KEK_Keyblock","CheckNULLTerminatedinNCF01_Keyblock",mode);
	checknull(ncf01_keyblock->iss_prev_src_station,sizeof(ncf01_keyblock->iss_prev_src_station),"NCF01_KEYBLOCK","ISS_PREV_SRC_STATION","CheckNULLTerminatedinNCF01_Keyblock",mode);
	checknull(ncf01_keyblock->future_field1,sizeof(ncf01_keyblock->future_field1),"NCF01_KEYBLOCK","Future_Field1","CheckNULLTerminatedinNCF01_Keyblock",mode);
	checknull(ncf01_keyblock->future_field2,sizeof(ncf01_keyblock->future_field2),"NCF01_KEYBLOCK","Future_Field2","CheckNULLTerminatedinNCF01_Keyblock",mode);
	checknull(ncf01_keyblock->future_field3,sizeof(ncf01_keyblock->future_field3),"NCF01_KEYBLOCK","Future_Field3","CheckNULLTerminatedinNCF01_Keyblock",mode);
	checknull(ncf01_keyblock->future_field4,sizeof(ncf01_keyblock->future_field4),"NCF01_KEYBLOCK","Future_Field4","CheckNULLTerminatedinNCF01_Keyblock",mode);
	checknull(ncf01_keyblock->future_field5,sizeof(ncf01_keyblock->future_field5),"NCF01_KEYBLOCK","Future_Field5","CheckNULLTerminatedinNCF01_Keyblock",mode);
