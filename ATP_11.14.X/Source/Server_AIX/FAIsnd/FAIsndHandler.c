...
#define  true     0x01
#endif
INT faisnd_read_CUP_merchant_indicator( void );
void faisnd_build_CRTRAN_field_31_MC();
void faisnd_build_CRTRAN_field_31_VISA();
void faisnd_build_CRTRAN_field_31_CUP();
void faisnd_build_CRTRAN_field_31_JCB();
void faisnd_build_CRTRAN_field_31_DINERS();
void faisnd_build_CRTRAN_field_31_AMEX();
void faisnd_build_CRTRAN_field_31_Fleet();
void RT_faisnd_build_CRTRAN_field_31_MC();
void RT_faisnd_build_CRTRAN_field_31_VISA();
void RT_faisnd_build_CRTRAN_field_31_CUP();
void RT_faisnd_build_CRTRAN_field_31_JCB();
void RT_faisnd_build_CRTRAN_field_31_DINERS();
void RT_faisnd_build_CRTRAN_field_31_AMEX();
void RT_faisnd_build_CRTRAN_field_31_Fleet();
void faisnd_build_request_Online_HeaderFile();
void faisnd_build_request_RealTime_HeaderFile();
void faisnd_build_request_EXT10_HeaderFile();
INT faisnd_Read_BDO_PAY_QR_NII_value(void);
...
BYTE Get_CCL01_Details_for_Decimal_places (void);
void faisnd_verify_temp_ccl01_list_for_decimal_places(void);
INT Get_particular_CCL01_record_for_Decimal_places_with_wait (pBYTE curr_code, INT arr_index);
...
CHAR  faisnd_controller_que_name[] = "falcntlA";
...
CCL01_GUI_LIST ccl01_list;
BYTE dec_plcs[2] = {0};

sCCL01 tmp_ccl01_list [CURR_CODE_LIST_SIZE];
...
struct
{
	...
	char	WORKFLOW						[16];
	char	RECORD_TYPE						[8];
	char	DATA_SPECIFICATION_VERSION		[5];
	char	CLIENT_FROM_HDR					[16];
	char	RCD_CRT_DATE					[8];
	char	RCD_CRT_TIME					[6];
	char	RCD_CRT_MSCND					[3];
	char	GMT_OFFSET						[6];
	char	CUSTOMER_ID_HDR					[20];
	char	CUSTOMER_ACT_NO					[40];
	...
	char	ENTITY_TYPE						[4];
	char	EXTSOURCE						[48];
	char	NOTIFICATION_NAME				[48];
	char	NOTIFICATION_STATUS				[10];
	char	SCORE1							[4];
	char	SCORE2							[4];
	char	SCORE3							[4];
	char	USER_DATA_01_STRG				[4];
	char	USER_DATA_02_STRG				[4];
	char	USER_DATA_03_STRG				[4];
	char	USER_DATA_04_STRG				[4];
	char	USER_DATA_05_STRG				[4];
	char	USER_DATA_06_STRG				[8];
	char	USER_DATA_07_STRG				[8];
	char	USER_DATA_08_STRG				[8];
	char	USER_DATA_09_STRG				[8];
	char	USER_DATA_10_STRG				[8];
	char	USER_DATA_11_STRG				[8];
	char	USER_DATA_12_STRG				[16];
	char	USER_DATA_13_STRG				[16];
	char	USER_DATA_14_STRG				[16];
	char	USER_DATA_15_STRG				[16];
	char	USER_DATA_16_STRG				[16];
	char	USER_DATA_17_STRG				[16];
	char	USER_DATA_18_STRG				[32];
	char	USER_DATA_19_STRG				[32];
	char	USER_DATA_20_STRG				[32];
	char	USER_DATA_21_STRG				[32];
	char	USER_DATA_22_STRG				[32];
	char	USER_DATA_23_STRG				[32];
	char	USER_DATA_24_STRG				[32];
	char	USER_DATA_25_STRG				[32];
	char	USER_DATA_26_STRG				[32];
	char	USER_DATA_27_STRG				[32];
	char	USER_DATA_28_STRG				[64];
	char	USER_DATA_29_STRG				[64];
	char	USER_DATA_30_STRG				[64];
	char	USER_DATA_31_STRG				[64];
	char	USER_DATA_32_STRG				[64];
	char	USER_DATA_33_STRG				[255];
	char	USER_DATA_34_STRG				[255];
}Ext10_DFld;
...
CHAR  faisnd_Erro_warning_Filename[256] = {0};
CHAR  faisnd_module_error_warning_file_name[256] = {0};
CHAR  faisnd_error_warning_file_path[256] = {0};
UINT Max_File_Size_Defined = 0 ;
CHAR  App_Name[7] = "faisnd";
...
INT faisnd_is_Issuing_Transaction(void)
{
	if((strncmp(Auth_Tx.TLF01_details.handler_queue,"dcp",3) != 0) &&
			(strncmp(Auth_Tx.TLF01_details.handler_queue,"VOICE",5) != 0))
	{
...
INT faisnd_is_Credential_On_File_VISA(pCHAR temp_pos_entry_mode)
{

	if((faisnd_is_Issuing_Transaction()) == true)
	{
...
INT faisnd_is_Credential_On_File_MC(pCHAR temp_pos_entry_mode)
{
...
INT faisnd_is_Credential_On_File_AMEX(pCHAR temp_pos_entry_mode)
{
	if((faisnd_is_Issuing_Transaction()) == true)
	{
...
INT faisnd_is_Credential_On_File_DINERS(pCHAR temp_pos_entry_mode)
{
...
INT faisnd_is_Credential_On_File_CUP(pCHAR temp_pos_entry_mode)
{
...
INT faisnd_is_Credential_On_File_JCB(pCHAR temp_pos_entry_mode)
{
...
void faisnd_AMEX_posEntryMode_F41(pCHAR temp_pos_entry_mode)
{
		if((faisnd_is_Issuing_Transaction()) == true)
		{
...
void faisnd_DINERS_posEntryMode_F41(pCHAR temp_pos_entry_mode)
{
...
void faisnd_CUP_posEntryMode_F41(pCHAR temp_pos_entry_mode)
{
	if((Is_BDO_Acquiring_Transaction()) == true)
	{
		if( strncmp(&Auth_Tx.TLF01_details.pos_entry_mode[1] , "07" ,2) == 0)
...
void faisnd_JCB_posEntryMode_F41(pCHAR temp_pos_entry_mode)
{
	if((Is_BDO_Acquiring_Transaction()) == true)
	{
		if( strncmp(&Auth_Tx.TLF01_details.pos_entry_mode[1],"07",2) == 0 )
...
void faisnd_MC_posEntryMode_F41(pCHAR temp_pos_entry_mode)
{
	if((Is_BDO_Acquiring_Transaction())== true)
	{
...
void faisnd_VISA_posEntryMode_F41(pCHAR temp_pos_entry_mode)
{
	if((strcmp(temp_pos_entry_mode,"01") == 0) && (strcmp(Auth_Tx.TLF01_details.pos_condition_code,"59") == 0))
	{
		strncpy(temp_pos_entry_mode,"81",2);
...
BOOLEAN  faisnd_Check_If_CUP_RPS_TRN(void)
{
...
BOOLEAN faisnd_Check_If_CUP_BDO_PAY(void)
{
...
BOOLEAN faisnd_Check_If_CUP_MOTO_TRN(void)
{
...
INT faisnd_check_DINERS_emv_capability_device(void)
{
...
BOOLEAN faisnd_check_is_Diners_Magstrip_pos_transaction(void)
{
	if(  (0 ==  strncmp( Auth_Tx.TLF01_details.pos_entry_mode,
...
BOOLEAN faisnd_check_is_Diners_Chip_pos_transaction(void)
{
	if( 0 ==  strncmp( Auth_Tx.TLF01_details.pos_entry_mode,
...
BOOLEAN faisnd_check_is_Diners_Fallback_pos_transaction(void)
{
	if( 0 ==  strncmp( Auth_Tx.TLF01_details.pos_entry_mode,
...
BOOLEAN faisnd_check_is_Diners_Contactless_Mastripe_pos_transaction(void)
{
	if( 0 ==  strncmp( Auth_Tx.TLF01_details.pos_entry_mode,
...
BOOLEAN faisnd_check_is_Diners_Contactless_Chip_pos_transaction(void)
{
	if( 0 ==  strncmp( Auth_Tx.TLF01_details.pos_entry_mode,
...
BOOLEAN faisnd_check_is_issuing_transaction(void)
{
...
BOOLEAN faisnd_check_is_voice_transaction(void)
{
	if(  0 == strncmp( Auth_Tx.TLF01_details.handler_queue,
					   voice_handler_que_name,
					   DINERS_VOICE_MODULE_COMP_LEN) )
...
BOOLEAN faisnd_check_is_Diners_Manual_pos_transaction(void)
{
	if( 0 ==  strncmp( Auth_Tx.TLF01_details.pos_entry_mode,
...
INT faisnd_check_is_Diners_Asiapay_Ecommerce_transaction (void)
{
...
INT faisnd_check_is_Diners_RPS_Transaction(void)
{
...
INT faisnd_check_is_Diners_Asiapay_Recurring (void)
{
	if( 0 == strncmp(Auth_Tx.TLF01_details.pos_condition_code,
...
INT faisnd_check_is_Diners_BDO_PAY (void)
{
	if( 0 == strncmp(Auth_Tx.TLF01_details.pos_condition_code,
...
INT faisnd_Check_If_DCI_pin_block_exists()
{
   INT  ret_val = true;
   ...
   else if (faisnd_Check_If_blank_string(Auth_Tx.TLF01_details.pin_block,
...
INT faisnd_Check_If_blank_string(pCHAR astr, INT max_len)
{
   INT  i = 0;
   INT  ret_val = true;
...
INT faisnd_Parse_track2( pAUTH_TX p_auth_tx, pCHAR error_msg )
{
   INT    ret_val = true;
   INT    card_num_len;
   INT    track2_idx;
...
BYTE faisnd_IsFieldNull (char str[])
{
	if (strlen (str) == 0)
		return 1 ;
	return 0 ;
...
BOOLEAN faisnd_Is_AsiaPay_Transaction()
{
...
void faisnd_Prepare_Pos_Data_AMEX(void)
{
	INT	 ret_val = true;
...
void faisnd_Prepare_Pos_Data_VISA(void)
{
	   ...
	   (0 == strncmp(Auth_Tx.TLF01_details.handler_queue,"VOICE",5)))
	{
	   ...
	   else
	   {
		...
		/* Set the POS Entry Mode flag for use in other fields. */
		 ...
		 if(!(faisnd_IsFieldNull(Auth_Tx.TLF01_details.nfi_name)))
		 {
		 ...
		 else
		 {
		  if ( Auth_Tx.TLF01_details.track2[0] != 0x00 )
		  {
			 ...
			 (void)faisnd_Parse_track2(&Auth_Tx,error_str); /* Gets service code */
...
void faisnd_Prepare_Pos_Data_MC(void)
{
   BOOLEAN e_commerce;
   INT iIndustry;
   CHAR    temp_str3[4] = {0};
...
void faisnd_Prepare_Pos_Data_CUP(void)
{
	/*
	...
	*/
	...
	else
	{
		...
		if((true == faisnd_Check_If_CUP_RPS_TRN()) ||
		   (true == faisnd_Check_If_CUP_MOTO_TRN()))
		{
		...
		switch(temp_posentry)
		{
			...
			case 01:
				...
				else if(true == faisnd_Check_If_CUP_MOTO_TRN())
				{
					if( 0 == strncmp( Auth_Tx.TLF01_details.handler_queue,
									   voice_handler_que_name,
				...
				else if (true == faisnd_Check_If_CUP_RPS_TRN()||
						(true == faisnd_Check_If_CUP_BDO_PAY()))
				{
					memcpy(Auth_Tx.TLF01_details.product_codes[16].amount + 1,"0",1);
				}
				else
		...
		else if (true == faisnd_Check_If_CUP_BDO_PAY())
		{
		...
		if(true == faisnd_Check_If_CUP_MOTO_TRN())
		{
...
void faisnd_Prepare_Pos_Data_DINERS(void)
{
	if(true == faisnd_check_DINERS_emv_capability_device ())
	{
		if(true == faisnd_check_is_Diners_Magstrip_pos_transaction())
		{
			if(true == faisnd_Check_If_DCI_pin_block_exists())
			{
		...
		else if(true == faisnd_check_is_Diners_Chip_pos_transaction())
		{
			if(true == faisnd_Check_If_DCI_pin_block_exists())
			{
				strncpy(Auth_Tx.TLF01_details.product_codes[16].amount,
		...
		else if(true == faisnd_check_is_Diners_Fallback_pos_transaction())
		{
			if(true == faisnd_Check_If_DCI_pin_block_exists())
			{
				strncpy(Auth_Tx.TLF01_details.product_codes[16].amount,
		...
		else if(true == faisnd_check_is_Diners_Contactless_Mastripe_pos_transaction())
		{
			if(true == faisnd_Check_If_DCI_pin_block_exists())
			{
				strncpy(Auth_Tx.TLF01_details.product_codes[16].amount,
		...
		else if(true == faisnd_check_is_Diners_Contactless_Chip_pos_transaction())
		{
			if(true == faisnd_Check_If_DCI_pin_block_exists())
			{
				strncpy(Auth_Tx.TLF01_details.product_codes[16].amount,
		...
		else if(true == faisnd_check_is_voice_transaction())
		{
			strncpy(Auth_Tx.TLF01_details.product_codes[16].amount,
					DCI_POS_DATA_DC_PRESENT_VOICE,
					DINERS_DE22_SIZE);
		}
		else if(true == faisnd_check_is_Diners_Manual_pos_transaction())
		{
			if(true == faisnd_check_is_Diners_Asiapay_Ecommerce_transaction())
			{
				strncpy(Auth_Tx.TLF01_details.product_codes[16].amount,
						DCI_POS_DATA_DC_PRESENT_ASIAPAY_ECOM,
						DINERS_DE22_SIZE);
			}
			else if (true == faisnd_check_is_Diners_RPS_Transaction())
			{
				strncpy(Auth_Tx.TLF01_details.product_codes[16].amount,
						DCI_POS_DATA_DC_PRESENT_RPS,
						DINERS_DE22_SIZE);
			}
			else if (true == faisnd_check_is_Diners_Asiapay_Recurring())
			{
				strncpy(Auth_Tx.TLF01_details.product_codes[16].amount,
						DCI_POS_DATA_DC_PRESENT_ASIAPAY_RPS	,
						DINERS_DE22_SIZE);
			}
			else if (true == faisnd_check_is_Diners_BDO_PAY())
			{
				strncpy(Auth_Tx.TLF01_details.product_codes[16].amount,
						DCI_POS_DATA_FOR_BDO_PAY	,
						DINERS_DE22_SIZE);
			}
			else if(true == faisnd_Check_If_DCI_pin_block_exists())
			{
				strncpy(Auth_Tx.TLF01_details.product_codes[16].amount,
...
void faisnd_Prepare_Pos_Data_JCB(void)
{
	CHAR   temp_str[50] = {0};
	INT    iIndustry;
	INT    mcc;
	   ...
	   (0 == strncmp(Auth_Tx.TLF01_details.handler_queue,"VOICE",5)))
	{
		...
		if((faisnd_Is_AsiaPay_Transaction() == true))
		{
			iIndustry=ECOMMERCE;
		}
...
INT faisnd_Is_Advice_or_Reversal_Transaction(void)
{
	...
	else if((Check_If_VISA_Transaction() == true) && (faisnd_is_Issuing_Transaction() ==true) &&
...
INT faisnd_is_Credential_On_File(void)
{
	...
	else
	{
		...
		{
			faisnd_is_Credential_On_File_AMEX(temp_pos_entry_mode);
		}
		else if((Check_If_DINERS_Transaction())== true)
		{
			faisnd_is_Credential_On_File_DINERS(temp_pos_entry_mode);
		}
		else if((Check_If_CUP_Transaction())== true)
		{
			faisnd_is_Credential_On_File_CUP(temp_pos_entry_mode);
		}
		else if((Check_If_JCB_Transaction())== true)
		{
			faisnd_is_Credential_On_File_JCB(temp_pos_entry_mode);
		}
		else if((Check_If_MC_Transaction())== true)
		{
			faisnd_is_Credential_On_File_MC(temp_pos_entry_mode);
		}
		else if((Check_If_VISA_Transaction())== true)
		{
			faisnd_is_Credential_On_File_VISA(temp_pos_entry_mode);
		}
}
...
/*	sprintf(msgBuffer,"CRTRAN message built with a unique Key:%s\n",key);
	faisnd_log_message(2,1,msgBuffer,"RqMssg_Online",0);*/

	faisnd_read_CUP_merchant_indicator();
	faisnd_read_CUP_MP_Bin_range_len_1();
	faisnd_read_CUP_MP_Bin_range_len_2();
	faisnd_read_CUP_MP_Bin_range_len_3();
	faisnd_read_CUP_MP_Bin_range_len_4();
	faisnd_read_CUP_MP_Bin_range_len_5();
	faisnd_read_CUP_MP_Bin_range_1_indicator();
	faisnd_read_CUP_MP_Bin_range_2_indicator();
	faisnd_read_CUP_MP_Bin_range_3_indicator();
	faisnd_read_CUP_MP_Bin_range_4_indicator();
	faisnd_read_CUP_MP_Bin_range_5_indicator();
	...
	faisnd_Read_BDO_PAY_QR_NII_value();

	faisnd_build_request_Online_HeaderFile();
	faisnd_build_request_field_1( );
	faisnd_build_request_field_2( );
	faisnd_build_request_field_3( );
	faisnd_build_request_field_4( );
	faisnd_build_request_field_5( );
	faisnd_build_request_field_6( );
	faisnd_build_request_field_7( );
	faisnd_build_request_field_8( );
	faisnd_build_request_field_9( );
	faisnd_build_request_field_10( );
	faisnd_build_request_field_11( );
	faisnd_build_request_field_12( );
	faisnd_build_request_field_13( );
	faisnd_build_request_field_14( );
	faisnd_build_request_field_15( );
	faisnd_build_request_field_16( );
	faisnd_build_request_field_17( );
	faisnd_build_request_field_18( );
	faisnd_build_request_field_19( );
	faisnd_build_request_field_20( );
	faisnd_build_request_field_21( );
	faisnd_build_request_field_22( );
	faisnd_build_request_field_23( );
	faisnd_build_request_field_24( );
	faisnd_build_request_field_25( );
	faisnd_build_request_field_26( );
	faisnd_build_request_field_27( );
	faisnd_build_request_field_28( );
	faisnd_build_request_field_29( );
	faisnd_build_request_field_30( );
	faisnd_build_request_field_31( );
	faisnd_build_request_field_32( );
	faisnd_build_request_field_33( );
	faisnd_build_request_field_34( );
	faisnd_build_request_field_35( );
	faisnd_build_request_field_36( );
	faisnd_build_request_field_37( );
	faisnd_build_request_field_38( );
	faisnd_build_request_field_39( );
	faisnd_build_request_field_40( );
	faisnd_build_request_field_41( );
	faisnd_build_request_field_42( );
	faisnd_build_request_field_43( );
	faisnd_build_request_field_44( );
	faisnd_build_request_field_45( );
	faisnd_build_request_field_46( );
	faisnd_build_request_field_47( );
	faisnd_build_request_field_48( );
	faisnd_build_request_field_49( );
	faisnd_build_request_field_50( );
	faisnd_build_request_field_51( );
	faisnd_build_request_field_52( );
	faisnd_build_request_field_53( );
	faisnd_build_request_field_54( );
	faisnd_build_request_field_55( );
	faisnd_build_request_field_56( );
	faisnd_build_request_field_57( );
	faisnd_build_request_field_58( );
	faisnd_build_request_field_59( );
	faisnd_build_request_field_60( );
	faisnd_build_request_field_61( );
	faisnd_build_request_field_62( );
	faisnd_build_request_field_63( );
	faisnd_build_request_field_64( );
	faisnd_build_request_field_65( );
	faisnd_build_request_field_66( );
	faisnd_build_request_field_67( );
	faisnd_build_request_field_68( );
	faisnd_build_request_field_69( );
	faisnd_build_request_field_70( );
	faisnd_build_request_field_71( );
	faisnd_build_request_field_72( );
	faisnd_build_request_field_73( );
	faisnd_build_request_field_74( );
	faisnd_build_request_field_75( );
	faisnd_build_request_field_76( );
	faisnd_build_request_field_77( );
	faisnd_build_request_field_78( );
	faisnd_build_request_field_79( );
	faisnd_build_request_field_80( );
	faisnd_build_request_field_81( );
	faisnd_build_request_field_82( );
	faisnd_build_request_field_83( );
	faisnd_build_request_field_84( );
	faisnd_build_request_field_85( );
	faisnd_build_request_field_86( );
	faisnd_build_request_field_87( );
	faisnd_build_request_field_88( );
	faisnd_build_request_field_89( );
	faisnd_build_request_field_90( );
	faisnd_build_request_field_91( );
	faisnd_build_request_field_92( );
	faisnd_build_request_field_93( );
	faisnd_build_request_field_94( );
	faisnd_build_request_field_95( );
	faisnd_build_request_field_96( );
	faisnd_build_request_field_97( );
	faisnd_build_request_field_98( );
	faisnd_build_request_field_99( );
	faisnd_build_request_field_100( );
	faisnd_build_request_field_101( );
	faisnd_build_request_field_102( );
	faisnd_build_request_field_103( );
	faisnd_build_request_field_104( );
	faisnd_build_request_field_105( );
	faisnd_build_request_field_106( );
	faisnd_build_request_field_107( );
	faisnd_build_request_field_108( );
	faisnd_build_request_field_109( );
	faisnd_build_request_field_110( );
	faisnd_build_request_field_111( );
	faisnd_build_request_field_112( );
	faisnd_build_request_field_113( );
	faisnd_build_request_field_114( );
	faisnd_build_request_field_115( );
	faisnd_build_request_field_116( );
	faisnd_build_request_field_117( );
	faisnd_build_request_field_118( );
	faisnd_build_request_field_119( );
	faisnd_build_request_field_120( );
	faisnd_build_request_field_121( );
	faisnd_build_request_field_122( );
	faisnd_build_request_field_123( );
	faisnd_build_request_field_124( );
	faisnd_build_request_field_125( );
	faisnd_build_request_field_126( );
	faisnd_build_request_field_127( );
	faisnd_build_request_field_128( );
	faisnd_build_request_field_129( );
	faisnd_build_request_field_130( );
	faisnd_build_request_field_131( );
	faisnd_build_request_field_132( );
	faisnd_build_request_field_133( );
	faisnd_build_request_field_134( );
	faisnd_build_request_field_135( );
	faisnd_build_request_field_136( );
	faisnd_build_request_field_137( );
	faisnd_build_request_field_138( );
	faisnd_build_request_field_139( );
	faisnd_build_request_field_140( );
	faisnd_build_request_field_141( );
	faisnd_build_request_field_142( );
	faisnd_build_request_field_143( );
	faisnd_build_request_field_144( );
	faisnd_build_request_field_145( );
	printf("\nCRTran_Online_req: %s\n", message);
...
void RqMssg_RealTime(pPTE_MSG p_msg_in)
{
	...
	faisnd_log_message(2,1,"faisndRT: New request from faisnd controller","RqMssg_RealTime",1);
	...
	strcat(key,Auth_Tx.TLF01_details.nii);
	/*sprintf(msgBuffer,"CRTRAN message built with a unique Key:%s\n",key);
	faisnd_log_message(2,1,msgBuffer,"RqMssg_RealTime",0);*/
	...
	faisnd_build_request_RealTime_HeaderFile();
	RT_faisnd_build_request_field_1( );
	RT_faisnd_build_request_field_2( );
	RT_faisnd_build_request_field_3( );
	RT_faisnd_build_request_field_4( );
	RT_faisnd_build_request_field_5( );
	RT_faisnd_build_request_field_6( );
	RT_faisnd_build_request_field_7( );
	RT_faisnd_build_request_field_8( );
	RT_faisnd_build_request_field_9( );
	RT_faisnd_build_request_field_10( );
	RT_faisnd_build_request_field_11( );
	RT_faisnd_build_request_field_12( );
	RT_faisnd_build_request_field_13( );
	RT_faisnd_build_request_field_14( );
	RT_faisnd_build_request_field_15( );
	RT_faisnd_build_request_field_16( );
	RT_faisnd_build_request_field_17( );
	RT_faisnd_build_request_field_18( );
	RT_faisnd_build_request_field_19( );
	RT_faisnd_build_request_field_20( );
	RT_faisnd_build_request_field_21( );
	RT_faisnd_build_request_field_22( );
	RT_faisnd_build_request_field_23( );
	RT_faisnd_build_request_field_24( );
	RT_faisnd_build_request_field_25( );
	RT_faisnd_build_request_field_26( );
	RT_faisnd_build_request_field_27( );
	RT_faisnd_build_request_field_28( );
	RT_faisnd_build_request_field_29( );
	RT_faisnd_build_request_field_30( );
	RT_faisnd_build_request_field_31( );
	RT_faisnd_build_request_field_32( );
	RT_faisnd_build_request_field_33( );
	RT_faisnd_build_request_field_34( );
	RT_faisnd_build_request_field_35( );
	RT_faisnd_build_request_field_36( );
	RT_faisnd_build_request_field_37( );
	RT_faisnd_build_request_field_38( );
	RT_faisnd_build_request_field_39( );
	RT_faisnd_build_request_field_40( );
	RT_faisnd_build_request_field_41( );
	RT_faisnd_build_request_field_42( );
	RT_faisnd_build_request_field_43( );
	RT_faisnd_build_request_field_44( );
	RT_faisnd_build_request_field_45( );
	RT_faisnd_build_request_field_46( );
	RT_faisnd_build_request_field_47( );
	RT_faisnd_build_request_field_48( );
	RT_faisnd_build_request_field_49( );
	RT_faisnd_build_request_field_50( );
	RT_faisnd_build_request_field_51( );
	RT_faisnd_build_request_field_52( );
	RT_faisnd_build_request_field_53( );
	RT_faisnd_build_request_field_54( );
	RT_faisnd_build_request_field_55( );
	RT_faisnd_build_request_field_56( );
	RT_faisnd_build_request_field_57( );
	RT_faisnd_build_request_field_58( );
	RT_faisnd_build_request_field_59( );
	RT_faisnd_build_request_field_60( );
	RT_faisnd_build_request_field_61( );
	RT_faisnd_build_request_field_62( );
	RT_faisnd_build_request_field_63( );
	RT_faisnd_build_request_field_64( );
	RT_faisnd_build_request_field_65( );
	RT_faisnd_build_request_field_66( );
	RT_faisnd_build_request_field_67( );
	RT_faisnd_build_request_field_68( );
	RT_faisnd_build_request_field_69( );
	RT_faisnd_build_request_field_70( );
	RT_faisnd_build_request_field_71( );
	RT_faisnd_build_request_field_72( );
	RT_faisnd_build_request_field_73( );
	RT_faisnd_build_request_field_74( );
	RT_faisnd_build_request_field_75( );
	RT_faisnd_build_request_field_76( );
	RT_faisnd_build_request_field_77( );
	RT_faisnd_build_request_field_78( );
	RT_faisnd_build_request_field_79( );
	RT_faisnd_build_request_field_80( );
	RT_faisnd_build_request_field_81( );
	RT_faisnd_build_request_field_82( );
	RT_faisnd_build_request_field_83( );
	RT_faisnd_build_request_field_84( );
	RT_faisnd_build_request_field_85( );
	RT_faisnd_build_request_field_86( );
	RT_faisnd_build_request_field_87( );
	RT_faisnd_build_request_field_88( );
	RT_faisnd_build_request_field_89( );
	RT_faisnd_build_request_field_90( );
	RT_faisnd_build_request_field_91( );
	RT_faisnd_build_request_field_92( );
	RT_faisnd_build_request_field_93( );
	RT_faisnd_build_request_field_94( );
	RT_faisnd_build_request_field_95( );
	RT_faisnd_build_request_field_96( );
	RT_faisnd_build_request_field_97( );
	RT_faisnd_build_request_field_98( );
	RT_faisnd_build_request_field_99( );
	RT_faisnd_build_request_field_100( );
	RT_faisnd_build_request_field_101( );
	RT_faisnd_build_request_field_102( );
	RT_faisnd_build_request_field_103( );
	RT_faisnd_build_request_field_104( );
	RT_faisnd_build_request_field_105( );
	RT_faisnd_build_request_field_106( );
	RT_faisnd_build_request_field_107( );
	RT_faisnd_build_request_field_108( );
	RT_faisnd_build_request_field_109( );
	RT_faisnd_build_request_field_110( );
	RT_faisnd_build_request_field_111( );
	RT_faisnd_build_request_field_112( );
	RT_faisnd_build_request_field_113( );
	RT_faisnd_build_request_field_114( );
	RT_faisnd_build_request_field_115( );
	RT_faisnd_build_request_field_116( );
	RT_faisnd_build_request_field_117( );
	RT_faisnd_build_request_field_118( );
	RT_faisnd_build_request_field_119( );
	RT_faisnd_build_request_field_120( );
	RT_faisnd_build_request_field_121( );
	RT_faisnd_build_request_field_122( );
	RT_faisnd_build_request_field_123( );
	RT_faisnd_build_request_field_124( );
	RT_faisnd_build_request_field_125( );
	RT_faisnd_build_request_field_126( );
	RT_faisnd_build_request_field_127( );
	RT_faisnd_build_request_field_128( );
	RT_faisnd_build_request_field_129( );
	RT_faisnd_build_request_field_130( );
	RT_faisnd_build_request_field_131( );
	RT_faisnd_build_request_field_132( );
	RT_faisnd_build_request_field_133( );
	RT_faisnd_build_request_field_134( );
	RT_faisnd_build_request_field_135( );
	RT_faisnd_build_request_field_136( );
	RT_faisnd_build_request_field_137( );
	RT_faisnd_build_request_field_138( );
	RT_faisnd_build_request_field_139( );
	RT_faisnd_build_request_field_140( );
	RT_faisnd_build_request_field_141( );
	RT_faisnd_build_request_field_142( );
	RT_faisnd_build_request_field_143( );
	RT_faisnd_build_request_field_144( );
	RT_faisnd_build_request_field_145( );
	printf("\nCRTran_Realtime_req: %s\n", message);
}
void faisnd_build_request_Online_HeaderFile( )
{
...
void faisnd_build_request_field_21( )
{
...
void faisnd_build_request_field_31( )
{
    ...
    else if (Check_If_AMEX_Transaction ()    == true)
	{
    	...
    	faisnd_build_CRTRAN_field_31_AMEX();
	}
    else if (Check_If_Fleet_Transaction ()    == true)
	{
    	faisnd_build_CRTRAN_field_31_Fleet();
	}
    else
    {
...
void faisnd_build_request_field_33( )
{
	...
	Else �BLANK�
	*/
void faisnd_build_request_field_34( )
{
...
void faisnd_build_request_field_35()
{
	if( Auth_Tx.TLF01_details.tx_key == AUTH_SALE          || Auth_Tx.TLF01_details.tx_key == AUTH_SALE_RESPONSE ||
		...
		Auth_Tx.TLF01_details.tx_key == AUTH_FAST_FUND 	   || Auth_Tx.TLF01_details.tx_key == AUTH_FAST_FUND_RESPONSE	||
		Auth_Tx.TLF01_details.tx_key == AUTH_OCT_TX 	   || Auth_Tx.TLF01_details.tx_key == AUTH_OCT_TX_RESPONSE)
	{
...
void faisnd_build_request_field_36()
{
...
void faisnd_build_request_field_37()
{
...
void faisnd_build_request_field_38()
{
...
void faisnd_build_request_field_39()
{
...
void faisnd_build_request_field_40()
{
	if(strcmp(Auth_Tx.BIN01_details.card_family, CARD_MASTERCARD)== 0)
	{
...
void faisnd_build_request_field_41()
{
	char temp_pos_entry_mode[3]={0};
	if(strlen(Auth_Tx.TLF01_details.pos_entry_mode)== 3)
	{
	...
	if((Check_If_AMEX_Transaction())== true)
	{
		faisnd_AMEX_posEntryMode_F41(temp_pos_entry_mode);
	}
	else if((Check_If_DINERS_Transaction())== true)
	{
		faisnd_DINERS_posEntryMode_F41(temp_pos_entry_mode);
	}
	else if((Check_If_CUP_Transaction())== true)
	{
		faisnd_CUP_posEntryMode_F41(temp_pos_entry_mode);
	}
	else if((Check_If_JCB_Transaction()) == true)
	{
		faisnd_JCB_posEntryMode_F41(temp_pos_entry_mode);
	}
	else if((Check_If_MC_Transaction())== true)
	{
		faisnd_MC_posEntryMode_F41(temp_pos_entry_mode);
	}
	else if((Check_If_VISA_Transaction())== true)
	{
		faisnd_VISA_posEntryMode_F41(temp_pos_entry_mode);
	}
	...
	if(faisnd_is_BDO_PAY_QR_Transaction() == true)
	{
		if((Is_BDO_Pos_Acquiring_Transaction()) == true)
		{
	...
	else if((faisnd_is_Credential_On_File() ==true) ||(strncmp(temp_pos_entry_mode,"81",2) == 0))
	{
	...
	else if(true == faisnd_check_if_trx_is_acq_MobilePOS_NFC_Tap2Phone_trx())
	{
		strncpy(Cr_Fld.TRANSACTION_POSTING_ENTRY_XFLG,
				FAI_MOBILE_NFC_TAP2PHONE_TXN,
				FAI_MOBILE_NFC_TAP2PHONE_TXN_LEN);
	}
	/*Swiftpass BDO Pay Credit Transactions With Pin*/
	else if(true == faisnd_check_if_trx_is_acq_Swiftpass_BDO_Pay_credit_trx())
	{
		strncpy(Cr_Fld.TRANSACTION_POSTING_ENTRY_XFLG,
				FAI_SWIFTPASS_BDO_PAY_TXN,
				FAI_SWIFTPASS_BDO_PAY_TXN_LEN);
	}
	else
	{
...
void faisnd_build_request_field_42( )
{
...
void faisnd_build_request_field_49( )
{
...
void faisnd_build_request_field_57( )
{
	if(strncmp(Cr_Fld.TRANSACTION_POSTING_ENTRY_XFLG,"E",1) == 0)
	{
...
void faisnd_build_request_field_63( )
{
...
void faisnd_build_request_field_64( )
{
...
void faisnd_build_request_field_65( )
{
	memset(Cr_Fld.SUPPRES_CASE_XFLG,' ',1);
	sprintf(&message[571],"%-1s\n",Cr_Fld.SUPPRES_CASE_XFLG);
}
void faisnd_build_request_field_66( )
{
	if(0 == strncmp(Auth_Tx.TLF01_details.product_codes[2].quantity, "1", 1))
	{
		/*** For MP/Installament transactions ***/
		memcpy(Cr_Fld.USER_INDICATOR_3_XCD, Auth_Tx.TLF01_details.deferred_term_length, 3);
	...
	/*********************UserIndicator04****************************/
void faisnd_build_request_field_67( )
{
...
void faisnd_build_request_field_68( )
{
	char temp_totalamt[14]={0};
	LONG tran_amount = 0;
	BYTE  retCode = 0;
	...
	faisnd_verify_temp_ccl01_list_for_decimal_places ();

	curr_dec_pls = atoi(dec_plcs);
		...
		(Check_If_CUP_Transaction ()  == true))
	{
		...
		if (curr_dec_pls == 2 && curr_dec_pls < MAX_DEC_PLCS_CURR_CODE)
		{
			sprintf(temp_totalamt,"%010d.%02d",original_tx_amt/100, original_tx_amt%100);
		}
		else if (curr_dec_pls == 0 && curr_dec_pls < MAX_DEC_PLCS_CURR_CODE)
		{
			sprintf(temp_totalamt,"%012d",original_tx_amt);
		}
		else if (curr_dec_pls == 1 && curr_dec_pls < MAX_DEC_PLCS_CURR_CODE)
		{
			sprintf(temp_totalamt,"%011d.%01d",original_tx_amt/10, original_tx_amt%10);
		}
		else if (curr_dec_pls == 3 && curr_dec_pls < MAX_DEC_PLCS_CURR_CODE)
		{
			sprintf(temp_totalamt,"%09d.%03d",original_tx_amt/1000, original_tx_amt%1000);
		}
		else if (curr_dec_pls == 4 && curr_dec_pls <= MAX_DEC_PLCS_CURR_CODE)
		{
			sprintf(temp_totalamt,"%08d.%04d",original_tx_amt/10000, original_tx_amt%10000);
		}
		else
		{
			sprintf(temp_totalamt,"%010d.%02d",original_tx_amt/100, original_tx_amt%100);
			 ...
			 Check_If_AMEX_Transaction ()==true)
	{
		...
		{
			tran_amount = strtod(Auth_Tx.reconciliation_amount, 0) ;
			/*sprintf(temp_totalamt,"%010d.%02d",(tran_amount / 100), (tran_amount % 100));*/
		}
		else
		{
			tran_amount = strtod(Auth_Tx.TLF01_details.total_amount, 0) ;
			/*sprintf(temp_totalamt,"%010d.%02d",(tran_amount / 100), (tran_amount % 100));*/
		}
		...
		{
			sprintf(temp_totalamt,"%012d",tran_amount);
		}
		else if (curr_dec_pls == 1 && curr_dec_pls < MAX_DEC_PLCS_CURR_CODE)
		{
			sprintf(temp_totalamt,"%011d.%01d",tran_amount/10, tran_amount%10);
		}
		else if (curr_dec_pls == 3 && curr_dec_pls < MAX_DEC_PLCS_CURR_CODE)
		{
			sprintf(temp_totalamt,"%09d.%03d",tran_amount/1000, tran_amount%1000);
		}
		else if (curr_dec_pls == 4 && curr_dec_pls <= MAX_DEC_PLCS_CURR_CODE)
		{
			sprintf(temp_totalamt,"%08d.%04d",tran_amount/10000, tran_amount%10000);
		}
		else
		{
			sprintf(temp_totalamt,"%010d.%02d",tran_amount/100, tran_amount%100);
...
void faisnd_build_request_field_69( )
{
...
void faisnd_build_request_field_70( )
{
	CHAR resp_buf[15] = {0} ;
...
void faisnd_build_request_field_89( )
{
	if (strcmp(Auth_Tx.BIN01_details.card_family, CARD_MASTERCARD)== 0)
	{
		if(Auth_Tx.TLF01_details.cvc == 'P')
...
void faisnd_build_request_field_90( )
{
...
void faisnd_build_request_field_91( )
{
...
void faisnd_build_request_field_94( )
{
...
void faisnd_build_request_field_95( )
{
...
void faisnd_build_request_field_96( )
{
...
void faisnd_build_request_field_97( )
{
...
void faisnd_build_request_field_115( )
{
		memset(Cr_Fld.PROCESSOR_REASON_XCD,' ',5);

	if(faisnd_is_Issuing_Transaction()== true)
	{
		if(faisnd_Is_Advice_or_Reversal_Transaction() == true)
		{
...
void faisnd_build_request_field_116( )
{
...
void faisnd_build_request_field_119( )
{
	...
	/*Field 120 ECI value*/
void faisnd_build_request_field_120( )
{
	memset(Cr_Fld.USER_DATA_6_NUM,' ',13);
...
void faisnd_build_request_field_121( )
{
	memset(Cr_Fld.USER_DATA_7_STRG,' ',40);
	if(strcmp(Auth_Tx.BIN01_details.card_family, CARD_AMEX)	== 0)
	{
...
void faisnd_build_request_field_136( )
{
...
void faisnd_build_request_field_137( )
{
...
void faisnd_build_request_field_145( )
{
	...
	faisnd_log_message( 2, 2, "STAN", "faisnd_build_request_field_145",0 );
}
...
/******************************************************************************
 *
 *  NAME:        faisnd_read_CUP_merchant_indicator
 *
...
/******************************************************************************
 *
 *  NAME:        faisnd_read_Workflow_indicator
 *
 *  DESCRIPTION:  This function reads information from the tf ini file.
 *
 *  INPUTS:       None
 ...
 *  MODIFICATIONS:
 ******************************************************************************/
INT faisnd_read_Workflow_indicator( void )
{
   DWORD rc = 0;
   CHAR filename     [MAX_FILENAME_SIZE]= {0};
   CHAR tmpstr       [MAX_FILENAME_SIZE]= {0};
 ...
 *
 ******************************************************************************/
void faisnd_log_message( INT dest, INT sev, pCHAR msg, pCHAR func, int details )
{
   INT  monitor_flag = 0;
   INT  eventlog_flag = 0;
   INT  msg_type = 0;
   ...
   faisnd_Log_error_warning_to_File(text_message,sev,func,details);
   if(monitor_flag == 1)
   {
		if(details == 1)
		{
...
INT faisnd_Log_error_warning_to_File(pCHAR Error_Buf,int sev, pCHAR func ,int detail)
{
	INT   ret_val = 0;
	INT   len=0;
	INT   cardlen = 0;
    ...
    len = strlen(faisnd_Erro_warning_Filename);
    path_len = strlen(faisnd_error_warning_file_path);
    if( len == 0 ||
    	path_len==0 )
    {
    ...
    if ( 0 != strcmp(&faisnd_Erro_warning_Filename[len-4], current_mmdd) )
    {
		/* Now create the new filename.*/
    	faisnd_create_Error_Filename();
    }
	if((fp = fopen(faisnd_Erro_warning_Filename,"a+b"))==NULL)
	{
		LogEvent(Error_Buf,INFO_MSG);
		return 0;
	}
...
void faisnd_create_Error_Filename()
{
   ...
   /* Get system timestamp "YYYY-MM-DD-hh.mm.ss.jjj" */
    ...
    strcpy( faisnd_Erro_warning_Filename, faisnd_error_warning_file_path );
    strcat( faisnd_Erro_warning_Filename, faisnd_module_error_warning_file_name );
	strcat( faisnd_Erro_warning_Filename, ".EW." );
    strncat(faisnd_Erro_warning_Filename, system_date,   4 );  /* YYYY */
    strncat(faisnd_Erro_warning_Filename, system_date+5, 2 );  /* MM   */
    strncat(faisnd_Erro_warning_Filename, system_date+8, 2 );  /* DD   */
}
...
INT get_FRT_timeout_for_faisnd( void )
{
   DWORD rc;
   CHAR filename     [MAX_FILENAME_SIZE]= {0};
   CHAR tmpstr       [MAX_FILENAME_SIZE]= {0};
...
INT set_timer( pCHAR lookup_key, INT timer_length, INT type_of_timer )
{
   ...
   strcpy( source_que, "faisndA" );

   sprintf(err_buf,"lookupkey while sending to ftimer : %s",lookup_key);
   faisnd_log_message( 2, 1, err_buf, "set_timer",0 );
   ...
   if ( false == ret_val )
	   faisnd_log_message( 2, 2, err_buf, "set_timer",0 );
...
INT send_msg_to_authorizer( BYTE msgtype )
{
   ...
   if ( ret_val == false )
   {
      ...
      faisnd_log_message(1, 2, Buffer, "send_msg_to_authorizer",1 );
   }
	...
	*/
	...
	if ( data_len != Auth_Tx_Size )
	{
		sprintf( err_buf,
				...
				lookup_key );
		faisnd_log_message( 2, 2, err_buf, "process_clear_timer_reply_for_approve_response",0 );
	}
	...
	if ( false == send_msg_to_authorizer(MT_RT_RESPONSE_APPROVED) )
	{
		...
		faisnd_log_message( 1, 3, err_buf, "process_clear_timer_reply_for_approve_response",0 );
	}
}
	...
	*/
	...
	if ( data_len != Auth_Tx_Size )
	{
		sprintf( err_buf,
				"Did not receive chained host response data with timer reply. Key = %s",
				lookup_key );
		faisnd_log_message( 2, 2, err_buf, "process_clear_timer_reply_for_decline_response",0 );
	}
	...
	if ( false == send_msg_to_authorizer(MT_RT_RESPONSE_DECLINE) )
	{
		sprintf( err_buf,
				...
				Auth_Tx.TLF01_details.message_type,
				Auth_Tx.TLF01_details.processing_code);
		faisnd_log_message( 1, 3, err_buf, "process_clear_timer_reply_for_decline_response",0 );
	}
}
	...
	*/
	...
	if ( data_len != Auth_Tx_Size )
	{
		sprintf( err_buf,
				"Did not receive chained host response data with timer reply. Key = %s",
				lookup_key );
		faisnd_log_message( 2, 2, err_buf, "process_clear_timer_reply_for_timeout_response",0 );
	}
	...
	if ( false == send_msg_to_authorizer(MT_RT_RESPONSE_TIMEOUT) )
	{
		sprintf( err_buf,
				...
				Auth_Tx.TLF01_details.message_type,
				Auth_Tx.TLF01_details.processing_code);
		faisnd_log_message( 1, 3, err_buf, "process_clear_timer_reply_for_timeout_response",0 );
	}
}
	...
	*/
	...
	if ( data_len != FTLF01_SIZE )
	{
		sprintf( err_buf,
				"Did not receive chained host response data with timer reply. Key = %s",
				lookup_key );
		faisnd_log_message( 2, 2, err_buf, "process_clear_timer_reply_for_response",0 );
	}
	...
	if (ret_val == RT_SYSTEM)
	{
		...
		if ( false == send_msg_to_authorizer(MT_RT_RESPONSE_TIMEOUT) )
		{
			sprintf( err_buf,
					...
					Auth_Tx.TLF01_details.message_type,
					Auth_Tx.TLF01_details.processing_code);
			faisnd_log_message( 1, 3, err_buf, "process_clear_timer_reply_for_response",0 );
		}
	...
	else
	{
		...
		faisnd_log_message(2,1,err_buf,"process_clear_timer_reply_for_response",1);
	...
	*/
	...
	/*if ( data_len != Auth_Tx_Size )
	{
		sprintf( err_buf,
				"Did not receive chained host response data with timer reply. Key = %s",
				lookup_key );
		faisnd_log_message( 2, 2, err_buf, "process_clear_timer_reply_for_no_response",0 );
	}*/
	...
	faisnd_log_message(2,1,strError,"process_clear_timer_reply_for_no_response",1);
	...
	if ( false == send_msg_to_authorizer(MT_RT_RESPONSE_TIMEOUT) )
	{
		sprintf( err_buf,
				...
				Auth_Tx.TLF01_details.message_type,
				Auth_Tx.TLF01_details.processing_code);
		faisnd_log_message( 1, 3, err_buf, "process_clear_timer_reply_for_no_response",0 );
	}
}
...
void send_request_to_timerds()
{
	...
	faisnd_log_message(2,1,err_buf,"send_request_to_timerds",1);
	...
	if (false == ret_val)
	{
		sprintf( err_buf,	"Cannot process %s txn request to host. Unable to set timer.",
							Auth_Tx.TLF01_details.message_type );
		faisnd_log_message(2,1,err_buf,"send_request_to_timerds",0);

	}

}

void RqMssg_EXT10_Data(pPTE_MSG p_msg_in)
{
	...
	memset (&Auth_Tx, 0, sizeof (AUTH_TX)) ;
	memset(&Ext10_DFld,0,sizeof(Ext10_DFld));
	memset(&message,0,sizeof(message));
	...
	faisnd_log_message(2,1,"faisndRT: New request from faisnd controller","RqMssg_EXT10_Data",1);
	...
	strcat(key,Auth_Tx.TLF01_details.nii);
	/*sprintf(msgBuffer,"CRTRAN message built with a unique Key:%s\n",key);
	faisnd_log_message(2,1,msgBuffer,"RqMssg_EXT10_Data",0);*/
	...
	/*faisnd_build_request_ext10_HeaderFile();*/
	faisnd_build_request_EXT10_HeaderFile();
	faisnd_build_request_ext10_field_1( );
	faisnd_build_request_ext10_field_2( );
	faisnd_build_request_ext10_field_3( );
	faisnd_build_request_ext10_field_4( );
	faisnd_build_request_ext10_field_5( );
	faisnd_build_request_ext10_field_6( );
	faisnd_build_request_ext10_field_7( );
	faisnd_build_request_ext10_field_8( );
	faisnd_build_request_ext10_field_9( );
	faisnd_build_request_ext10_field_10( );
	faisnd_build_request_ext10_field_11( );
	faisnd_build_request_ext10_field_12( );
	faisnd_build_request_ext10_field_13( );
	faisnd_build_request_ext10_field_14( );
	faisnd_build_request_ext10_field_15( );
	faisnd_build_request_ext10_field_16( );
	faisnd_build_request_ext10_field_17( );
	faisnd_build_request_ext10_field_18( );
	faisnd_build_request_ext10_field_19( );
	faisnd_build_request_ext10_field_20( );
	faisnd_build_request_ext10_field_21( );
	faisnd_build_request_ext10_field_22( );
	faisnd_build_request_ext10_field_23( );
	faisnd_build_request_ext10_field_24( );
	faisnd_build_request_ext10_field_25( );
	faisnd_build_request_ext10_field_26( );
	faisnd_build_request_ext10_field_27( );
	faisnd_build_request_ext10_field_28( );
	faisnd_build_request_ext10_field_29( );
	faisnd_build_request_ext10_field_30( );
	faisnd_build_request_ext10_field_31( );
	faisnd_build_request_ext10_field_32( );
	faisnd_build_request_ext10_field_33( );
	faisnd_build_request_ext10_field_34( );
	faisnd_build_request_ext10_field_35( );
	faisnd_build_request_ext10_field_36( );
	faisnd_build_request_ext10_field_37( );
	faisnd_build_request_ext10_field_38( );
	faisnd_build_request_ext10_field_39( );
	faisnd_build_request_ext10_field_40( );
	faisnd_build_request_ext10_field_41( );
	faisnd_build_request_ext10_field_42( );
	faisnd_build_request_ext10_field_43( );
	faisnd_build_request_ext10_field_44( );
	faisnd_build_request_ext10_field_45( );
	faisnd_build_request_ext10_field_46( );
	faisnd_build_request_ext10_field_47( );
	faisnd_build_request_ext10_field_48( );
	faisnd_build_request_ext10_field_49( );
	faisnd_build_request_ext10_field_50( );
	faisnd_build_request_ext10_field_51( );
	faisnd_build_request_ext10_field_52( );
	faisnd_build_request_ext10_field_53( );
	faisnd_build_request_ext10_field_54( );
	faisnd_build_request_ext10_field_55( );
	faisnd_build_request_ext10_field_56( );
	printf("\nCRTran_EXT10_req: %s\n", message);
}
...
void PinnacleMsgHandler(pPTE_MSG p_msg_in)
{
   ...
   faisnd_read_Workflow_indicator();
   ...
   /*case MT_GET_STATS:
    ...
    case MT_AUTH_REQUEST:/*name it as online*/
 					...
 					faisnd_log_message(2,1,msgBuffer,"PinnacleMsgHandler",1);
    ...
    case MT_AUTH_RT_REQUEST:/*name it as realtime*/
 					...
 					faisnd_log_message(2,1,msgBuffer,"PinnacleMsgHandler",0);*/
 					/*send the req to Ftimerds
 					send_request_to_timerds();*/
 					break;
    case MT_AUTH_EXT10_REQUEST:
    				/* Call EXT10 request When Vertexon
    				 * did not approve the auth request */
    				RqMssg_EXT10_Data(p_cur_msg);
    				msglen=strlen(message);
    				sprintf(msgBuffer,"Sending message in RT Mode for EXT10, msglen:(%d) ",msglen);
    				faisnd_log_message(2,1,msgBuffer,"PinnacleMsgHandler",1);
    				break;
	...
	case MT_TIMER_REPLY:
			...
			/*faisnd_log_message(2,1,"MT_TIMER_REPLY","PinnacleMsgHandler",0);*/
			...
			{
				faisnd_log_message(2,1,"MT_TIMER_REPLY result code fail ","PinnacleMsgHandler",0 );
			}*/
			if (PTEMSG_OK == ptemsg_get_result_code(p_cur_msg))
			{
			   subtype1 = ptemsg_get_msg_subtype1(p_cur_msg);
			   ...
			   {
				  /* do nothing */
				  faisnd_log_message(2,1,"ST1_TIMER_START ","PinnacleMsgHandler",0 );

			   }
			   else
			   {
				   faisnd_log_message(2,1,"ST1_TIMER_REPLY ","PinnacleMsgHandler",0 );
     ...
     case MT_SYSTEM_REQUEST:
          	  ...
          	  case ST1_SYS_PING	:		if ( ST1_SYS_PING == ptemsg_get_msg_subtype1(p_msg_in) )
										{
												...
												sprintf( strTemp,
															"Pinged -> faisnd Service: %s, version %s",
															ServiceName, Version );
      ...
      default:
          ...
          TxUtils_Send_Msg_To_Operator 
				  (1, strTemp,
					1, ERROR_MSG,"FAIsndHandler.c", 4, FATAL_ERROR,0, 0, 0) ;
		break ;
    }  /* switch msg_type */
}
INT send_transaction_statistics( pPTE_MSG p_msg )
{
   ...
   if ( false == ret_code  )
   {
      faisnd_log_message( 2, 1, err_msg, "send_transaction_statistics",1 );
   }
   return( ret_code );
}
...
BYTE faisnd_Send_Interactive_DB_Request( pPTE_MSG  p_msg_out,
                                               pPTE_MSG *p_msg_in,
                                               pCHAR     que_name,
                                               pCHAR     error_msg )
{
...
BYTE Get_CCL01_Details_for_Decimal_places (void)
{
	...
	pPTE_MSG_DATA p_msg_data;
	BYTE          rcode = true;
	BYTE          buffer[sizeof(AUTH_TX) + sizeof(CCL01_GUI_LIST)];
	char 		 error_msg[100];
	...
	{
	  rcode = faisnd_Send_Interactive_DB_Request(p_msg_out,
													  &p_msg_in,
													  trands_que_name,
													  error_msg );
	  if ( rcode == PTEMSG_OK )
	  {
		 ...
		 memcpy( &ccl01_list, p_data+sizeof(AUTH_TX), sizeof(CCL01_GUI_LIST) );

		 ccl01_count = atoi (ccl01_list.num_returned);
	  }

	  for(i = 0; i < ccl01_count; i ++)
	  {
		  strncpy(tmp_ccl01_list[i].currency_value, ccl01_list.ccl01_record[i].currency_value, 3);
		  strncpy(tmp_ccl01_list[i].currency_decimal_places, ccl01_list.ccl01_record[i].currency_decimal_places, 1);
	  }
...
{
   /*printf("faisnd:Recived Signal Handler\n");*/
...
INT Get_particular_CCL01_record_for_Decimal_places_with_wait (pBYTE curr_code, INT arr_index)
{
	...
	pPTE_MSG_DATA p_msg_data;
	BYTE          rcode = true;
	BYTE          buffer[sizeof(AUTH_TX) + sizeof(CCL01)];
	char 		 error_msg[100];

	memset( buffer,0, sizeof(buffer) );
	memset (&pCCL01, 0x00, sizeof (CCL01)) ;
	memcpy (pCCL01.currency_value, curr_code, sizeof(pCCL01.currency_value) - 1);
	memcpy( buffer, &Auth_Tx, sizeof(Auth_Tx) );
	memcpy( buffer+sizeof(Auth_Tx), &pCCL01, sizeof(CCL01));
	...
	else
	{
	  ...
	  if ( rcode == PTEMSG_OK )
	  {
		 ...
		 memcpy( &pCCL01, p_data+sizeof(AUTH_TX), sizeof(CCL01) );
		 strncpy(tmp_ccl01_list[ arr_index ].currency_decimal_places, &pCCL01.currency_decimal_places[0], 1);

		 retCode = pCCL01.currency_decimal_places[0];
		 free(p_msg_in);
	  }
	  else
	  {
...
void faisnd_verify_temp_ccl01_list_for_decimal_places()
{
	INT i = 0;
	BYTE txn_curr_code[4] = {0};
	int retcode = 0;
	INT chk_cur_flg = 0;

	if (true == faisnd_is_Issuing_Transaction())
	{
		/* copy 3rd currency code if not PESO OR USD */
		if (true == Check_If_DINERS_Transaction() &&
			(0 != strncmp(Auth_Tx.TLF01_details.product_codes[13].code, USD, 3 ) &&
			 0 != strncmp(Auth_Tx.TLF01_details.product_codes[13].code, PESO, 3)))
		{
			strncpy(txn_curr_code, Auth_Tx.TLF01_details.product_codes[13].code, 3);
		}
		else if (true == Check_If_CUP_Transaction() &&
				(0 != strncmp(Auth_Tx.TLF01_details.nfi_seq_nbr, USD, 3 ) &&
				 0 != strncmp(Auth_Tx.TLF01_details.nfi_seq_nbr, PESO, 3)))
		{			/* CUP CC = 352 */
			strncpy(txn_curr_code, Auth_Tx.TLF01_details.nfi_seq_nbr, 3);
		}
		else if (0 != strncmp(Auth_Tx.TLF01_details.nfi_seq_nbr, USD, 3) &&
				 0 != strncmp(Auth_Tx.TLF01_details.nfi_seq_nbr, PESO, 3))
		{
			strncpy(txn_curr_code, Auth_Tx.TLF01_details.nfi_seq_nbr, 3);
		}
		else
		{	/* copy currency code if PESO OR USD */
			strncpy(txn_curr_code, Auth_Tx.TLF01_details.currency_code, 3);
		}
	}

	for (i = 0; i < ccl01_count; i++)
	{
		if (tmp_ccl01_list[i].currency_value[0] != '\0')
		{
			if (0 == strncmp(tmp_ccl01_list[i].currency_value, txn_curr_code, 3))
			{
				strncpy(dec_plcs, tmp_ccl01_list[i].currency_decimal_places, 2);
				chk_cur_flg = 1;
			}
		}
	}
	...
	if (chk_cur_flg == 0)
	{
		retcode = Get_particular_CCL01_record_for_Decimal_places_with_wait( txn_curr_code, i );

		if (retcode == -1)
		{
			/* set the default value to 2 */
			dec_plcs[0] = '2';
			faisnd_log_message( 2, 3, "Txn currency code does not match in the currency code list",
										" faisnd_verify_ccl01_list_for_decimal_places ", 1 );
		}
		else
		{
			dec_plcs[0] = retcode;
			faisnd_log_message( 2, 3, "Txn currency code match with the last record loaded",
													" faisnd_verify_ccl01_list_for_decimal_places ", 1 );
		}
...
INT FAIsndHandler_initialize(CHAR* appName, CHAR* serName)
{
	INT ret_val = true;
	CHAR err_buf[100] = { 0 };
	...
	faisnd_read_CUP_merchant_indicator();
	faisnd_get_error_warning_file_name_path();
	get_FRT_timeout_for_faisnd();
	...
	/* This peace of code is alredy there in faisnd_read_CUP_merchant_indicator function
	 GetPrivateProfileString(
	 "CUPMIDSECTION",
	 "CUP_MID_INDICATOR",
	 "0",
	...
	if (t_id == 0)
	{
		...
		faisnd_log_message(1,1,strTemp,"FAIsndHandler_initialize",1);

	}

	if (ccl01_flag == 0)
	{
		rcode = Get_CCL01_Details_for_Decimal_places();
		ccl01_flag = 1;
		faisnd_log_message( 2, 3, "Get Currency code list through Interactive DB call",
									" FAIsndHandler_initialize ", 1 );
	}

	sprintf(strTemp, "Started the FAIsndHandler Service: %s", ServiceName);
	LogEvent(strTemp, INFO_MSG);
...
void faisnd_get_error_warning_file_name_path(void )
{
   DWORD rc;
   CHAR  filename   [80] = {0};
   CHAR  tmpstr     [80] = {0};
   CHAR  faisnd_error_warning_file_size[5] = {0};
   ...
   rc = GetPrivateProfileString(
								  ...
								  "DB_STATICS_PATH",       	/* points to key name             */
								   "",  					/* Default string                 */
								   faisnd_error_warning_file_path,              	/* points to destination buffer   */
								   sizeof(faisnd_error_warning_file_path)-1,   	 /* size of destination buffer     */
								   filename                  /* points to ini filename         */
						 	   );
   ...
   rc = GetPrivateProfileString(
								  ...
								  "",  					/* Default string                 */
								  faisnd_module_error_warning_file_name,              	/* points to destination buffer   */
								  sizeof(faisnd_module_error_warning_file_name)-1,   	 /* size of destination buffer     */
								  filename                  /* points to ini filename         */
								);
   ...
   rc = GetPrivateProfileString(
							  ...
							  "500",  					/* Default string                 */
							  faisnd_error_warning_file_size,              	/* points to destination buffer   */
							  sizeof(faisnd_error_warning_file_size)-1,   	 /* size of destination buffer     */
							  filename                  /* points to ini filename         */
							);

	/* File size size conversion */
	Max_File_Size_Defined = atoi(faisnd_error_warning_file_size);
   ...
   if((strlen(faisnd_error_warning_file_path) > 0) &&
	  (strlen(faisnd_module_error_warning_file_name)> 0))
   {
	   faisnd_create_Error_Filename();
   }
}

CHAR* FAIsndHandler_sendRequestMessage(CHAR* srvNam)
{
	LONG lReturnCode = 0L;
	CHAR strTemp[256] = { 0 };
	pPTE_MSG p_msg = 0;
	...
	if (strcmp(javaEndProcessSignalled, "1") != 0) {
		...
		if (p_msg != NULL_PTR) {
			...
			faisnd_log_message(2,1,strBuffer,"FAIsndHandler_sendRequestMessage",0);*/
			count++;
			err_ctr = 0;
...
void FAIsndHandler_receiveResponseMsg(char* ResponseMsg)
 {
...
char buffer[256]={0};
	...
	{
		faisnd_log_message(2,3,"faisndRT: not received response from FAI","faisnd_Send_Request_To_Service",1);
		return RT_UNKOWN;
	}
	...
	sprintf(buffer,"faisndRT: Response Tranid+RRN (%.31s)",Rsp_msg.Scr_Rsp_Hdr.EH_EXT_HDR);
	faisnd_log_message(2,1,buffer,"Parse_Rsp_Msg",1);
...
void FAIsndHandler_terminate()
{
	...
	CHAR strTemp[256] = { 0 };
	CHAR SerName[20] = { 0 };
	strcpy(SerName, "FAIsndHandler");
	sprintf(strTemp, "Shutting down the FAIsndHandler Service: %s", SerName);
	LogEvent(strTemp, INFO_MSG);
...
INT FAIsndHandler_getLibFileVersion()
{
	CHAR ver_buf[5] = { 0 };
	sprintf(ver_buf, "faisnd_Version:%s", Version);
...
INT faisnd_read_CUP_MP_Bin_range_len_1( void )
{
   DWORD rc;
   CHAR filename     [MAX_FILENAME_SIZE]= {0};
   CHAR tmpstr       [MAX_FILENAME_SIZE]= {0};
...
/******************************************************************************
 *
 *  NAME:         faisnd_read_CUP_MP_Bin_range_len_2
 *
 *  DESCRIPTION:  This function reads information from the tf ini file.
 *
 *  INPUTS:       None
 ...
 *  MODIFICATIONS:
 ******************************************************************************/
INT faisnd_read_CUP_MP_Bin_range_len_2( void )
{
   DWORD rc;
   CHAR filename     [MAX_FILENAME_SIZE]= {0};
   CHAR tmpstr       [MAX_FILENAME_SIZE]= {0};
...
/******************************************************************************
 *
 *  NAME:         faisnd_read_CUP_MP_Bin_range_len_3
 *
 *  DESCRIPTION:  This function reads information from the tf ini file.
 *
 *  INPUTS:       None
 ...
 *  MODIFICATIONS:
 ******************************************************************************/
INT faisnd_read_CUP_MP_Bin_range_len_3( void )
{
   DWORD rc;
   CHAR filename     [MAX_FILENAME_SIZE]= {0};
   CHAR tmpstr       [MAX_FILENAME_SIZE]= {0};
...
/******************************************************************************
 *
 *  NAME:         faisnd_read_CUP_MP_Bin_range_len_4
 *
 *  DESCRIPTION:  This function reads information from the tf ini file.
 *
 *  INPUTS:       None
 ...
 *  MODIFICATIONS:
 ******************************************************************************/
INT faisnd_read_CUP_MP_Bin_range_len_4( void )
{
   DWORD rc;
   CHAR filename     [MAX_FILENAME_SIZE]= {0};
   CHAR tmpstr       [MAX_FILENAME_SIZE]= {0};
...
/******************************************************************************
 *
 *  NAME:         faisnd_read_CUP_MP_Bin_range_len_5
 *
 *  DESCRIPTION:  This function reads information from the tf ini file.
 *
 *  INPUTS:       None
 ...
 *  MODIFICATIONS:
 ******************************************************************************/
INT faisnd_read_CUP_MP_Bin_range_len_5( void )
{
   DWORD rc;
   CHAR filename     [MAX_FILENAME_SIZE]= {0};
   CHAR tmpstr       [MAX_FILENAME_SIZE]= {0};
...
/******************************************************************************
 *
 *  NAME:         faisnd_read_CUP_MP_Bin_range_1_indicator
 *
 *  DESCRIPTION:  This function reads information from the tf ini file.
 *
 *  INPUTS:       None
 ...
 *  MODIFICATIONS:
 ******************************************************************************/
INT faisnd_read_CUP_MP_Bin_range_1_indicator( void )
{
   DWORD rc;
   CHAR filename     [MAX_FILENAME_SIZE]= {0};
   CHAR tmpstr       [MAX_FILENAME_SIZE]= {0};
...
/******************************************************************************
 *
 *  NAME:         faisnd_read_CUP_MP_Bin_range_2_indicator
 *
 *  DESCRIPTION:  This function reads information from the tf ini file.
 *
 *  INPUTS:       None
 ...
 *  MODIFICATIONS:
 ******************************************************************************/
INT faisnd_read_CUP_MP_Bin_range_2_indicator( void )
{
   DWORD rc;
   CHAR filename     [MAX_FILENAME_SIZE]= {0};
   CHAR tmpstr       [MAX_FILENAME_SIZE]= {0};
...
/******************************************************************************
 *
 *  NAME:         faisnd_read_CUP_MP_Bin_range_3_indicator
 *
 *  DESCRIPTION:  This function reads information from the tf ini file.
 *
 *  INPUTS:       None
 ...
 *  MODIFICATIONS:
 ******************************************************************************/
INT faisnd_read_CUP_MP_Bin_range_3_indicator( void )
{
   DWORD rc;
   CHAR filename     [MAX_FILENAME_SIZE]= {0};
   CHAR tmpstr       [MAX_FILENAME_SIZE]= {0};
...
/******************************************************************************
 *
 *  NAME:         faisnd_read_CUP_MP_Bin_range_4_indicator
 *
 *  DESCRIPTION:  This function reads information from the tf ini file.
 *
 *  INPUTS:       None
 ...
 *  MODIFICATIONS:
 ******************************************************************************/
INT faisnd_read_CUP_MP_Bin_range_4_indicator( void )
{
   DWORD rc;
   CHAR filename     [MAX_FILENAME_SIZE]= {0};
   CHAR tmpstr       [MAX_FILENAME_SIZE]= {0};
...
/******************************************************************************
 *
 *  NAME:         faisnd_read_CUP_MP_Bin_range_5_indicator
 *
 *  DESCRIPTION:  This function reads information from the tf ini file.
 *
 *  INPUTS:       None
 ...
 *  MODIFICATIONS:
 ******************************************************************************/
INT faisnd_read_CUP_MP_Bin_range_5_indicator( void )
{
   DWORD rc;
   CHAR filename     [MAX_FILENAME_SIZE]= {0};
   CHAR tmpstr       [MAX_FILENAME_SIZE]= {0};
...
/******************************************************************************
 *
 *  NAME:         faisnd_Read_BDO_PAY_QR_NII_value
 *
      ...
      if ( ret_val == false )
      {
         ...
         sprintf( Buffer,
                 "Unable to insert record into %s.  Error = %s",
                  db_table, err_buf );
         faisnd_log_message(1, 3, Buffer, "insert_db_record",1 );
      }
...
INT clear_request_timer_for_timeout_response( pCHAR lookup_key )
{
   ...
   faisnd_log_message( 2, 1, err_buf, "clear_request_timer_for_timeout_response",0 );
   ...
   if ( false == ret_val )
	   faisnd_log_message( 2, 2, err_buf, "clear_request_timer_for_timeout_response",0 );
...
INT clear_request_timer_for_decline_response( pCHAR lookup_key )
{
   ...
   sprintf(err_buf, "lookup key : %s", lookup_key);
   faisnd_log_message( 2, 1, err_buf, "clear_request_timer_for_decline_response",0 );
   ...
   if ( false == ret_val )
	   faisnd_log_message( 2, 2, err_buf, "clear_request_timer_for_decline_response",0 );
...
INT clear_request_timer_for_approval_response( pCHAR lookup_key )
{
   ...
   sprintf(err_buf, "lookup key : %s", lookup_key);
   faisnd_log_message( 2, 1, err_buf, "clear_request_timer_for_approval_response",0 );
   ...
   if ( false == ret_val )
	   faisnd_log_message( 2, 2, err_buf, "clear_request_timer_for_approval_response",0 );
...
INT clear_request_timer_for_Received_Response( pCHAR lookup_key )
{
   ...
   faisnd_log_message( 2, 1, err_buf, "clear_request_timer_for_Received_Response",0 );
   ...
   if ( false == ret_val )
	   faisnd_log_message( 2, 2, err_buf, "clear_request_timer_for_Received_Response",0 );
...
BYTE faisnd_Send_Request_To_Service_Old (BYTE* que_name, BYTE nType, BYTE nSubType1,
							  ...
							  pBYTE p_data,   INT nDataSize)
{
   ...
   /* Get system timestamp "YYYY-MM-DD-hh.mm.ss.jjj" */
	...
	if (RT_RESPONSE == ret_val)
	{
		...
		faisnd_log_message(2,3,strError,"faisnd_Send_Request_To_Service",1);
	...
	{
		/* log msg */
		strcpy (strError,"faisnd writes failed into ActiveMQ") ;
		faisnd_log_message(1,3,strError,"faisnd_Send_Request_To_Service",1);

		strncpy(Ftlf01.tran_req_sent_mode, "RT", 2);

		/*copy resp recv mode */
		strncpy(Ftlf01.tran_resp_recv_mode, "SF", 2);
		strcpy(Ftlf01.response_text, "faisnd writes failed into ActiveMQ");
		/* copy decision codes */
		strncpy(Ftlf01.decision_code_1_value, 0x00, sizeof(Ftlf01.decision_code_1_value)-1);
		strncpy(Ftlf01.decision_code_2_value, 0x00, sizeof(Ftlf01.decision_code_2_value)-1);
		strncpy(Ftlf01.decision_code_3_value, 0x00, sizeof(Ftlf01.decision_code_3_value)-1);
...
BYTE faisnd_Send_Request_To_Service (BYTE* que_name, BYTE nType, BYTE nSubType1,
							  BYTE nSubType2, BYTE nAppDataType,
							  pBYTE p_data,   INT nDataSize)
{
	LONG retCode = 0L ;
	...
	retVal =	build_and_send_request_message( MT_AUTH_RESPONSE,
									0,
									0,
									(pBYTE)faisnd_controller_que_name,
									(pBYTE)&buffer,
	...
	faisnd_log_message(2,1,"faisndRT: Sending the response to faisnd controller","faisnd_Send_Request_To_Service",1);
	...
	faisnd_log_message(2,1,strError,"faisnd_Send_Request_To_Service",1);
	...
	return DEVICE_OK ;
#endif
} /* faisnd_Send_Request_To_Service_New */
...
void RT_faisnd_build_request_field_12( )
{
...
void RT_faisnd_build_request_field_21( )
{
	if(strcmp(Auth_Tx.ACF01_details.available,"") != 0)
	{
		char temp_avail_amt[11]="";
...
void RT_faisnd_build_request_field_31( )
{
    ...
    else if (Check_If_AMEX_Transaction ()    == true)
	{
    	...
    	RT_faisnd_build_CRTRAN_field_31_AMEX();
	}
    else if (Check_If_Fleet_Transaction ()    == true)
	{
    	RT_faisnd_build_CRTRAN_field_31_Fleet();
	}
    else
    {
...
void RT_faisnd_build_request_field_33( )
{
	...
	Else �BLANK�
	*/
void RT_faisnd_build_request_field_34( )
{
	if( strncmp(Auth_Tx.TLF01_details.response_code,"00",2)== 0 ||
		strncmp(Auth_Tx.TLF01_details.response_code,"10",2)== 0 ||
		strncmp(Auth_Tx.TLF01_details.response_code,"11",2)== 0 ||
...
void RT_faisnd_build_request_field_35()
{
	if( Auth_Tx.TLF01_details.tx_key == AUTH_SALE          || Auth_Tx.TLF01_details.tx_key == AUTH_SALE_RESPONSE ||
		Auth_Tx.TLF01_details.tx_key == AUTH_AUTHORIZATION || Auth_Tx.TLF01_details.tx_key == AUTH_AUTHORIZATION_RESPONSE||
		Auth_Tx.TLF01_details.tx_key == AUTH_ADVICE        || Auth_Tx.TLF01_details.tx_key == AUTH_ADVICE_RESPONSE||
...
void RT_faisnd_build_request_field_36()
{
...
void RT_faisnd_build_request_field_37()
{
	if(strncmp(Auth_Tx.MCF01_details.zip_code,"9999",4)== 0)
	{
...
void RT_faisnd_build_request_field_38()
{
	if(strlen(Auth_Tx.MCF01_details.primary_key.merchant_id)> 0)
	{
...
void RT_faisnd_build_request_field_39()
{
	if(strcmp(Auth_Tx.BIN01_details.card_family, CARD_MASTERCARD)== 0)
	{
		if(strcmp(Auth_Tx.TLF01_details.response_code, "00") == 0)
...
void RT_faisnd_build_request_field_40()
{
	if(strcmp(Auth_Tx.BIN01_details.card_family, CARD_MASTERCARD)== 0)
	{
		/* mapping variable need to check*/
...
/*	Please refer to POS netry mode mapping doc : # */
void RT_faisnd_build_request_field_41()
{
	char temp_pos_entry_mode[3]={0};
	if(strlen(Auth_Tx.TLF01_details.pos_entry_mode)== 3)
	{
	...
	{
		strncpy(Cr_Fld_RT.TRANSACTION_POSTING_ENTRY_XFLG,
				FAI_MOBILE_NFC_TAP2PHONE_TXN,
				FAI_MOBILE_NFC_TAP2PHONE_TXN_LEN);
	}
	/*Swiftpass BDO Pay Credit Transactions With Pin*/
...
void RT_faisnd_build_request_field_42( )
{
...
void RT_faisnd_build_request_field_49( )
{
...
void RT_faisnd_build_request_field_57( )
{
	if(strncmp(Cr_Fld_RT.TRANSACTION_POSTING_ENTRY_XFLG,"E",1) == 0)
	{
...
void RT_faisnd_build_request_field_63( )
{
	if(strlen(Auth_Tx.MCF01_details.city)== 0)
	{
...
void RT_faisnd_build_request_field_64( )
{
	if(strlen(Auth_Tx.MCF01_details.intl_code)== 0)
	{
...
void RT_faisnd_build_request_field_65( )
{
	memset(Cr_Fld_RT.SUPPRES_CASE_XFLG,' ',1);
	sprintf(&message[602],"%-1s\n",Cr_Fld_RT.SUPPRES_CASE_XFLG);
}
void RT_faisnd_build_request_field_66( )
{
	if(0 == strncmp(Auth_Tx.TLF01_details.product_codes[2].quantity, "1", 1))
	{
		/*** For MP/Installament transactions ***/
		memcpy(Cr_Fld_RT.USER_INDICATOR_3_XCD, Auth_Tx.TLF01_details.deferred_term_length, 3);
	...
	/*********************UserIndicator04****************************/
void RT_faisnd_build_request_field_67( )
{
	int len_curr_code, len_TLF_curr_code = 0, len_recon_curr_code=0 ;
...
void RT_faisnd_build_request_field_68( )
{
	char temp_totalamt[14]={0};
	LONG tran_amount = 0;
	INT	  curr_dec_pls = 0;
...
void RT_faisnd_build_request_field_69( )
{
	if(strlen(Auth_Tx.TLF01_details.response_text)>0)
	{
...
void RT_faisnd_build_request_field_70( )
{
	CHAR resp_buf[15] = {0} ;
...
void RT_faisnd_build_request_field_89( )
{
	if (strcmp(Auth_Tx.BIN01_details.card_family, CARD_MASTERCARD)== 0)
	{
		if(Auth_Tx.TLF01_details.cvc == 'P')
...
void RT_faisnd_build_request_field_90( )
{
...
void RT_faisnd_build_request_field_91( )
{
...
void RT_faisnd_build_request_field_94( )
{
	if(strcmp(Auth_Tx.TLF01_details.terminal_id,"") != 0)
	{
...
void RT_faisnd_build_request_field_95( )
{
	...
	/*Field 96 Terminal Entry capability */
void RT_faisnd_build_request_field_96( )
{
...
void RT_faisnd_build_request_field_97( )
{
...
void RT_faisnd_build_request_field_115( )
{
	memset(Cr_Fld_RT.PROCESSOR_REASON_XCD,' ',5);
	sprintf(&message[883],"%-5s\n",Cr_Fld_RT.PROCESSOR_REASON_XCD);
}
void RT_faisnd_build_request_field_116( )
{
	if(strcmp(Auth_Tx.TLF01_details.product_codes[1].code,"stndin") == 0)
	{
...
void RT_faisnd_build_request_field_117( )
{
...
void RT_faisnd_build_request_field_119( )
{
	...
	/*Field 120 ECI value*/
void RT_faisnd_build_request_field_120( )
{
	memset(Cr_Fld_RT.USER_DATA_6_NUM,' ',13);
	...
	/* User data 7 filled with AMEX POS DATA - Auth_Tx.amex_pos_entry_mode*/
void RT_faisnd_build_request_field_121( )
{
	/*	Prepare POS data only for acquired transaction */
	if((0 == strncmp(Auth_Tx.TLF01_details.handler_queue,"dcp",3)) ||
	   (0 == strncmp(Auth_Tx.TLF01_details.handler_queue,"VOICE",5)))
	{
		faisnd_Prepare_Pos_Data_F121();
	}
	memset(Cr_Fld_RT.USER_DATA_7_STRG,' ',40);
	if(strcmp(Auth_Tx.BIN01_details.card_family, CARD_AMEX)	== 0)
	{
...
void RT_faisnd_build_request_field_135( )
{
	...
	/*Field 136 Service code*/
void RT_faisnd_build_request_field_136( )
{
...
void RT_faisnd_build_request_field_137( )
{
...
/*void faisnd_build_request_ext10_HeaderFile( )
{
	memcpy(Ext10_DFld.HeaderFile,"O000009710000000000102tdriver   PMAX      0000000000                  ",70);
	sprintf(message,"%-70s\n",Ext10_DFld.HeaderFile);
}*/
...
void faisnd_build_request_EXT10_HeaderFile( )
{
    ...
    strncpy(temp_hdr, "E000016500031000000102tdriver   PMAX      0000000000 ", 53);
	strncat(temp_hdr, transcn_id, TRANSCN_ID_LEN);
	strncat(temp_hdr, Auth_Tx.TLF01_details.retrieval_ref_num, RRN_LEN);
	strncat(temp_hdr, "                 ", 17);

	memcpy(Ext10_DFld.HeaderFile, temp_hdr, faisnd_RT_HDR_LEN);
	sprintf(message,"%-101s\n",Ext10_DFld.HeaderFile);

	sprintf(buffer,"faisndRT: Request Tranid+RRN (%s%.12s)",transcn_id,Auth_Tx.TLF01_details.retrieval_ref_num);
	faisnd_log_message(2,1,buffer,"faisnd_build_request_EXT10_HeaderFile",1);
}
void faisnd_build_request_ext10_field_1( )
{
	memcpy(Ext10_DFld.WORKFLOW,"modelSTUB",16);
	sprintf(&message[101],"%-16s\n",Ext10_DFld.WORKFLOW);
}
void faisnd_build_request_ext10_field_2( )
{
	memcpy(Ext10_DFld.RECORD_TYPE,"EXT10",8);
	sprintf(&message[117],"%-8s\n",Ext10_DFld.RECORD_TYPE);
}
void faisnd_build_request_ext10_field_3(  )
{
	memcpy(Ext10_DFld.DATA_SPECIFICATION_VERSION,"1.0",5);
	sprintf(&message[125],"%-5s\n",Ext10_DFld.DATA_SPECIFICATION_VERSION);
}
void faisnd_build_request_ext10_field_4( )
{
	memcpy(Ext10_DFld.CLIENT_FROM_HDR,"DT_BDO_CR",16);
	sprintf(&message[130],"%-16s\n",Ext10_DFld.CLIENT_FROM_HDR);
}
void faisnd_build_request_ext10_field_5( )
{
	memcpy(Ext10_DFld.RCD_CRT_DATE,date_str,8);
	sprintf(&message[146],"%-8s\n",Ext10_DFld.RCD_CRT_DATE);
}
void faisnd_build_request_ext10_field_6( )
{
	memcpy(Ext10_DFld.RCD_CRT_TIME,time_str,6);
	sprintf(&message[154],"%-6s\n",Ext10_DFld.RCD_CRT_TIME);
}
void faisnd_build_request_ext10_field_7( )
{
	memcpy(Ext10_DFld.RCD_CRT_MSCND,time_milliseconds,3);
	sprintf(&message[160],"%-3s\n",Ext10_DFld.RCD_CRT_MSCND);
}
void faisnd_build_request_ext10_field_8( )
{
	memcpy(Ext10_DFld.GMT_OFFSET,"8.00",6);
	sprintf(&message[163],"%-6s\n",Ext10_DFld.GMT_OFFSET);
}
void faisnd_build_request_ext10_field_9( )
{
	memset(Ext10_DFld.CUSTOMER_ID_HDR,' ', 20);
	memcpy(Ext10_DFld.CUSTOMER_ID_HDR, Auth_Tx.TLF01_details.card_num, 20);
	sprintf(&message[169],"%-20s\n",Ext10_DFld.CUSTOMER_ID_HDR);
}
void faisnd_build_request_ext10_field_10( )
{
	memset(Ext10_DFld.CUSTOMER_ACT_NO,' ', 40);
	memcpy(Ext10_DFld.CUSTOMER_ACT_NO, Auth_Tx.TLF01_details.card_num, 20);
	sprintf(&message[189],"%-40s\n",Ext10_DFld.CUSTOMER_ACT_NO);
}
void faisnd_build_request_ext10_field_11( )
{
	char temp_Tran_id[33]={0};
	char transcn_id[20] = {0};
	static INT  faisnd_tx_counter=0;
	...
	sprintf(temp_Tran_id,"%-19s-CRT-%08d",transcn_id,faisnd_tx_counter++);
	/*strncpy(temp_Tran_id,Auth_Tx.TLF01_details.primary_key.transaction_id,20);
	strcat(temp_Tran_id,"-CRT-");
	sprintf(&temp_Tran_id[25],"%07d",faisnd_tx_counter++);*/
	strncpy(Ext10_DFld.EXTERNAL_TRANSACTION_XID,temp_Tran_id,32);
	sprintf(&message[229],"%-32s\n",Ext10_DFld.EXTERNAL_TRANSACTION_XID);
}
void faisnd_build_request_ext10_field_12( )
{
	memcpy(Ext10_DFld.SERVICE_ID,Auth_Tx.TLF01_details.card_num,19);
	sprintf(&message[261],"%-19s\n",Ext10_DFld.SERVICE_ID);
}
void faisnd_build_request_ext10_field_13( )
{
	memcpy(Ext10_DFld.TRANSACTION_DATE, Auth_Tx.TLF01_details.date_yyyymmdd, 8);
	sprintf(&message[280],"%-8s\n",Ext10_DFld.TRANSACTION_DATE);
}
void faisnd_build_request_ext10_field_14( )
{
	memcpy(Ext10_DFld.TRANSACTION_TIME, Auth_Tx.TLF01_details.time_hhmmss, 6);
	sprintf(&message[288],"%-6s\n",Ext10_DFld.TRANSACTION_TIME);
}
void faisnd_build_request_ext10_field_15( )
{
	memset(Ext10_DFld.VALIDITY,' ',4);
	sprintf(&message[294],"%-4s\n",Ext10_DFld.VALIDITY);
}
void faisnd_build_request_ext10_field_16( )
{
	memcpy(Ext10_DFld.ENTITY_TYPE,"SRVC",4);
	sprintf(&message[298],"%-4s\n",Ext10_DFld.ENTITY_TYPE);
}
void faisnd_build_request_ext10_field_17( )
{
	memcpy(Ext10_DFld.EXTSOURCE,"CREDIT_RT",48);
	sprintf(&message[302],"%-48s\n",Ext10_DFld.EXTSOURCE);
}
void faisnd_build_request_ext10_field_18( )
{
	memcpy(Ext10_DFld.NOTIFICATION_NAME,"CREDIT_RT",48);
	sprintf(&message[350],"%-48s\n",Ext10_DFld.NOTIFICATION_NAME);
}

void faisnd_build_request_ext10_field_19( )
{
	memset(Ext10_DFld.NOTIFICATION_STATUS,' ',10);
	sprintf(&message[398],"%-10s\n",Ext10_DFld.NOTIFICATION_STATUS);
}
void faisnd_build_request_ext10_field_20( )
{
	memset(Ext10_DFld.SCORE1,' ',4);
	sprintf(&message[408],"%-4s\n",Ext10_DFld.SCORE1);
}
void faisnd_build_request_ext10_field_21( )
{
	memset(Ext10_DFld.SCORE2,' ',4);
	sprintf(&message[412],"%-4s\n",Ext10_DFld.SCORE2);
}
void faisnd_build_request_ext10_field_22( )
{
	memset(Ext10_DFld.SCORE3,' ',4);
	sprintf(&message[416],"%-4s\n",Ext10_DFld.SCORE3);
}
void faisnd_build_request_ext10_field_23( )
{
	char rc_code[3] = {0};
	INT DE39 = 0;

	memset(Ext10_DFld.USER_DATA_01_STRG,' ',4);
	strncpy(rc_code, Auth_Tx.TLF01_details.response_code, 2);
	DE39 = atoi(rc_code);
	...
	switch(DE39)
	{
		...
		case 32:
		case 85:
			strncpy(Ext10_DFld.USER_DATA_01_STRG,"A",1);
			break;
		...
		case 82:
		case 92:
			strncpy(Ext10_DFld.USER_DATA_01_STRG,"D",1);
			break;
		...
		case 41:
		case 43:
			strncpy(Ext10_DFld.USER_DATA_01_STRG,"P",1);
			break;
		...
		case 66:
		case 75:
			strncpy(Ext10_DFld.USER_DATA_01_STRG,"R",1);
			break;

		default:
			strncpy(Ext10_DFld.USER_DATA_01_STRG," ",1);

	}

	if (0 == strncmp(Auth_Tx.TLF01_details.response_code, "N7", 2))
	{
		strncpy(Ext10_DFld.USER_DATA_01_STRG,"D",1);
	}
	sprintf(&message[420],"%-4s\n",Ext10_DFld.USER_DATA_01_STRG);

}
void faisnd_build_request_ext10_field_24( )
{
	memset(Ext10_DFld.USER_DATA_02_STRG,' ',4);
	...
	if(faisnd_is_Issuing_Transaction()== true)
	{
		if(faisnd_Is_Advice_or_Reversal_Transaction() == true)
		{
			if(true == Check_If_AMEX_Transaction())
			{
				...
				memcpy(Ext10_DFld.USER_DATA_02_STRG, Auth_Tx.TLF01_details.product_codes[12].code,3);
			}
			...
			else if( true == Check_If_CUP_Transaction() )
			{
				...
				memcpy(Ext10_DFld.USER_DATA_02_STRG,Auth_Tx.TLF01_details.product_codes[13].quantity,2);
		...
		{
			memcpy(Ext10_DFld.USER_DATA_02_STRG,Auth_Tx.TLF01_details.response_code,2);
		}
	}
	else
	{
	...
	sprintf(&message[424],"%-4s\n",Ext10_DFld.USER_DATA_02_STRG);

}
void faisnd_build_request_ext10_field_25( )
{
	memset(Ext10_DFld.USER_DATA_03_STRG,' ',4);
	sprintf(&message[428],"%-4s\n",Ext10_DFld.USER_DATA_03_STRG);
}
void faisnd_build_request_ext10_field_26( )
{
	memset(Ext10_DFld.USER_DATA_04_STRG,' ',4);
	sprintf(&message[432],"%-4s\n",Ext10_DFld.USER_DATA_04_STRG);
}
void faisnd_build_request_ext10_field_27( )
{
	memset(Ext10_DFld.USER_DATA_05_STRG,' ',4);
	sprintf(&message[436],"%-4s\n",Ext10_DFld.USER_DATA_05_STRG);
}
void faisnd_build_request_ext10_field_28( )
{
	memset(Ext10_DFld.USER_DATA_06_STRG,' ',8);
	sprintf(&message[440],"%-8s\n",Ext10_DFld.USER_DATA_06_STRG);
}
void faisnd_build_request_ext10_field_29( )
{
	memset(Ext10_DFld.USER_DATA_07_STRG,' ',8);
	sprintf(&message[448],"%-8s\n",Ext10_DFld.USER_DATA_07_STRG);
}
void faisnd_build_request_ext10_field_30( )
{
	memset(Ext10_DFld.USER_DATA_08_STRG,' ',8);
	sprintf(&message[456],"%-8s\n",Ext10_DFld.USER_DATA_08_STRG);
}
void faisnd_build_request_ext10_field_31( )
{
	memset(Ext10_DFld.USER_DATA_09_STRG,' ',8);
	sprintf(&message[464],"%-8s\n",Ext10_DFld.USER_DATA_09_STRG);
}
void faisnd_build_request_ext10_field_32( )
{
	memset(Ext10_DFld.USER_DATA_10_STRG,' ',8);
	sprintf(&message[472],"%-8s\n",Ext10_DFld.USER_DATA_10_STRG);
}
void faisnd_build_request_ext10_field_33( )
{
	memset(Ext10_DFld.USER_DATA_11_STRG,' ',8);
	strncpy(Ext10_DFld.USER_DATA_11_STRG, "608", 3);
	sprintf(&message[480],"%-8s\n",Ext10_DFld.USER_DATA_11_STRG);
}
void faisnd_build_request_ext10_field_34( )
{
	memset(Ext10_DFld.USER_DATA_12_STRG,' ',16);
	memcpy(Ext10_DFld.USER_DATA_12_STRG, Cr_Fld_RT.TRANSACTION_AMT, 13);
	sprintf(&message[488],"%-16s\n",Ext10_DFld.USER_DATA_12_STRG);

}
void faisnd_build_request_ext10_field_35( )
{
	memset(Ext10_DFld.USER_DATA_13_STRG,' ',16);
	sprintf(&message[504],"%-16s\n",Ext10_DFld.USER_DATA_13_STRG);
}
void faisnd_build_request_ext10_field_36( )
{
	memset(Ext10_DFld.USER_DATA_14_STRG,' ',16);
	sprintf(&message[520],"%-16s\n",Ext10_DFld.USER_DATA_14_STRG);
}
void faisnd_build_request_ext10_field_37( )
{
	memset(Ext10_DFld.USER_DATA_15_STRG,' ',16);
	sprintf(&message[536],"%-16s\n",Ext10_DFld.USER_DATA_15_STRG);
}
void faisnd_build_request_ext10_field_38( )
{
	memset(Ext10_DFld.USER_DATA_16_STRG,' ',16);
	sprintf(&message[552],"%-16s\n",Ext10_DFld.USER_DATA_16_STRG);
}
void faisnd_build_request_ext10_field_39( )
{
	memset(Ext10_DFld.USER_DATA_17_STRG,' ',16);
	sprintf(&message[568],"%-16s\n",Ext10_DFld.USER_DATA_17_STRG);
}
void faisnd_build_request_ext10_field_40( )
{
	memset(Ext10_DFld.USER_DATA_18_STRG,' ',32);
	sprintf(&message[584],"%-32s\n",Ext10_DFld.USER_DATA_18_STRG);
}
void faisnd_build_request_ext10_field_41( )
{
	memset(Ext10_DFld.USER_DATA_19_STRG,' ',32);
	memcpy(Ext10_DFld.USER_DATA_19_STRG, Ext10_DFld.EXTERNAL_TRANSACTION_XID, 32);
	sprintf(&message[616],"%-32s\n",Ext10_DFld.USER_DATA_19_STRG);
}
void faisnd_build_request_ext10_field_42( )
{
	memset(Ext10_DFld.USER_DATA_20_STRG,' ',32);
	sprintf(&message[648],"%-32s\n",Ext10_DFld.USER_DATA_20_STRG);
}
void faisnd_build_request_ext10_field_43( )
{
	memset(Ext10_DFld.USER_DATA_21_STRG,' ',32);
	sprintf(&message[680],"%-32s\n",Ext10_DFld.USER_DATA_21_STRG);
}
void faisnd_build_request_ext10_field_44( )
{
	memset(Ext10_DFld.USER_DATA_22_STRG,' ',32);
	sprintf(&message[712],"%-32s\n",Ext10_DFld.USER_DATA_22_STRG);
}
void faisnd_build_request_ext10_field_45( )
{
	memset(Ext10_DFld.USER_DATA_23_STRG,' ',32);
	sprintf(&message[744],"%-32s\n",Ext10_DFld.USER_DATA_23_STRG);
}
void faisnd_build_request_ext10_field_46( )
{
	memset(Ext10_DFld.USER_DATA_24_STRG,' ',32);
	sprintf(&message[776],"%-32s\n",Ext10_DFld.USER_DATA_24_STRG);
}
void faisnd_build_request_ext10_field_47( )
{
	memset(Ext10_DFld.USER_DATA_25_STRG,' ',32);
	sprintf(&message[808],"%-32s\n",Ext10_DFld.USER_DATA_25_STRG);
}
void faisnd_build_request_ext10_field_48( )
{
	memset(Ext10_DFld.USER_DATA_26_STRG,' ',32);
	sprintf(&message[840],"%-32s\n",Ext10_DFld.USER_DATA_26_STRG);
}
void faisnd_build_request_ext10_field_49( )
{
	memset(Ext10_DFld.USER_DATA_27_STRG,' ',32);
	sprintf(&message[872],"%-32s\n",Ext10_DFld.USER_DATA_27_STRG);
}

void faisnd_build_request_ext10_field_50( )
{
	memset(Ext10_DFld.USER_DATA_28_STRG,' ',64);
	sprintf(&message[904],"%-64s\n",Ext10_DFld.USER_DATA_28_STRG);
}

void faisnd_build_request_ext10_field_51( )
{
	memset(Ext10_DFld.USER_DATA_29_STRG,' ',64);
	sprintf(&message[968],"%-64s\n",Ext10_DFld.USER_DATA_29_STRG);
}

void faisnd_build_request_ext10_field_52( )
{
	memset(Ext10_DFld.USER_DATA_30_STRG,' ',64);
	sprintf(&message[1032],"%-64s\n",Ext10_DFld.USER_DATA_30_STRG);
}

void faisnd_build_request_ext10_field_53( )
{
	memset(Ext10_DFld.USER_DATA_31_STRG,' ',64);
	sprintf(&message[1096],"%-64s\n",Ext10_DFld.USER_DATA_31_STRG);
}

void faisnd_build_request_ext10_field_54( )
{
	memset(Ext10_DFld.USER_DATA_32_STRG,' ',64);
	sprintf(&message[1160],"%-64s\n",Ext10_DFld.USER_DATA_32_STRG);
}

void faisnd_build_request_ext10_field_55( )
{
	memset(Ext10_DFld.USER_DATA_33_STRG,' ',255);
	sprintf(&message[1224],"%-255s\n",Ext10_DFld.USER_DATA_33_STRG);
}

void faisnd_build_request_ext10_field_56( )
{
	memset(Ext10_DFld.USER_DATA_34_STRG,' ',255);
	sprintf(&message[1479],"%-255s",Ext10_DFld.USER_DATA_34_STRG);
}

INT faisnd_check_if_trx_is_bdo_pos_acq_trx(   )
{
	 if((0 == strncmp(Auth_Tx.TLF01_details.handler_queue,
...
INT faisnd_check_if_PEM_is_MobilePOS_NFC_Tap2Phone_trx(    )
{
	 if(0 == strncmp(Auth_Tx.TLF01_details.pos_entry_mode,
			 	 	 POS_MOBILE_NFC_TAP2PHONE_TXN,
					 POS_ENTRY_MODE_LEN))
	{
		return (true);
	}
...
INT faisnd_check_if_trx_qualify_for_MobilePOS_NFC_Tap2Phone_trx (    )
{
...
INT faisnd_check_if_trx_is_acq_MobilePOS_NFC_Tap2Phone_trx( )
{
	if((true == faisnd_check_if_PEM_is_MobilePOS_NFC_Tap2Phone_trx()) &&
	   (true == faisnd_check_if_trx_is_bdo_pos_acq_trx())&&
	   (true == faisnd_check_if_trx_qualify_for_MobilePOS_NFC_Tap2Phone_trx()))
	{
		return (true);
	}
	else
...
INT faisnd_check_if_PEM_is_Swiftpass_BDO_Pay_credit_trx( )
{
	 if(0 == strncmp(Auth_Tx.TLF01_details.pos_entry_mode,
			 	 	 POS_SWIFTPASS_BDO_PAY_CREDIT_TXN_WITH_TXN,
					 POS_ENTRY_MODE_LEN))
	{
		return (true);
	}
...
INT faisnd_check_if_trx_qualify_for_Swiftpass_BDO_Pay_credit_trx ( )
{
	if((0 == strncmp(Auth_Tx.TLF01_details.message_type,
			 	 	 POS_ACQ_SALE_MESSAGE_TYPE,
					 ISO_MESSAGE_TYPE_LEN))||
...
INT faisnd_check_if_trx_is_acq_Swiftpass_BDO_Pay_credit_trx( )
{
	if((true == faisnd_check_if_PEM_is_Swiftpass_BDO_Pay_credit_trx()) &&
	   (true == faisnd_check_if_trx_is_bdo_pos_acq_trx())&&
	   (true == faisnd_check_if_trx_qualify_for_Swiftpass_BDO_Pay_credit_trx()))
	{
		return (true);
	}
	else
