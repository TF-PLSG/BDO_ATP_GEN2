...
/******************************************************************************
     ...
     $Log:   N:\POS\PVCS6.6\EPICPORTZ\PTE\Equitable\App_lib\util_dbstruct.h  $
   
   initial release
******************************************************************************/

#ifndef UTIL_DBSTRUCT_H
#define UTIL_DBSTRUCT_H
...
typedef struct
{
	   BYTE  merch_id				[15];
	   BYTE  system_date			[8];
	   BYTE  total_amount			[12];
		BYTE total_transcn_cnt		[12];
		BYTE total_aprvd_amount		[12];
		BYTE total_reversed_amount	[12];
		BYTE total_aprvd_transcn_count		[12];
		BYTE total_reversed_transcn_count	[12];
		BYTE field_1				[12];
		BYTE field_2				[12];
		BYTE field_3				[12];
		BYTE field_4				[12];
