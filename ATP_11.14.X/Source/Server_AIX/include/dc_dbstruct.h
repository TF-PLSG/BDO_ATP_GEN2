...
/*Merchnat integerity parameters*/
typedef struct
{
	BYTE merchant_id[16];
	BYTE card_nbr[20];
...
}MERCHANT_INTEGRITY_PARAM,*pMERCHANT_INTEGRITY_PARAM;
/* device control file */
typedef struct
{
   struct
...
/* batch header file For MP/Installpay/Fleet  */
typedef struct
{
   struct
   {
...
{
   BYTE  num_returned     [5];
   BCH01_MP batch_record     [GUI_MAX_LIST_SIZE];
}BCH01_MP_GUI_LIST, *pBCH01_MP_GUI_LIST;
...
{
   BYTE  num_returned     [5];
   BCH01_MP batch_list       [SCH_MAX_LIST_SIZE];
}BCH01_MP_LIST, *pBCH01_MP_LIST;
...
typedef struct
{
   ...
   BYTE  open_date                                 [10];
   BYTE  open_time                                 [7];
   BYTE  release_date                              [10];
   BYTE  release_time                              [7];
   BYTE  batch_status                              [2];      /*R-released;C-closed;A-active*/
   BYTE  visa_merchant_id                          [16];
   BYTE  purge_date								   [9];
}ARCHIVE_BCH01, *pARCHIVE_BCH01;
...
typedef struct
{
   ...
   BYTE term                                       [4];
   BYTE purge_date									[9];
}ARCHIVE_BCH20, *pARCHIVE_BCH20;

typedef struct
{
   BYTE  num_returned     [5];
   ARCHIVE_BCH01 batch_record     [ARCH_GUI_MAX_LIST_SIZE];
}ARCHIVE_BCH01_GUI_LIST, *pARCHIVE_BCH01_GUI_LIST;

typedef struct
{
   BYTE  num_returned     [5];
   ARCHIVE_BCH10 batch_record       [ARCH_GUI_MAX_LIST_SIZE];
}ARCHIVE_BCH10_GUI_LIST, *pARCHIVE_BCH10_GUI_LIST;

typedef struct
{
   BYTE  num_returned     [5];
   ARCHIVE_BCH11 batch_list       [ARCH_GUI_MAX_LIST_SIZE];
}ARCHIVE_BCH11_GUI_LIST, *pARCHIVE_BCH11_GUI_LIST;

typedef struct
{
   BYTE  num_returned     [5];
   ARCHIVE_BCH20 batch_list       [ARCH_GUI_MAX_LIST_SIZE];
}ARCHIVE_BCH20_GUI_LIST, *pARCHIVE_BCH20_GUI_LIST;

typedef struct
{
   BYTE  num_returned     [5];
   ARCHIVE_BCH10 batch_list       [BATCH_SERVICE_LIST_SIZE];
}ARCHIVE_BCH10_LIST, *pARCHIVE_BCH10_LIST;


typedef struct
{
   BYTE  num_returned     [5];
   ARCHIVE_BCH11 batch_list       [BATCH_SERVICE_LIST_SIZE];
}ARCHIVE_BCH11_LIST, *pARCHIVE_BCH11_LIST;

typedef struct
{
   BYTE  num_returned     [5];
   ARCHIVE_BCH01 batch_list       [SCH_MAX_LIST_SIZE];
}ARCHIVE_BCH01_LIST, *pARCHIVE_BCH01_LIST;
