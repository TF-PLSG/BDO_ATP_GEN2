/******************************************************************************
   ...
   $Log:   N:\POS\PVCS6.6\EPICPORTZ\PTE\Equitable\App_lib\dc_database.h  $
   
      Rev 1.22   May 03 2006 17:32:18   dirby
   Added prototype to select emv raw data for reversals/voids.
   SCR 21042
   
      Rev 1.21   Oct 01 2004 11:57:24   dirby
   Added function prototype for db_select_tlf01_for_void_reload.
   SCR 12626
   
      Rev 1.20   Mar 04 2004 18:31:42   dirby
   Added function prototype to look for duplicate transactions.
   SCR 1222
   
      Rev 1.19   Mar 12 2003 17:16:04   dirby
   Added function prototype for db_select_tlf01_for_visa_rejects.
   SCR 1034
   
      Rev 1.18   Jun 13 2001 13:49:18   dirby
   Reverted back to revision 1.16.  Revision 1.17 contains
   Base product stuff not used in current Equitable.
   
      Rev 1.17   Dec 04 2000 14:29:28   apinto
   Added Function Prototypes for the following table for the new
   product = Equitable +RealPay :
   
   PCID , UCF03, UCF03L <-- A.Pinto.
   
      Rev 1.16   Jul 31 2000 16:42:48   dirby
   Added function prototype for select_tlf01_by_auth_term_num.
   
      Rev 1.15   Jan 18 2000 16:35:32   ddabberu
   removed c++ style comments
   
      Rev 1.14   Jan 12 2000 13:28:32   sdasgupt
...
//BYTE db_select_caf01_for_keyblock (pCHAR, pCAF01, pCHAR); //Added by Leela
...
BYTE db_delete_tlf01_by_standin(pTLF01, pCHAR); /* ThoughtFocus Girija Y*/
...
BYTE db_select_tlf01_for_visa_rejects (pTLF01,pTLF01,pCHAR );
...
BYTE db_select_tlf01_by_original_tran (pTLF01,pTLF01,pCHAR );
BYTE db_select_tlf01_for_void_reload  (pTLF01,pTLF01,pCHAR );
BYTE db_select_tlf01_last_auth_nbr    (pTLF01,pTLF01,pCHAR );
...
BYTE db_select_mcf01_CUP(pCHAR, pMCF01, pCHAR);
...
BYTE db_select_dcf01_CUP(pCHAR, pDCF01, pCHAR);    
...
BYTE db_select_RPS01_for_VISA (pAUTH_TX auth_tx, pRPS01,pCHAR ErrorMsg);
...
BYTE db_select_bch10_duplicate_txn (pBCH10,pBCH10,pCHAR );
...
BYTE db_select_bch10_detail_by_batch_tid_stan(pCHAR ,pCHAR ,pCHAR,pCHAR,pBCH01,pCHAR);
BYTE db_select_bch10_by_auth_nbr (pBCH10, pBCH10, pCHAR );
BYTE db_select_bch10_by_original_transaction (pBCH10, pBCH10, pCHAR );
BYTE db_select_emvraw( pCHAR Primary_key, pEMV_RAW emvraw_ptr, pCHAR ErrorMsg );
