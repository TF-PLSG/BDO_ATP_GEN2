...
void CheckNULLTerminatedinFCLF01(pFCLF01 fclf01,pCHAR mode);
void CheckNULLTerminatedinFRULE01(pFRULE01 frule01,pCHAR mode);


void CheckNULLTerminatedinFCLF01(pFCLF01 fclf01,pCHAR mode)
{
	checknull(fclf01->network_id    			,sizeof(fclf01->network_id),"FCLF01","network_id","CheckNULLTerminatedinFCLF01",mode);
	checknull(fclf01->fraud_control_enable_flag              ,sizeof(fclf01->fraud_control_enable_flag),"FCLF01","fraud_control_enable_flag","CheckNULLTerminatedinFCLF01",mode);
	checknull(fclf01->fraud_rule_enable_flag         ,sizeof(fclf01->fraud_rule_enable_flag),"FCLF01","fraud_rule_enable_flag","CheckNULLTerminatedinFCLF01",mode);
	checknull(fclf01->fai_threshold_time        ,sizeof(fclf01->fai_threshold_time),"FCLF01","fai_threshold_time","CheckNULLTerminatedinFCLF01",mode);
...
void CheckNULLTerminatedinFRULE01(pFRULE01 frule01,pCHAR mode)
{
	checknull(frule01->fraud_rule		 ,sizeof(frule01->fraud_rule),"FRULE01","fraud_rule","CheckNULLTerminatedinFRULE01",mode);
	checknull(frule01->card_brand        ,sizeof(frule01->card_brand),"FRULE01","card_brand","CheckNULLTerminatedinFRULE01",mode);
	checknull(frule01->acq_country_code  ,sizeof(frule01->acq_country_code),"FRULE01","acq_country_code","CheckNULLTerminatedinFRULE01",mode);
	checknull(frule01->billing_amt       ,sizeof(frule01->billing_amt),"FRULE01","billing_amt","CheckNULLTerminatedinFRULE01",mode);
	checknull(frule01->pos_mode_1        ,sizeof(frule01->pos_mode_1),"FRULE01","pos_mode_1","CheckNULLTerminatedinFRULE01",mode);
	checknull(frule01->pos_mode_2        ,sizeof(frule01->pos_mode_2),"FRULE01","pos_mode_2","CheckNULLTerminatedinFRULE01",mode);
	checknull(frule01->pos_mode_3        ,sizeof(frule01->pos_mode_3),"FRULE01","pos_mode_3","CheckNULLTerminatedinFRULE01",mode);
	checknull(frule01->mcc_1             ,sizeof(frule01->mcc_1),"FRULE01","mcc_1","CheckNULLTerminatedinFRULE01",mode);
	checknull(frule01->mcc_2             ,sizeof(frule01->mcc_2),"FRULE01","mcc_2","CheckNULLTerminatedinFRULE01",mode);
	checknull(frule01->mcc_3             ,sizeof(frule01->mcc_3),"FRULE01","mcc_3","CheckNULLTerminatedinFRULE01",mode);
}

void CheckNULLTerminatedinFTLF01(pFTLF01 ftlf01,pCHAR mode)
{
	checknull(ftlf01->tran_id		  	,sizeof(ftlf01->tran_id),"FTLF01","tran_id","CheckNULLTerminatedinFTLF01",mode);
	checknull(ftlf01->sys_date        	,sizeof(ftlf01->sys_date),"FTLF01","sys_date","CheckNULLTerminatedinFTLF01",mode);
	checknull(ftlf01->card_brand      	,sizeof(ftlf01->card_brand),"FTLF01","card_brand","CheckNULLTerminatedinFTLF01",mode);
	checknull(ftlf01->handler_queue     ,sizeof(ftlf01->handler_queue),"FTLF01","handler_queue","CheckNULLTerminatedinFTLF01",mode);
	checknull(ftlf01->tran_req_sent_time        ,sizeof(ftlf01->tran_req_sent_time),"FTLF01","tran_req_sent_time","CheckNULLTerminatedinFTLF01",mode);
	checknull(ftlf01->tran_resp_recv_time       ,sizeof(ftlf01->tran_resp_recv_time),"FTLF01","tran_resp_recv_time","CheckNULLTerminatedinFTLF01",mode);
	checknull(ftlf01->tran_req_sent_mode        ,sizeof(ftlf01->tran_req_sent_mode),"FTLF01","tran_req_sent_mode","CheckNULLTerminatedinFTLF01",mode);
	checknull(ftlf01->tran_resp_recv_mode       ,sizeof(ftlf01->tran_resp_recv_mode),"FTLF01","tran_resp_recv_mode","CheckNULLTerminatedinFTLF01",mode);
	checknull(ftlf01->response_text             ,sizeof(ftlf01->response_text),"FTLF01","response_text","CheckNULLTerminatedinFTLF01",mode);
	checknull(ftlf01->decision_code_1_value             ,sizeof(ftlf01->decision_code_1_value),"FTLF01","decision_code_1_value","CheckNULLTerminatedinFTLF01",mode);
	checknull(ftlf01->decision_code_2_value             ,sizeof(ftlf01->decision_code_2_value),"FTLF01","decision_code_2_value","CheckNULLTerminatedinFTLF01",mode);
	checknull(ftlf01->decision_code_3_value             ,sizeof(ftlf01->decision_code_3_value),"FTLF01","decision_code_3_value","CheckNULLTerminatedinFTLF01",mode);
	checknull(ftlf01->decision_code_4_value             ,sizeof(ftlf01->decision_code_4_value),"FTLF01","decision_code_4_value","CheckNULLTerminatedinFTLF01",mode);
	checknull(ftlf01->decision_code_5_value             ,sizeof(ftlf01->decision_code_5_value),"FTLF01","decision_code_5_value","CheckNULLTerminatedinFTLF01",mode);
	checknull(ftlf01->decision_code_6_value             ,sizeof(ftlf01->decision_code_6_value),"FTLF01","decision_code_6_value","CheckNULLTerminatedinFTLF01",mode);
	checknull(ftlf01->decision_code_7_value             ,sizeof(ftlf01->decision_code_7_value),"FTLF01","decision_code_7_value","CheckNULLTerminatedinFTLF01",mode);
	checknull(ftlf01->decision_code_8_value             ,sizeof(ftlf01->decision_code_8_value),"FTLF01","decision_code_8_value","CheckNULLTerminatedinFTLF01",mode);
	checknull(ftlf01->decision_code_9_value             ,sizeof(ftlf01->decision_code_9_value),"FTLF01","decision_code_9_value","CheckNULLTerminatedinFTLF01",mode);
	checknull(ftlf01->decision_code_10_value            ,sizeof(ftlf01->decision_code_10_value),"FTLF01","decision_code_10_value","CheckNULLTerminatedinFTLF01",mode);
	checknull(ftlf01->future_field1             				,sizeof(ftlf01->future_field1),"FTLF01","future_field1","CheckNULLTerminatedinFTLF01",mode);
	checknull(ftlf01->future_field2             				,sizeof(ftlf01->future_field2),"FTLF01","future_field2","CheckNULLTerminatedinFTLF01",mode);
	checknull(ftlf01->future_field3             				,sizeof(ftlf01->future_field3),"FTLF01","future_field3","CheckNULLTerminatedinFTLF01",mode);
	checknull(ftlf01->future_field4             				,sizeof(ftlf01->future_field4),"FTLF01","future_field4","CheckNULLTerminatedinFTLF01",mode);
	checknull(ftlf01->future_field5             				,sizeof(ftlf01->future_field5),"FTLF01","future_field5","CheckNULLTerminatedinFTLF01",mode);
