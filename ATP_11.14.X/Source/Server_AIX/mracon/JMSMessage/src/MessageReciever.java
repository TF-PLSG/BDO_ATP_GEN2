				...
				while (msgConsumer.receiveNoWait() != null) {
					...
					if (msg instanceof TextMessage) {
						...
						if (responseMsg != null) {
							...
							mraconHandler.receiveResponseMsg(responseMsg.toString());
						}
					}
				}
				if (!isanyMessages) {
					...
					if (MsgSenderThread.logsCreate == true && logsenalble == true) {
						logger.info("There are no response messages inside JMS Queue this transaction processing in ONLINE mode......!!!");		
