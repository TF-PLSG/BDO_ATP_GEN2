...
Function:      ncdci_init_character_code_maps
...
Return values:
               None
******************************************************************************/
void ncdci_init_character_code_maps()
{
   // ascii to ebcdic map
...
/*************************************************************************************
       NAME:               ncdci_convert_int_to_ascii
...
*************************************************************************************/
void ncdci_convert_int_to_ascii( pBYTE source, pBYTE dest, INT len )
{
   INT  temp = 0;
   BYTE temp_byte = 0;
...
void ncdci_convert_to_ascii( pBYTE source, pBYTE dest, INT len )
{
   ...
   return;
} /* ncdci_convert_to_ascii */



/*************************************************************************************
       NAME:               ncdci_convert_to_ebcdic
...
void ncdci_convert_to_ebcdic( pBYTE source, pBYTE dest, INT len )
{
   ...
   return;
} /* ncdci_convert_to_ebcdic */

/*****************************************************************************/
/******************************************************************************
 *
 *  NAME:         ncdci_hex_to_ebcdic
 *
 ...
 *
 ******************************************************************************/
void ncdci_hex_to_ebcdic( pBYTE instr, pBYTE outstr, INT len )
{
   INT   i = 0;
   INT   j = 0;
   INT   outstr_idx = 0;
    ...
    */
   ncdci_convert_to_ebcdic( outstr, outstr, len*2 );
 ...
 *
 ******************************************************************************/
void ncdci_ebcdic_to_hex( pBYTE instr, pBYTE outstr, INT len )
{
   #define  MAX_LEN 100
   ...
   ncdci_convert_to_ascii( instr, temp_str, len );
...
******************************************************************************/
 void ncdci_asc_to_bcd (afield, how_many, bstring)
   pCHAR         afield;
   INT           how_many;
   BYTE          bstring[];
{  
...
/*****************************************************************************
  ...
  Modified by:
******************************************************************************/
void ncdci_bcd_to_asc (bstring, blen, astr, astr_len)
