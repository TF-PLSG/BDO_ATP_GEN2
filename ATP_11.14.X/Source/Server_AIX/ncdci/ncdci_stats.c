 ...
 * All Rights Reserved.
 *
 * MODULE:      ncdci_stats.c
 *  
 * TITLE:       ncdci Network Controller Statistics Processor
 *  
...
/******************************************************************************
 *
 *  NAME:         ncdci_send_transaction_statistics
 *
 ...
 *  MODIFICATIONS:
 ******************************************************************************/
INT ncdci_send_transaction_statistics( pPTE_MSG p_msg )
{
   INT   ret_code = false;
   ...
   ret_code = ncdci_build_and_send_request_message( MT_GET_STATS_RESPONSE, 
                                              ST1_NONE,
                                              ST2_NONE,
                                              originator_queue, 
                                              (pBYTE)&Monitor_Stats,
   ...
   if ( false == ret_code  )
   {
      ncdci_log_message( 2, 2, err_msg, "ncdci_send_transaction_statistics", 0 );
   }
   return( ret_code );
}
 ...
 *  MODIFICATIONS:
 ******************************************************************************/
INT ncdci_reset_transaction_statistics( pPTE_MSG p_msg )
{
   INT   ret_code = false;
   BYTE  originator_queue[17] = {0};
   BYTE  originator_info[33] = {0};
   ...
   if ( false == ret_code  )
   {
      ncdci_log_message( 2, 2, err_msg, "ncdci_reset_transaction_statistics", 0 );
   }
   return( ret_code );
}
