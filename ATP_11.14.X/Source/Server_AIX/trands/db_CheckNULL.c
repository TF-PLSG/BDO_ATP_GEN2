...
void CheckNULLTerminatedinKEY3DS01(pKEY3DS01   key3ds01,pCHAR mode);
...
void CheckNULLTerminatedinCR01(pCR01 cr01,pCHAR mode);
...
void CheckNULLTerminatedinJCB3DS2(pJCB3DS2   jcb3ds2,pCHAR mode);
...
void CheckNULLTerminatedinCR01(pCR01 cr01,pCHAR mode)
{
checknull(cr01->rule_id,sizeof(cr01->rule_id),"CR01","Rule ID","CheckNULLTerminatedinCR01",mode);
checknull(cr01->rulename,sizeof(cr01->rulename) ,"CR01","Rule Name", "CheckNULLTerminatedinCR01",mode);
checknull(cr01->status,sizeof(cr01->status   )  ,"CR01"	,"Rule Status","CheckNULLTerminatedinCR01",mode);
checknull(cr01->rule_processing,sizeof(cr01->rule_processing ),"CR01","Rule processing", "CheckNULLTerminatedinCR01",mode);
checknull(cr01->single_amtlimit,sizeof(cr01->single_amtlimit),"CR01","Single Amount Limit",	"CheckNULLTerminatedinCR01",mode);
checknull(cr01->acc_amtlimit,sizeof(cr01->acc_amtlimit),"CR01","Accumulated Amount Limit","CheckNULLTerminatedinCR01",mode);
checknull(cr01->acc_transactionlimit,sizeof(cr01->acc_transactionlimit),"CR01","Accumulated Transaction Limit Counter","CheckNULLTerminatedinCR01",mode);
checknull(cr01->acc_amtlimit_counter,sizeof(cr01->acc_amtlimit_counter),"CR01","Accumulated Amount Limit Counter","CheckNULLTerminatedinCR01",mode);
checknull(cr01->acc_transactionlimit_counter,sizeof(cr01->acc_transactionlimit_counter),"CR01","Accumulated Transaction Limit","CheckNULLTerminatedinCR01",mode);
checknull(cr01->rule_bin_high,sizeof(cr01->rule_bin_high),"CR01","Rule Bin Low","CheckNULLTerminatedinCR01",mode);
checknull(cr01->rule_bin_low,sizeof(cr01->rule_bin_low),"CR01","Rule Bin High","CheckNULLTerminatedinCR01",mode);
checknull(cr01->response_code,sizeof(cr01->response_code),"CR01","Response code","CheckNULLTerminatedinCR01",mode);
checknull(cr01->cardnum_blocking[0].exception_cardnum,sizeof(cr01->cardnum_blocking[0].exception_cardnum),"CR01","cardnum_blocking[0].exception_cardnum","CheckNULLTerminatedinCR01",mode);
checknull(cr01->cardnum_blocking[1].exception_cardnum,sizeof(cr01->cardnum_blocking[1].exception_cardnum),"CR01","cardnum_blocking[1].exception_cardnum","CheckNULLTerminatedinCR01",mode);
checknull(cr01->cardnum_blocking[2].exception_cardnum,sizeof(cr01->cardnum_blocking[2].exception_cardnum),"CR01","cardnum_blocking[2].exception_cardnum","CheckNULLTerminatedinCR01",mode);
checknull(cr01->cardnum_blocking[3].exception_cardnum,sizeof(cr01->cardnum_blocking[3].exception_cardnum),"CR01","cardnum_blocking[3].exception_cardnum","CheckNULLTerminatedinCR01",mode);
checknull(cr01->cardnum_blocking[4].exception_cardnum,sizeof(cr01->cardnum_blocking[4].exception_cardnum),"CR01","cardnum_blocking[4].exception_cardnum","CheckNULLTerminatedinCR01",mode);
checknull(cr01->cardnum_blocking[5].exception_cardnum,sizeof(cr01->cardnum_blocking[5].exception_cardnum),"CR01","cardnum_blocking[5].exception_cardnum","CheckNULLTerminatedinCR01",mode);
checknull(cr01->cardnum_blocking[6].exception_cardnum,sizeof(cr01->cardnum_blocking[6].exception_cardnum),"CR01","cardnum_blocking[6].exception_cardnum","CheckNULLTerminatedinCR01",mode);
checknull(cr01->cardnum_blocking[7].exception_cardnum,sizeof(cr01->cardnum_blocking[7].exception_cardnum),"CR01","cardnum_blocking[7].exception_cardnum","CheckNULLTerminatedinCR01",mode);
checknull(cr01->cardnum_blocking[8].exception_cardnum,sizeof(cr01->cardnum_blocking[8].exception_cardnum),"CR01","cardnum_blocking[8].exception_cardnum","CheckNULLTerminatedinCR01",mode);
checknull(cr01->cardnum_blocking[9].exception_cardnum,sizeof(cr01->cardnum_blocking[9].exception_cardnum),"CR01","cardnum_blocking[9].exception_cardnum","CheckNULLTerminatedinCR01",mode);
checknull(cr01->cardnum_blocking[10].exception_cardnum,sizeof(cr01->cardnum_blocking[10].exception_cardnum),"CR01","cardnum_blocking[10].exception_cardnum","CheckNULLTerminatedinCR01",mode);
checknull(cr01->cardnum_blocking[11].exception_cardnum,sizeof(cr01->cardnum_blocking[11].exception_cardnum),"CR01","cardnum_blocking[11].exception_cardnum","CheckNULLTerminatedinCR01",mode);
checknull(cr01->cardnum_blocking[12].exception_cardnum,sizeof(cr01->cardnum_blocking[12].exception_cardnum),"CR01","cardnum_blocking[12].exception_cardnum","CheckNULLTerminatedinCR01",mode);
checknull(cr01->cardnum_blocking[13].exception_cardnum,sizeof(cr01->cardnum_blocking[13].exception_cardnum),"CR01","cardnum_blocking[13].exception_cardnum","CheckNULLTerminatedinCR01",mode);
checknull(cr01->cardnum_blocking[14].exception_cardnum,sizeof(cr01->cardnum_blocking[14].exception_cardnum),"CR01","cardnum_blocking[14].exception_cardnum","CheckNULLTerminatedinCR01",mode);
checknull(cr01->cardnum_blocking[15].exception_cardnum,sizeof(cr01->cardnum_blocking[15].exception_cardnum),"CR01","cardnum_blocking[15].exception_cardnum","CheckNULLTerminatedinCR01",mode);
checknull(cr01->cardnum_blocking[16].exception_cardnum,sizeof(cr01->cardnum_blocking[16].exception_cardnum),"CR01","cardnum_blocking[16].exception_cardnum","CheckNULLTerminatedinCR01",mode);
checknull(cr01->cardnum_blocking[17].exception_cardnum,sizeof(cr01->cardnum_blocking[17].exception_cardnum),"CR01","cardnum_blocking[17].exception_cardnum","CheckNULLTerminatedinCR01",mode);
checknull(cr01->cardnum_blocking[18].exception_cardnum,sizeof(cr01->cardnum_blocking[18].exception_cardnum),"CR01","cardnum_blocking[18].exception_cardnum","CheckNULLTerminatedinCR01",mode);
checknull(cr01->cardnum_blocking[19].exception_cardnum,sizeof(cr01->cardnum_blocking[19].exception_cardnum),"CR01","cardnum_blocking[19].exception_cardnum","CheckNULLTerminatedinCR01",mode);
checknull(cr01->cardnum_blocking[20].exception_cardnum,sizeof(cr01->cardnum_blocking[20].exception_cardnum),"CR01","cardnum_blocking[20].exception_cardnum","CheckNULLTerminatedinCR01",mode);
checknull(cr01->cardnum_blocking[21].exception_cardnum,sizeof(cr01->cardnum_blocking[21].exception_cardnum),"CR01","cardnum_blocking[21].exception_cardnum","CheckNULLTerminatedinCR01",mode);
checknull(cr01->cardnum_blocking[22].exception_cardnum,sizeof(cr01->cardnum_blocking[22].exception_cardnum),"CR01","cardnum_blocking[22].exception_cardnum","CheckNULLTerminatedinCR01",mode);
checknull(cr01->cardnum_blocking[23].exception_cardnum,sizeof(cr01->cardnum_blocking[23].exception_cardnum),"CR01","cardnum_blocking[23].exception_cardnum","CheckNULLTerminatedinCR01",mode);
checknull(cr01->cardnum_blocking[24].exception_cardnum,sizeof(cr01->cardnum_blocking[24].exception_cardnum),"CR01","cardnum_blocking[24].exception_cardnum","CheckNULLTerminatedinCR01",mode);
checknull(cr01->cardnum_blocking[25].exception_cardnum,sizeof(cr01->cardnum_blocking[25].exception_cardnum),"CR01","cardnum_blocking[25].exception_cardnum","CheckNULLTerminatedinCR01",mode);
checknull(cr01->cardnum_blocking[26].exception_cardnum,sizeof(cr01->cardnum_blocking[26].exception_cardnum),"CR01","cardnum_blocking[26].exception_cardnum","CheckNULLTerminatedinCR01",mode);
checknull(cr01->cardnum_blocking[27].exception_cardnum,sizeof(cr01->cardnum_blocking[27].exception_cardnum),"CR01","cardnum_blocking[27].exception_cardnum","CheckNULLTerminatedinCR01",mode);
checknull(cr01->cardnum_blocking[28].exception_cardnum,sizeof(cr01->cardnum_blocking[28].exception_cardnum),"CR01","cardnum_blocking[28].exception_cardnum","CheckNULLTerminatedinCR01",mode);
checknull(cr01->cardnum_blocking[29].exception_cardnum,sizeof(cr01->cardnum_blocking[29].exception_cardnum),"CR01","cardnum_blocking[29].exception_cardnum","CheckNULLTerminatedinCR01",mode);
checknull(cr01->cardnum_blocking[30].exception_cardnum,sizeof(cr01->cardnum_blocking[30].exception_cardnum),"CR01","cardnum_blocking[30].exception_cardnum","CheckNULLTerminatedinCR01",mode);
checknull(cr01->cardnum_blocking[31].exception_cardnum,sizeof(cr01->cardnum_blocking[31].exception_cardnum),"CR01","cardnum_blocking[31].exception_cardnum","CheckNULLTerminatedinCR01",mode);
checknull(cr01->cardnum_blocking[32].exception_cardnum,sizeof(cr01->cardnum_blocking[32].exception_cardnum),"CR01","cardnum_blocking[32].exception_cardnum","CheckNULLTerminatedinCR01",mode);
checknull(cr01->cardnum_blocking[33].exception_cardnum,sizeof(cr01->cardnum_blocking[33].exception_cardnum),"CR01","cardnum_blocking[33].exception_cardnum","CheckNULLTerminatedinCR01",mode);
checknull(cr01->cardnum_blocking[34].exception_cardnum,sizeof(cr01->cardnum_blocking[34].exception_cardnum),"CR01","cardnum_blocking[34].exception_cardnum","CheckNULLTerminatedinCR01",mode);
checknull(cr01->cardnum_blocking[35].exception_cardnum,sizeof(cr01->cardnum_blocking[35].exception_cardnum),"CR01","cardnum_blocking[35].exception_cardnum","CheckNULLTerminatedinCR01",mode);
checknull(cr01->cardnum_blocking[36].exception_cardnum,sizeof(cr01->cardnum_blocking[36].exception_cardnum),"CR01","cardnum_blocking[36].exception_cardnum","CheckNULLTerminatedinCR01",mode);
checknull(cr01->cardnum_blocking[37].exception_cardnum,sizeof(cr01->cardnum_blocking[37].exception_cardnum),"CR01","cardnum_blocking[37].exception_cardnum","CheckNULLTerminatedinCR01",mode);
checknull(cr01->cardnum_blocking[38].exception_cardnum,sizeof(cr01->cardnum_blocking[38].exception_cardnum),"CR01","cardnum_blocking[38].exception_cardnum","CheckNULLTerminatedinCR01",mode);
checknull(cr01->cardnum_blocking[39].exception_cardnum,sizeof(cr01->cardnum_blocking[39].exception_cardnum),"CR01","cardnum_blocking[39].exception_cardnum","CheckNULLTerminatedinCR01",mode);
checknull(cr01->cardnum_blocking[40].exception_cardnum,sizeof(cr01->cardnum_blocking[40].exception_cardnum),"CR01","cardnum_blocking[40].exception_cardnum","CheckNULLTerminatedinCR01",mode);
checknull(cr01->cardnum_blocking[41].exception_cardnum,sizeof(cr01->cardnum_blocking[41].exception_cardnum),"CR01","cardnum_blocking[41].exception_cardnum","CheckNULLTerminatedinCR01",mode);
checknull(cr01->cardnum_blocking[42].exception_cardnum,sizeof(cr01->cardnum_blocking[42].exception_cardnum),"CR01","cardnum_blocking[42].exception_cardnum","CheckNULLTerminatedinCR01",mode);
checknull(cr01->cardnum_blocking[43].exception_cardnum,sizeof(cr01->cardnum_blocking[43].exception_cardnum),"CR01","cardnum_blocking[43].exception_cardnum","CheckNULLTerminatedinCR01",mode);
checknull(cr01->cardnum_blocking[44].exception_cardnum,sizeof(cr01->cardnum_blocking[44].exception_cardnum),"CR01","cardnum_blocking[44].exception_cardnum","CheckNULLTerminatedinCR01",mode);
checknull(cr01->cardnum_blocking[45].exception_cardnum,sizeof(cr01->cardnum_blocking[45].exception_cardnum),"CR01","cardnum_blocking[45].exception_cardnum","CheckNULLTerminatedinCR01",mode);
checknull(cr01->cardnum_blocking[46].exception_cardnum,sizeof(cr01->cardnum_blocking[46].exception_cardnum),"CR01","cardnum_blocking[46].exception_cardnum","CheckNULLTerminatedinCR01",mode);
checknull(cr01->cardnum_blocking[47].exception_cardnum,sizeof(cr01->cardnum_blocking[47].exception_cardnum),"CR01","cardnum_blocking[47].exception_cardnum","CheckNULLTerminatedinCR01",mode);
checknull(cr01->cardnum_blocking[48].exception_cardnum,sizeof(cr01->cardnum_blocking[48].exception_cardnum),"CR01","cardnum_blocking[48].exception_cardnum","CheckNULLTerminatedinCR01",mode);
checknull(cr01->cardnum_blocking[49].exception_cardnum,sizeof(cr01->cardnum_blocking[49].exception_cardnum),"CR01","cardnum_blocking[49].exception_cardnum","CheckNULLTerminatedinCR01",mode);
checknull(cr01->future_use_1,sizeof(cr01->future_use_1),"CR01" ,"Future field","CheckNULLTerminatedinCR01",mode);
checknull(cr01->future_use_2,sizeof(cr01->future_use_2),"CR01" ,"Future field","CheckNULLTerminatedinCR01",mode);
checknull(cr01->future_use_3,sizeof(cr01->future_use_3 ),"CR01" ,"Future field","CheckNULLTerminatedinCR01",mode);
checknull(cr01->future_use_4,sizeof(cr01->future_use_4),"CR01","Future field","CheckNULLTerminatedinCR01",mode);
checknull(cr01->future_use_5,sizeof(cr01->future_use_5),"CR01" ,"Future field",  "CheckNULLTerminatedinCR01",mode);
checknull(cr01->future_use_6,sizeof(cr01->future_use_6),"CR01","Future field", "CheckNULLTerminatedinCR01",mode);
checknull(cr01->future_use_7,sizeof(cr01->future_use_7 ),"CR01" ,"Future field", "CheckNULLTerminatedinCR01",mode);
checknull(cr01->future_use_8,sizeof(cr01->future_use_8),"CR01" ,"Future field",  "CheckNULLTerminatedinCR01",mode);
checknull(cr01->future_use_9,sizeof(cr01->future_use_9 ),"CR01"  ,"Future field","CheckNULLTerminatedinCR01",mode);
checknull(cr01->future_use_10,sizeof(cr01->future_use_10 ),"CR01" ,"Future field", "CheckNULLTerminatedinCR01",mode);
...
void CheckNULLTerminatedinAMEX3DS2(pAMEX3DS2   amex3ds2, pCHAR mode)
{
	checknull(amex3ds2->self_validation_ac,sizeof(amex3ds2->self_validation_ac),"amex3ds2","self_validation_ac","CheckNULLTerminatedinamex3ds2",mode);
	checknull(amex3ds2->csc_validation_flag,sizeof(amex3ds2->csc_validation_flag),"amex3ds2","csc_validation_flag","CheckNULLTerminatedinamex3ds2",mode);
	checknull(amex3ds2->authentication_result_code_ac,sizeof(amex3ds2->authentication_result_code_ac),"amex3ds2","authentication_result_code_ac","CheckNULLTerminatedinamex3ds2",mode);
	checknull(amex3ds2->authentication_attempt_ac,sizeof(amex3ds2->authentication_attempt_ac),"amex3ds2","authentication_attempt_ac","CheckNULLTerminatedinamex3ds2",mode);
	checknull(amex3ds2->authentication_attempt_verify_flag,sizeof(amex3ds2->authentication_attempt_verify_flag),"amex3ds2","authentication_attempt_verify_flag","CheckNULLTerminatedinamex3ds2",mode);
}

void CheckNULLTerminatedinCUP3DS2(pCUP3DS2   cup3ds2, pCHAR mode)
{
	checknull(cup3ds2->av_verification_rc,sizeof(cup3ds2->av_verification_rc),"cup3ds2","av_verification_rc","CheckNULLTerminatedinCUP3DS2",mode);
	checknull(cup3ds2->cvn2_validation_flag,sizeof(cup3ds2->cvn2_validation_flag),"cup3ds2","cvn2_validation_flag","CheckNULLTerminatedinCUP3DS2",mode);
	checknull(cup3ds2->authentication_attempt_rc,sizeof(cup3ds2->authentication_attempt_rc),"cup3ds2","authentication_attempt_rc","CheckNULLTerminatedinCUP3DS2",mode);
	checknull(cup3ds2->av_validation_flag,sizeof(cup3ds2->av_validation_flag),"cup3ds2","av_validation_flag","CheckNULLTerminatedinCUP3DS2",mode);
	checknull(cup3ds2->cup_authentication_attempt_verify_flag,sizeof(cup3ds2->cup_authentication_attempt_verify_flag),"cup3ds2","cup_authentication_attempt_verify_flag","CheckNULLTerminatedinCUP3DS2",mode);
}

void CheckNULLTerminatedinDCI3DS2(pDCI3DS2   dci3ds2, pCHAR mode)
{
	checknull(dci3ds2->self_validation_pass_cavv_rc,sizeof(dci3ds2->self_validation_pass_cavv_rc),"dci3ds2","self_validation_pass_cavv_rc","CheckNULLTerminatedindci3ds2",mode);
	checknull(dci3ds2->self_validation_cavv_rc,sizeof(dci3ds2->self_validation_cavv_rc),"dci3ds2","self_validation_cavv_rc","CheckNULLTerminatedindci3ds2",mode);
	checknull(dci3ds2->cvv2_validation_flag,sizeof(dci3ds2->cvv2_validation_flag),"dci3ds2","cvv2_validation_flag","CheckNULLTerminatedindci3ds2",mode);
	checknull(dci3ds2->authentication_result_code_ac,sizeof(dci3ds2->authentication_result_code_ac),"dci3ds2","authentication_result_code_ac","CheckNULLTerminatedindci3ds2",mode);
	checknull(dci3ds2->authentication_result_code_cavv_rc,sizeof(dci3ds2->authentication_result_code_cavv_rc),"dci3ds2","authentication_result_code_cavv_rc","CheckNULLTerminatedindci3ds2",mode);
	checknull(dci3ds2->authentication_attmpt_ac,sizeof(dci3ds2->authentication_attmpt_ac),"dci3ds2","authentication_attmpt_ac","CheckNULLTerminatedindci3ds2",mode);
	checknull(dci3ds2->authentication_attempt_verify_flag,sizeof(dci3ds2->authentication_attempt_verify_flag),"dci3ds2","authentication_attempt_verify_flag","CheckNULLTerminatedindci3ds2",mode);
}

void CheckNULLTerminatedinJCB3DS2(pJCB3DS2   jcb3ds2, pCHAR mode)
{
	checknull(jcb3ds2->auth_result_code_value,sizeof(jcb3ds2->auth_result_code_value),"JCB3DS2","auth_result_code_value","CheckNULLTerminatedinJCB3DS2",mode);
	checknull(jcb3ds2->response_code,sizeof(jcb3ds2->response_code),"JCB3DS2","response_code","CheckNULLTerminatedinJCB3DS2",mode);
	checknull(jcb3ds2->validation_flag,sizeof(jcb3ds2->validation_flag),"JCB3DS2","validation_flag","CheckNULLTerminatedinJCB3DS2",mode);
...
void CheckNULLTerminatedinKEY3DS01(pKEY3DS01   key3ds01,pCHAR mode)
{
	checknull(key3ds01->caf_profile_id , sizeof(key3ds01->caf_profile_id),"KEY3DS01","caf_profile_id","CheckNULLTerminatedinKEY3DS01",mode);
	checknull(key3ds01->key3ds , sizeof(key3ds01->key3ds),"KEY3DS01","key3ds","CheckNULLTerminatedinKEY3DS01",mode);
...
void CheckNULLTerminatedinCAF01(pCAF01   caf01,pCHAR mode)
{
	...
	checknull(caf01->velocity[0].nbr_usage , sizeof(caf01->velocity[0].nbr_usage),"CAF01","velocity[0].nbr_usage","CheckNULLTerminatedinCAF01",mode);
	...
	checknull(caf01->velocity[0].amt_usage , sizeof(caf01->velocity[0].amt_usage),"CAF01","velocity[0].amt_usage","CheckNULLTerminatedinCAF01",mode);

	checknull(caf01->velocity[1].nbr_usage , sizeof(caf01->velocity[1].nbr_usage),"CAF01","velocity[1].nbr_usage","CheckNULLTerminatedinCAF01",mode);
	checknull(caf01->velocity[1].day_period , sizeof(caf01->velocity[1].day_period),"CAF01","velocity[1].day_period","CheckNULLTerminatedinCAF01",mode);
	checknull(caf01->velocity[1].amt_usage , sizeof(caf01->velocity[1].amt_usage),"CAF01","velocity[1].amt_usage","CheckNULLTerminatedinCAF01",mode);

	checknull(caf01->velocity[2].nbr_usage , sizeof(caf01->velocity[2].nbr_usage),"CAF01","velocity[2].nbr_usage","CheckNULLTerminatedinCAF01",mode);
	checknull(caf01->velocity[2].day_period , sizeof(caf01->velocity[2].day_period),"CAF01","velocity[2].day_period","CheckNULLTerminatedinCAF01",mode);
	checknull(caf01->velocity[2].amt_usage , sizeof(caf01->velocity[2].amt_usage),"CAF01","velocity[2].amt_usage","CheckNULLTerminatedinCAF01",mode);
...
void CheckNULLTerminatedinCCF03(pCCF03   ccf03p,pCHAR mode)
{
	...
	checknull(ccf03p->peso_usage[14].nbr_usage, sizeof(ccf03p->peso_usage[14].nbr_usage),"CCF03P","peso_usage[14].nbr_usage","CheckNULLTerminatedinCCF03",mode);
	checknull(ccf03p->peso_usage[14].amt_usage, sizeof(ccf03p->peso_usage[14].amt_usage),"CCF03P","peso_usage[14].amt_usage","CheckNULLTerminatedinCCF03",mode);
	checknull(ccf03p->peso_usage[15].nbr_usage, sizeof(ccf03p->peso_usage[15].nbr_usage),"CCF03P","peso_usage[15].nbr_usage","CheckNULLTerminatedinCCF03",mode);
	checknull(ccf03p->peso_usage[15].amt_usage, sizeof(ccf03p->peso_usage[15].amt_usage),"CCF03P","peso_usage[15].amt_usage","CheckNULLTerminatedinCCF03",mode);
	checknull(ccf03p->peso_usage[16].nbr_usage, sizeof(ccf03p->peso_usage[16].nbr_usage),"CCF03P","peso_usage[16].nbr_usage","CheckNULLTerminatedinCCF03",mode);
	checknull(ccf03p->peso_usage[16].amt_usage, sizeof(ccf03p->peso_usage[16].amt_usage),"CCF03P","peso_usage[16].amt_usage","CheckNULLTerminatedinCCF03",mode);
	checknull(ccf03p->peso_usage[17].nbr_usage, sizeof(ccf03p->peso_usage[17].nbr_usage),"CCF03P","peso_usage[17].nbr_usage","CheckNULLTerminatedinCCF03",mode);
	checknull(ccf03p->peso_usage[17].amt_usage, sizeof(ccf03p->peso_usage[17].amt_usage),"CCF03P","peso_usage[17].amt_usage","CheckNULLTerminatedinCCF03",mode);
	checknull(ccf03p->peso_usage[18].nbr_usage, sizeof(ccf03p->peso_usage[18].nbr_usage),"CCF03P","peso_usage[18].nbr_usage","CheckNULLTerminatedinCCF03",mode);
	checknull(ccf03p->peso_usage[18].amt_usage, sizeof(ccf03p->peso_usage[18].amt_usage),"CCF03P","peso_usage[18].amt_usage","CheckNULLTerminatedinCCF03",mode);
	checknull(ccf03p->peso_usage[19].nbr_usage, sizeof(ccf03p->peso_usage[19].nbr_usage),"CCF03P","peso_usage[19].nbr_usage","CheckNULLTerminatedinCCF03",mode);
	checknull(ccf03p->peso_usage[19].amt_usage, sizeof(ccf03p->peso_usage[19].amt_usage),"CCF03P","peso_usage[19].amt_usage","CheckNULLTerminatedinCCF03",mode);
...
void CheckNULLTerminatedinCCL01(pCCL01   ccl01,pCHAR mode)
{
	checknull(ccl01->currency_value, sizeof(ccl01->currency_value),"CCL01","value","CheckNULLTerminatedinCCL01",mode);
	checknull(ccl01->currency_code, sizeof(ccl01->currency_code),"CCL01","code","CheckNULLTerminatedinCCL01",mode);
	checknull(ccl01->currency_decimal_places, sizeof(ccl01->currency_decimal_places),"CCL01","decimal_places","CheckNULLTerminatedinCCL01",mode);
	checknull(ccl01->currency_name, sizeof(ccl01->currency_name),"CCL01","curr_name","CheckNULLTerminatedinCCL01",mode);
	checknull(ccl01->future_field1, sizeof(ccl01->future_field1),"CCL01","future field1","CheckNULLTerminatedinCCL01",mode);
	checknull(ccl01->future_field2, sizeof(ccl01->future_field2),"CCL01","future_field2","CheckNULLTerminatedinCCL01",mode);
	checknull(ccl01->future_field3, sizeof(ccl01->future_field3),"CCL01","future_field3","CheckNULLTerminatedinCCL01",mode);

}

void CheckNULLTerminatedinBDKKEY01(pBDKKEY01   bdkkey01,pCHAR mode)
{
	checknull(bdkkey01->card_brand, sizeof(bdkkey01->card_brand),"BDKKEY01","card brand","CheckNULLTerminatedinBDKKEY01",mode);
	checknull(bdkkey01->bdk_key, sizeof(bdkkey01->bdk_key),"BDKKEY01","bdk key","CheckNULLTerminatedinBDKKEY01",mode);
	checknull(bdkkey01->future_field1, sizeof(bdkkey01->future_field1),"BDKKEY01","future_field1","CheckNULLTerminatedinBDKKEY01",mode);
	checknull(bdkkey01->future_field2, sizeof(bdkkey01->future_field2),"BDKKEY01","future_field2","CheckNULLTerminatedinBDKKEY01",mode);
	checknull(bdkkey01->future_field3, sizeof(bdkkey01->future_field3),"BDKKEY01","future_field3","CheckNULLTerminatedinBDKKEY01",mode);

}

void CheckNULLTerminatedinCAF01_KEYBLOCK01(pCAF01_KEYBLOCK   caf01_keyblock01,pCHAR mode)
{
	checknull(caf01_keyblock01->primary_key.Caf_Profile_id, sizeof(caf01_keyblock01->primary_key.Caf_Profile_id),"CAF01_KEYBLOCK","Caf_Profile_id","CheckNULLTerminatedinCAF01_KEYBLOCK01",mode);
	checknull(caf01_keyblock01->primary_key.Type, sizeof(caf01_keyblock01->primary_key.Type),"CAF01_KEYBLOCK","Type","CheckNULLTerminatedinCAF01_KEYBLOCK01",mode);
	checknull(caf01_keyblock01->Cvk_Mag_Keyblock, sizeof(caf01_keyblock01->Cvk_Mag_Keyblock),"CAF01_KEYBLOCK","Cvk_Mag_Keyblock","CheckNULLTerminatedinCAF01_KEYBLOCK01",mode);
	checknull(caf01_keyblock01->Cvk_Acq_3DS_Keyblock, sizeof(caf01_keyblock01->Cvk_Acq_3DS_Keyblock),"CAF01_KEYBLOCK","Cvk_Acq_3DS_Keyblock","CheckNULLTerminatedinCAF01_KEYBLOCK01",mode);
	checknull(caf01_keyblock01->Cvk_Pin_Verification, sizeof(caf01_keyblock01->Cvk_Pin_Verification),"CAF01_KEYBLOCK","Cvk_Pin_Verification","CheckNULLTerminatedinCAF01_KEYBLOCK01",mode);
	checknull(caf01_keyblock01->Cvk_Mkac_Keyblock, sizeof(caf01_keyblock01->Cvk_Mkac_Keyblock),"CAF01_KEYBLOCK","Cvk_Mkac_Keyblock","CheckNULLTerminatedinCAF01_KEYBLOCK01",mode);
	checknull(caf01_keyblock01->Csck_Iss_3ds_Keyblock, sizeof(caf01_keyblock01->Csck_Iss_3ds_Keyblock),"CAF01_KEYBLOCK","Csck_Iss_3ds_Keyblock","CheckNULLTerminatedinCAF01_KEYBLOCK01",mode);
	checknull(caf01_keyblock01->Csck_Mag_Keyblock, sizeof(caf01_keyblock01->Csck_Mag_Keyblock),"CAF01_KEYBLOCK","Csck_Mag_Keyblock","CheckNULLTerminatedinCAF01_KEYBLOCK01",mode);
	checknull(caf01_keyblock01->Dci_3ds_Keyblock, sizeof(caf01_keyblock01->Dci_3ds_Keyblock),"CAF01_KEYBLOCK","Dci_3ds_Keyblock","CheckNULLTerminatedinCAF01_KEYBLOCK01",mode);
	checknull(caf01_keyblock01->Cvk_3ds_Cak_Keyblock, sizeof(caf01_keyblock01->Cvk_3ds_Cak_Keyblock),"CAF01_KEYBLOCK","Cvk_3ds_Cak_Keyblock","CheckNULLTerminatedinCAF01_KEYBLOCK01",mode);
	checknull(caf01_keyblock01->Future_Field1, sizeof(caf01_keyblock01->Future_Field1),"CAF01_KEYBLOCK","Future_Field1","CheckNULLTerminatedinCAF01_KEYBLOCK01",mode);
	checknull(caf01_keyblock01->Future_Field2, sizeof(caf01_keyblock01->Future_Field2),"CAF01_KEYBLOCK","Future_Field2","CheckNULLTerminatedinCAF01_KEYBLOCK01",mode);
	checknull(caf01_keyblock01->Future_Field3, sizeof(caf01_keyblock01->Future_Field3),"CAF01_KEYBLOCK","Future_Field3","CheckNULLTerminatedinCAF01_KEYBLOCK01",mode);
	checknull(caf01_keyblock01->Future_Field4, sizeof(caf01_keyblock01->Future_Field4),"CAF01_KEYBLOCK","Future_Field4","CheckNULLTerminatedinCAF01_KEYBLOCK01",mode);
	checknull(caf01_keyblock01->Future_Field5, sizeof(caf01_keyblock01->Future_Field5),"CAF01_KEYBLOCK","Future_Field5","CheckNULLTerminatedinCAF01_KEYBLOCK01",mode);
}
...
void CheckNULLTerminatedinTLF01(pTLF01   tlf01,pCHAR mode)
{
	...
	checknull(tlf01->entry_type,sizeof(tlf01->entry_type),"TLF01","entry_type","CheckNULLTerminatedinTLF01",mode);
	checknull(tlf01->tpdu_id,sizeof(tlf01->tpdu_id),"TLF01","tpdu_id","CheckNULLTerminatedinTLF01",mode);
	checknull(tlf01->issuer_id,sizeof(tlf01->issuer_id),"TLF01","issuer_id","CheckNULLTerminatedinTLF01",mode);
	checknull(tlf01->acquirer_id,sizeof(tlf01->acquirer_id),"TLF01","acquirer_id","CheckNULLTerminatedinTLF01",mode);
	checknull(tlf01->tx_key,sizeof(tlf01->tx_key),"TLF01","tx_key","CheckNULLTerminatedinTLF01",mode);
	checknull(tlf01->terminal_id,sizeof(tlf01->terminal_id),"TLF01","terminal_id","CheckNULLTerminatedinTLF01",mode);
	checknull(tlf01->terminal_type,sizeof(tlf01->terminal_type),"TLF01","terminal_type","CheckNULLTerminatedinTLF01",mode);
	checknull(tlf01->response_text,sizeof(tlf01->response_text),"TLF01","response_text","CheckNULLTerminatedinTLF01",mode);
	checknull(tlf01->card_num_len,sizeof(tlf01->card_num_len),"TLF01","card_num_len","CheckNULLTerminatedinTLF01",mode);
	checknull(tlf01->card_num,sizeof(tlf01->card_num),"TLF01","card_num","CheckNULLTerminatedinTLF01",mode);
	checknull(tlf01->exp_date,sizeof(tlf01->exp_date),"TLF01","exp_date","CheckNULLTerminatedinTLF01",mode);
	checknull(tlf01->total_amount,sizeof(tlf01->total_amount),"TLF01","total_amount","CheckNULLTerminatedinTLF01",mode);
	checknull(tlf01->add_amounts,sizeof(tlf01->add_amounts),"TLF01","add_amounts","CheckNULLTerminatedinTLF01",mode);
	checknull(tlf01->invoice_number,sizeof(tlf01->invoice_number),"TLF01","invoice_number","CheckNULLTerminatedinTLF01",mode);
	checknull(tlf01->orig_amount,sizeof(tlf01->orig_amount),"TLF01","orig_amount","CheckNULLTerminatedinTLF01",mode);
	checknull(tlf01->auth_number,sizeof(tlf01->auth_number),"TLF01","auth_number","CheckNULLTerminatedinTLF01",mode);
	checknull(tlf01->processing_code,sizeof(tlf01->processing_code),"TLF01","processing_code","CheckNULLTerminatedinTLF01",mode);
	checknull(tlf01->sys_trace_audit_num,sizeof(tlf01->sys_trace_audit_num),"TLF01","sys_trace_audit_num","CheckNULLTerminatedinTLF01",mode);
	checknull(tlf01->orig_sys_trace_num,sizeof(tlf01->orig_sys_trace_num),"TLF01","orig_sys_trace_num","CheckNULLTerminatedinTLF01",mode);
	checknull(tlf01->pos_entry_mode,sizeof(tlf01->pos_entry_mode),"TLF01","pos_entry_mode","CheckNULLTerminatedinTLF01",mode);
	checknull(tlf01->nii,sizeof(tlf01->nii),"TLF01","nii","CheckNULLTerminatedinTLF01",mode);
	checknull(tlf01->pos_condition_code,sizeof(tlf01->pos_condition_code),"TLF01","pos_condition_code","CheckNULLTerminatedinTLF01",mode);
	checknull(tlf01->track1,sizeof(tlf01->track1),"TLF01","track1","CheckNULLTerminatedinTLF01",mode);
	checknull(tlf01->track2,sizeof(tlf01->track2),"TLF01","track2","CheckNULLTerminatedinTLF01",mode);
	checknull(tlf01->retrieval_ref_num,sizeof(tlf01->retrieval_ref_num),"TLF01","retrieval_ref_num","CheckNULLTerminatedinTLF01",mode);
	checknull(tlf01->orig_retrieval_ref_num,sizeof(tlf01->orig_retrieval_ref_num),"TLF01","orig_retrieval_ref_num","CheckNULLTerminatedinTLF01",mode);
	checknull(tlf01->merchant_id,sizeof(tlf01->merchant_id),"TLF01","merchant_id","CheckNULLTerminatedinTLF01",mode);
	checknull(tlf01->orig_message,sizeof(tlf01->orig_message),"TLF01","orig_message","CheckNULLTerminatedinTLF01",mode);
	checknull(tlf01->settlement_total,sizeof(tlf01->settlement_total),"TLF01","settlement_total","CheckNULLTerminatedinTLF01",mode);
	checknull(tlf01->message_type,sizeof(tlf01->message_type),"TLF01","message_type","CheckNULLTerminatedinTLF01",mode);
	checknull(tlf01->card_holder_name,sizeof(tlf01->card_holder_name),"TLF01","card_holder_name","CheckNULLTerminatedinTLF01",mode);

	checknull(tlf01->general_status,sizeof(tlf01->general_status),"TLF01","general_status","CheckNULLTerminatedinTLF01",mode);
	checknull(tlf01->originator_queue,sizeof(tlf01->originator_queue),"TLF01","originator_queue","CheckNULLTerminatedinTLF01",mode);
	checknull(tlf01->originator_info,sizeof(tlf01->originator_info),"TLF01","originator_info","CheckNULLTerminatedinTLF01",mode);
	checknull(tlf01->batch_number,sizeof(tlf01->batch_number),"TLF01","batch_number","CheckNULLTerminatedinTLF01",mode);
	checknull(tlf01->response_code,sizeof(tlf01->response_code),"TLF01","response_code","CheckNULLTerminatedinTLF01",mode);
	checknull(tlf01->date_yyyymmdd,sizeof(tlf01->date_yyyymmdd),"TLF01","date_yyyymmdd","CheckNULLTerminatedinTLF01",mode);
	checknull(tlf01->time_hhmmss,sizeof(tlf01->time_hhmmss),"TLF01","time_hhmmss","CheckNULLTerminatedinTLF01",mode);
	checknull(tlf01->num_sales,sizeof(tlf01->num_sales),"TLF01","num_sales","CheckNULLTerminatedinTLF01",mode);
	checknull(tlf01->sales_amount,sizeof(tlf01->sales_amount),"TLF01","sales_amount","CheckNULLTerminatedinTLF01",mode);
	checknull(tlf01->num_refunds,sizeof(tlf01->num_refunds),"TLF01","sales_amount","CheckNULLTerminatedinTLF01",mode);
	checknull(tlf01->refund_amount,sizeof(tlf01->refund_amount),"TLF01","refund_amount","CheckNULLTerminatedinTLF01",mode);
	checknull(tlf01->num_dbsales,sizeof(tlf01->num_dbsales),"TLF01","num_dbsales","CheckNULLTerminatedinTLF01",mode);

	checknull(tlf01->dbsales_amount,sizeof(tlf01->dbsales_amount),"TLF01","dbsales_amount","CheckNULLTerminatedinTLF01",mode);
	checknull(tlf01->num_dbrefunds,sizeof(tlf01->num_dbrefunds),"TLF01","num_dbrefunds","CheckNULLTerminatedinTLF01",mode);
	checknull(tlf01->dbrefund_amount,sizeof(tlf01->dbrefund_amount),"TLF01","dbrefund_amount","CheckNULLTerminatedinTLF01",mode);
	checknull(tlf01->pin_block,sizeof(tlf01->pin_block),"TLF01","pin_block","CheckNULLTerminatedinTLF01",mode);
	checknull(tlf01->tax_amount,sizeof(tlf01->tax_amount),"TLF01","tax_amount","CheckNULLTerminatedinTLF01",mode);
	checknull(tlf01->tip_amount,sizeof(tlf01->tip_amount),"TLF01","tip_amount","CheckNULLTerminatedinTLF01",mode);
	checknull(tlf01->tran_start_time,sizeof(tlf01->tran_start_time),"TLF01","tran_start_time","CheckNULLTerminatedinTLF01",mode);
	checknull(tlf01->host_start_time,sizeof(tlf01->host_start_time),"TLF01","host_start_time","CheckNULLTerminatedinTLF01",mode);
	checknull(tlf01->host_finish_time,sizeof(tlf01->host_finish_time),"TLF01","host_finish_time","CheckNULLTerminatedinTLF01",mode);
	checknull(tlf01->tran_finish_time,sizeof(tlf01->tran_finish_time),"TLF01","tran_finish_time","CheckNULLTerminatedinTLF01",mode);
	checknull(tlf01->settle_file_prefix,sizeof(tlf01->settle_file_prefix),"TLF01","settle_file_prefix","CheckNULLTerminatedinTLF01",mode);

	checknull(tlf01->resp_source_len,sizeof(tlf01->resp_source_len),"TLF01","resp_source_len","CheckNULLTerminatedinTLF01",mode);
	checknull(tlf01->visa_char_indicator,sizeof(tlf01->visa_char_indicator),"TLF01","visa_char_indicator","CheckNULLTerminatedinTLF01",mode);
	checknull(tlf01->visa_tran_id,sizeof(tlf01->visa_tran_id),"TLF01","visa_tran_id","CheckNULLTerminatedinTLF01",mode);
	checknull(tlf01->visa_validation_code,sizeof(tlf01->visa_validation_code),"TLF01","visa_validation_code","CheckNULLTerminatedinTLF01",mode);
	checknull(tlf01->mcard_banknet_len,sizeof(tlf01->mcard_banknet_len),"TLF01","mcard_banknet_len","CheckNULLTerminatedinTLF01",mode);
	checknull(tlf01->mcard_banknet,sizeof(tlf01->mcard_banknet),"TLF01","mcard_banknet","CheckNULLTerminatedinTLF01",mode);
	checknull(tlf01->agent_id_len,sizeof(tlf01->agent_id_len),"TLF01","agent_id_len","CheckNULLTerminatedinTLF01",mode);
	checknull(tlf01->agent_id,sizeof(tlf01->agent_id),"TLF01","agent_id","CheckNULLTerminatedinTLF01",mode);
	checknull(tlf01->cvc,sizeof(tlf01->cvc),"TLF01","cvc","CheckNULLTerminatedinTLF01",mode);
	checknull(tlf01->settlement_date,sizeof(tlf01->settlement_date),"TLF01","settlement_date","CheckNULLTerminatedinTLF01",mode);
	checknull(tlf01->category_code,sizeof(tlf01->category_code),"TLF01","category_code","CheckNULLTerminatedinTLF01",mode);
	checknull(tlf01->conversion_rate,sizeof(tlf01->conversion_rate),"TLF01","conversion_rate","CheckNULLTerminatedinTLF01",mode);
	checknull(tlf01->product_code,sizeof(tlf01->product_code),"TLF01","product_code","CheckNULLTerminatedinTLF01",mode);
	checknull(tlf01->odometer,sizeof(tlf01->odometer),"TLF01","odometer","CheckNULLTerminatedinTLF01",mode);
	checknull(tlf01->organization_id,sizeof(tlf01->organization_id),"TLF01","organization_id","CheckNULLTerminatedinTLF01",mode);

	checknull(tlf01->dynamic_keychange,sizeof(tlf01->dynamic_keychange),"TLF01","dynamic_keychange","CheckNULLTerminatedinTLF01",mode);
	checknull(tlf01->source_key,sizeof(tlf01->source_key),"TLF01","source_key","CheckNULLTerminatedinTLF01",mode);
	checknull(tlf01->txn_cnt,sizeof(tlf01->txn_cnt),"TLF01","txn_cnt","CheckNULLTerminatedinTLF01",mode);
	checknull(tlf01->dcf01_retired_cwk,sizeof(tlf01->dcf01_retired_cwk),"TLF01","dcf01_retired_cwk","CheckNULLTerminatedinTLF01",mode);
	checknull(tlf01->dest_key,sizeof(tlf01->dest_key),"TLF01","dest_key","CheckNULLTerminatedinTLF01",mode);
	checknull(tlf01->ncf01_retired_cwk,sizeof(tlf01->ncf01_retired_cwk),"TLF01","ncf01_retired_cwk","CheckNULLTerminatedinTLF01",mode);
	checknull(tlf01->handler_queue,sizeof(tlf01->handler_queue),"TLF01","handler_queue","CheckNULLTerminatedinTLF01",mode);
	checknull(tlf01->authorizing_host_queue,sizeof(tlf01->authorizing_host_queue),"TLF01","authorizing_host_queue","CheckNULLTerminatedinTLF01",mode);
	checknull(tlf01->max_net_consec_tmouts,sizeof(tlf01->max_net_consec_tmouts),"TLF01","max_net_consec_tmouts","CheckNULLTerminatedinTLF01",mode);

	checknull(tlf01->max_active_txns,sizeof(tlf01->max_active_txns),"TLF01","max_active_txns","CheckNULLTerminatedinTLF01",mode);
	checknull(tlf01->forwarding_institution_id,sizeof(tlf01->forwarding_institution_id),"TLF01","forwarding_institution_id","CheckNULLTerminatedinTLF01",mode);
	checknull(tlf01->remote_nsp_type,sizeof(tlf01->remote_nsp_type),"TLF01","remote_nsp_type","CheckNULLTerminatedinTLF01",mode);
	checknull(tlf01->kek,sizeof(tlf01->kek),"TLF01","kek","CheckNULLTerminatedinTLF01",mode);
	checknull(tlf01->acquiring_id,sizeof(tlf01->acquiring_id),"TLF01","acquiring_id","CheckNULLTerminatedinTLF01",mode);
...
void CheckNULLTerminatedinBCH10(pBCH10   bch10,pCHAR mode)
{
	...
	checknull(bch10->tx_key,sizeof(bch10->tx_key),"BCH10","tx_key","CheckNULLTerminatedinBCH10",mode);
	checknull(bch10->bin_type,sizeof(bch10->bin_type),"BCH10","bin_type","CheckNULLTerminatedinBCH10",mode);
...
void CheckNULLTerminatedinBCH11(pBCH11   bch11,pCHAR mode)
{
	...
	checknull(bch11->tx_key,sizeof(bch11->tx_key),"BCH11","tx_key","CheckNULLTerminatedinBCH11",mode);
	checknull(bch11->bin_type,sizeof(bch11->bin_type),"BCH11","bin_type","CheckNULLTerminatedinBCH11",mode);
...
void CheckNULLTerminatedinBCH20(pBCH20   bch20,pCHAR mode)
{
	...
	checknull(bch20->tx_key,sizeof(bch20->tx_key),"BCH20","tx_key","CheckNULLTerminatedinBCH20",mode);
	checknull(bch20->bin_type,sizeof(bch20->bin_type),"BCH20","bin_type","CheckNULLTerminatedinBCH20",mode);
...
void CheckNULLTerminatedinNCF30(pNCF30 ncf30,pCHAR mode)
{
	...
	checknull(ncf30->tx_key,sizeof(ncf30->tx_key),"NCF30","tx_key","CheckNULLTerminatedinNCF30",mode);
...
void CheckNULLTerminatedinSAF01(pSAF01   saf01,pCHAR mode)
{
	...
	checknull(saf01->tx_key,sizeof(saf01->tx_key),"SAF01","tx_key","CheckNULLTerminatedinSAF01",mode);
...
void CheckNULLTerminatedinFGUARD(pFGUARD   fguard,pCHAR mode)
{
	...
	checknull(fguard->status,sizeof(fguard->status),"FGUARD","status","CheckNULLTerminatedinFGUARD",mode);
