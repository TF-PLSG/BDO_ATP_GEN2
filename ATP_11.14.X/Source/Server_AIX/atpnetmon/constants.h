 ...
 *
 *	DESCRIPTION: This file contains constants/macros used in atpnetmon.
 *
 ...
 * REVISION HISTORY:
 *
 * $Log:   N:\POS\PVCS6.6\EPICPORTZ\PTE\Equitable\atpnetmon\constants.h  $
...
#define LOCAL_GUI_MAX_LIST_SIZE  50

/* Defines size of a sign on Bin. */
#define  BIN_LENGTH  7

CHAR  Dest_Queue_atpnetmon[MAX_QUE_NAME_SIZE];
