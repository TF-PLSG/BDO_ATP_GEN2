...
#ifndef USE_REGISTRY
// Not using windows registry
// Executables are assumed to be run from bin folder.  All vital ascendent folders will be
// used as "..\\config", "..\\bin", "..\\log", "..\\trace"
	lstrcpy( AscendentRoot, "..\\" );
	return 1;
#else 
   LONG  Ret;
   HKEY  hRegKey;
...
BOOLEAN GetThisMachineId ( pCHAR ThisMachineId )
{
   ...
   rc = GetPrivateProfileString(
    sectionname,	            /*  points to section name  */
    "THIS_MACHINE_ID_1",              /*  points to key name  */
...
BOOLEAN GetThisMachineId_2 ( pCHAR ThisMachineId )
{
   ...
   rc = GetPrivateProfileString(
    sectionname,	            /*  points to section name  */
    "THIS_MACHINE_ID_2",              /*  points to key name  */
...
BOOLEAN GetThisMachineId_3 ( pCHAR ThisMachineId )
{
   ...
   rc = GetPrivateProfileString(
    sectionname,	            /*  points to section name  */
    "THIS_MACHINE_ID_3",              /*  points to key name  */
    "ASCENDENT_SVR3",               /*  points to default string  */
    tmpstr,                         /*  points to destination buffer  */
    sizeof(tmpstr) - 1,             /*  size of destination buffer  */
    filename                        /*  points to initialization filename  */
   );
...
BOOLEAN GetThisMachineId_4 ( pCHAR ThisMachineId )
{
   ...
   rc = GetPrivateProfileString(
    sectionname,	            /*  points to section name  */
    "THIS_MACHINE_ID_4",              /*  points to key name  */
    "ASCENDENT_SVR4",               /*  points to default string  */
    tmpstr,                         /*  points to destination buffer  */
    sizeof(tmpstr) - 1,             /*  size of destination buffer  */
    filename                        /*  points to initialization filename  */
   );
...
BOOLEAN GetFirstServerId ( pCHAR FirstServerId )
{
	...
	if ( strcmp (FirstServerId, "ASCENDENT_SVR1") == 0 )
		return 0;
	else
		return 1;
