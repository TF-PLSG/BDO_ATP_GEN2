                        ...
                        INT headerlength)
{
  ...
  if(port_init(connection_type, &Serial, &ipc_info) == FALSE)
  {
    return(FALSE);
  }
                    ...
                    INT header_length     , pCHAR host_name )
{
  ...
  switch (connection_type)
  {
      ...
      case DM_PORTTYPE_TCP_SERVER_IGNORE_TPDU:
         ...
         if(port_init(connection_type, &TcpServer, &ipc_info) == FALSE)
         {
            return(FALSE);
         }
      ...
      case DM_PORTTYPE_TCP_CLIENT_IGNORE_TPDU:
         ...
         if(port_init(connection_type, &TcpClient, &ipc_info) == FALSE)
         {
            return(FALSE);
         }
