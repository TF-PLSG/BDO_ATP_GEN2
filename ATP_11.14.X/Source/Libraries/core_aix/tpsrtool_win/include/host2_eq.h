/******************************************************************************
    ...
    $Log:   N:\PVCS\PTE\Equitable\App_lib\host2_eq.h  $
   
      Rev 1.4   May 12 2000 15:39:52   svelaga
   Modified the structure.
   
      Rev 1.3   Jan 18 2000 16:35:36   ddabberu
...
typedef struct host2_req_eq
{
   ...
   BYTE acceptor_name            [15];
   BYTE acquirer_cb_code         [4];
   BYTE acquirer_currency_code   [3];
   BYTE acquirer_tran_amt       [11];	
   BYTE filler                   [37];
