/******************************************************************************
   ...
   $Log:   N:\PVCS\PTE\CORE\PTE_LIB\PTELLIST.H  $
   
      Rev 1.8   Oct 14 1999 07:24:10   MSALEH
   integrate SSL modifications
   
      Rev 1.7   Aug 25 1999 15:59:50   MSALEH
   add another function prototype to .h file
   
      Rev 1.6   Dec 03 1998 10:53:30   drodden
...
/* SSL Stuff */
#ifdef SSL_SUPPORT
typedef struct SSL_LIST_ELEMENT
{
   struct SSL_LIST_ELEMENT  *p_next_element;
   struct SSL_LIST_ELEMENT  *p_prev_element;
   CHAR  tran_id [MAX_TRAN_ID_SIZE];
   LONG  data_size;
   SSL   stored_ssl;        /* must be last field in this struct */
}*pSSL_LIST_ELEMENT;

typedef struct
{
   pSSL_LIST_ELEMENT p_first;
   pSSL_LIST_ELEMENT p_last;
   LONG              num_elements;
   LONG              key1_offset;
   LONG              key2_offset;
} SSL_LINKED_LIST, *pSSL_LINKED_LIST;
