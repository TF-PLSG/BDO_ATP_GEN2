...
//Krishna@tf, 25.5.11, Defined macros for Min & Max Values of User Name & Password
#ifdef WIN32
#define MIN_USERNAME_LEN  10
#define MIN_USERPWD_LEN	  10
#define MAX_USERNAME_LEN  19
#define MAX_USERPWD_LEN   19
#endif


/**temp_accountstatus declared in order to use it in the userdefinition.cpp file -TF_Veena**/
extern CHAR temp_accountstatus[10];
/******************************************************************************************/
