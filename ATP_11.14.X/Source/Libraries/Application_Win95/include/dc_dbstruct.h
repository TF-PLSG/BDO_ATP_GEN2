...
{
   BYTE  num_returned     [5];
   ARCHIVE_BCH11 batch_record       [ARCH_GUI_MAX_LIST_SIZE];
}ARCHIVE_BCH11_GUI_LIST, *pARCHIVE_BCH11_GUI_LIST;

typedef struct
{
   BYTE  num_returned     [5];
   ARCHIVE_BCH20 batch_record       [ARCH_GUI_MAX_LIST_SIZE];
}ARCHIVE_BCH20_GUI_LIST, *pARCHIVE_BCH20_GUI_LIST;

typedef struct
{
   BYTE  num_returned     [5];
   ARCHIVE_BCH10 batch_record       [BATCH_SERVICE_LIST_SIZE];
...
{
   BYTE  num_returned     [5];
   ARCHIVE_BCH11 batch_record       [BATCH_SERVICE_LIST_SIZE];
}ARCHIVE_BCH11_LIST, *pARCHIVE_BCH11_LIST;

typedef struct
{
   BYTE  num_returned     [5];
   ARCHIVE_BCH01 batch_record       [SCH_MAX_LIST_SIZE];
