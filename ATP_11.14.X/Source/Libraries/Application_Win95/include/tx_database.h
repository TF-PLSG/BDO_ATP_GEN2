...
BYTE db_select_mcc01 (pCHAR, pOMC01, pCHAR);         
BYTE db_insert_mcc01 (pOMC01, pCHAR);         
BYTE db_update_mcc01 (pOMC01, pCHAR);
BYTE db_delete_mcc01 (pOMC01, pCHAR);        
...
BYTE db_select_amex3ds2(pCHAR,pAMEX3DS2 amex3ds2_ptr, pCHAR ErrorMsg);
...
BYTE db_select_dci3ds2(pCHAR,pDCI3DS2 dci3ds2_ptr, pCHAR ErrorMsg);
BYTE db_update_dci3ds2( pDCI3DS2 dci3ds2_ptr, pCHAR ErrorMsg);
BYTE db_insert_dci3ds2( pDCI3DS2 dci3ds2_ptr, pCHAR ErrorMsg);

BYTE db_select_cup3ds2(pCHAR,pCUP3DS2 cup3ds2_ptr, pCHAR ErrorMsg);
...
BYTE db_select_binblkmid01(pCHAR,pMIDBINBLK01 binblkmid01_ptr, pCHAR ErrorMsg);
